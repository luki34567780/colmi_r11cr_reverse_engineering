...
public final class OpenJSSEPlatform extends okhttp3.internal.platform.Platform {
    ...
    public javax.net.ssl.SSLContext newSSLContext() {
        ...
        kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(sSLContext, "SSLContext.getInstance(\"TLSv1.3\", provider)");
        return sSLContext;
    }

    @Override // okhttp3.internal.platform.Platform
    public javax.net.ssl.X509TrustManager platformTrustManager() {
        javax.net.ssl.TrustManagerFactory factory = javax.net.ssl.TrustManagerFactory.getInstance(javax.net.ssl.TrustManagerFactory.getDefaultAlgorithm(), this.provider);
