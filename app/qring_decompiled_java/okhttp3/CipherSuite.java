...
public final class CipherSuite {
    ...
    public static final class Companion {
        ...
        public final synchronized okhttp3.CipherSuite forJavaName(java.lang.String javaName) {
            ...
            if (cipherSuite == null) {
                okhttp3.CipherSuite.Companion companion = this;
        ...
        private final java.lang.String secondaryName(java.lang.String javaName) {
            if (kotlin.text.StringsKt.startsWith$default(javaName, "TLS_", false, 2, (java.lang.Object) null)) {
                ...
                sb.append("SSL_");
                java.util.Objects.requireNonNull(javaName, "null cannot be cast to non-null type java.lang.String");
    ...
    static {
        ...
        ORDER_BY_NAME = new java.util.Comparator<java.lang.String>() { // from class: okhttp3.CipherSuite$Companion$ORDER_BY_NAME$1
            ...
            public int compare(java.lang.String a, java.lang.String b) {
                ...
                int min = java.lang.Math.min(a.length(), b.length());
                for (int i = 4; i < min; i++) {
