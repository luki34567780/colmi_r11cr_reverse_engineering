...
public interface Dns {
    ...
    public static final okhttp3.Dns.Companion INSTANCE = new okhttp3.Dns.Companion(null);
        ...
        private static final class DnsSystem implements okhttp3.Dns {
            ...
            public java.util.List<java.net.InetAddress> lookup(java.lang.String hostname) {
                ...
                try {
                    ...
                    kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(allByName, "InetAddress.getAllByName(hostname)");
