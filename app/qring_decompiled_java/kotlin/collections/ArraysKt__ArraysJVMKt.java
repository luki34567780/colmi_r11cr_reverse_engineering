...
class ArraysKt__ArraysJVMKt {
    ...
    public static final <T> T[] arrayOfNulls(T[] reference, int i) {
        ...
        java.util.Objects.requireNonNull(newInstance, "null cannot be cast to non-null type kotlin.Array<T of kotlin.collections.ArraysKt__ArraysJVMKt.arrayOfNulls>");
