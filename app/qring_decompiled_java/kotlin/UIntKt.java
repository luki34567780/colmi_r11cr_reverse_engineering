...
public final class UIntKt {
    private static final int toUInt(byte b) {
        return kotlin.UInt.m1185constructorimpl(b);
    }

    private static final int toUInt(short s) {
        return kotlin.UInt.m1185constructorimpl(s);
    }

    private static final int toUInt(int i) {
        return kotlin.UInt.m1185constructorimpl(i);
    }

    private static final int toUInt(long j) {
        return kotlin.UInt.m1185constructorimpl((int) j);
    }
