...
public final class ULongKt {
    private static final long toULong(byte b) {
        return kotlin.ULong.m1263constructorimpl(b);
    }

    private static final long toULong(short s) {
        return kotlin.ULong.m1263constructorimpl(s);
    }

    private static final long toULong(int i) {
        return kotlin.ULong.m1263constructorimpl(i);
    }

    private static final long toULong(long j) {
        return kotlin.ULong.m1263constructorimpl(j);
    }
