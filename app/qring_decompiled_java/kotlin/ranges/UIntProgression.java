...
public class UIntProgression implements java.lang.Iterable<kotlin.UInt>, kotlin.jvm.internal.markers.KMappedMarker {
    ...
    private UIntProgression(int i, int i2, int i3) {
        ...
        this.first = i;
        this.last = kotlin.internal.UProgressionUtilKt.m2282getProgressionLastElementNkh28Cs(i, i2, i3);
        this.step = i3;
    }
    ...
    public final java.util.Iterator<kotlin.UInt> iterator() {
        return new kotlin.ranges.UIntProgressionIterator(getFirst(), getLast(), this.step, null);
    }

    public boolean isEmpty() {
        if (this.step > 0) {
            if (kotlin.UnsignedKt.uintCompare(getFirst(), getLast()) > 0) {
                return true;
            }
        } else if (kotlin.UnsignedKt.uintCompare(getFirst(), getLast()) < 0) {
            return true;
        }
        return false;
    }
    ...
    public java.lang.String toString() {
        ...
        if (this.step > 0) {
            ...
            sb.append((java.lang.Object) kotlin.UInt.m1230toStringimpl(getFirst()));
            sb.append("..");
            sb.append((java.lang.Object) kotlin.UInt.m1230toStringimpl(getLast()));
            sb.append(" step ");
            i = this.step;
        } else {
            sb = new java.lang.StringBuilder();
    ...
    public static final class Companion {
        ...
        public final kotlin.ranges.UIntProgression m2298fromClosedRangeNkh28Cs(int rangeStart, int rangeEnd, int step) {
