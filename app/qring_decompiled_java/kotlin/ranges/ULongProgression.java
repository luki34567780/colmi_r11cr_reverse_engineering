...
public class ULongProgression implements java.lang.Iterable<kotlin.ULong>, kotlin.jvm.internal.markers.KMappedMarker {
    ...
    private ULongProgression(long j, long j2, long j3) {
        ...
        this.first = j;
        this.last = kotlin.internal.UProgressionUtilKt.m2281getProgressionLastElement7ftBX0g(j, j2, j3);
        this.step = j3;
    }
    ...
    public final java.util.Iterator<kotlin.ULong> iterator() {
        return new kotlin.ranges.ULongProgressionIterator(getFirst(), getLast(), this.step, null);
    }

    public boolean isEmpty() {
        long j = this.step;
        int ulongCompare = kotlin.UnsignedKt.ulongCompare(getFirst(), getLast());
        if (j > 0) {
            if (ulongCompare > 0) {
                return true;
            }
    ...
    public int hashCode() {
        ...
        int m1263constructorimpl = ((((int) kotlin.ULong.m1263constructorimpl(getFirst() ^ kotlin.ULong.m1263constructorimpl(getFirst() >>> 32))) * 31) + ((int) kotlin.ULong.m1263constructorimpl(getLast() ^ kotlin.ULong.m1263constructorimpl(getLast() >>> 32)))) * 31;
        long j = this.step;
        return ((int) (j ^ (j >>> 32))) + m1263constructorimpl;
    }
    ...
    public java.lang.String toString() {
        ...
        if (this.step > 0) {
            ...
            sb.append((java.lang.Object) kotlin.ULong.m1308toStringimpl(getFirst()));
            sb.append("..");
            sb.append((java.lang.Object) kotlin.ULong.m1308toStringimpl(getLast()));
            sb.append(" step ");
            j = this.step;
        } else {
            sb = new java.lang.StringBuilder();
    ...
    public static final class Companion {
        ...
        public final kotlin.ranges.ULongProgression m2304fromClosedRange7ftBX0g(long rangeStart, long rangeEnd, long step) {
