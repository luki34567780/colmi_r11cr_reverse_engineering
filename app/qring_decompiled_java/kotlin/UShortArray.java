...
public final class UShortArray implements java.util.Collection<kotlin.UShort>, kotlin.jvm.internal.markers.KMappedMarker {
    ...
    public static final /* synthetic */ kotlin.UShortArray m1419boximpl(short[] sArr) {
        return new kotlin.UShortArray(sArr);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static short[] m1421constructorimpl(short[] storage) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(storage, "storage");
        return storage;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m1424equalsimpl(short[] sArr, java.lang.Object obj) {
    ...
    public static final boolean m1425equalsimpl0(short[] sArr, short[] sArr2) {
    ...
    public static int m1428hashCodeimpl(short[] sArr) {
        return java.util.Arrays.hashCode(sArr);
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static java.lang.String m1432toStringimpl(short[] sArr) {
    ...
    public boolean m1433addxj2QHRw(short s) {
        throw new java.lang.UnsupportedOperationException("Operation is not supported for read-only collection");
    }
    ...
    public boolean equals(java.lang.Object obj) {
        return m1424equalsimpl(this.storage, obj);
    }

    @Override // java.util.Collection
    public int hashCode() {
        return m1428hashCodeimpl(this.storage);
    }
    ...
    public java.lang.String toString() {
        return m1432toStringimpl(this.storage);
    }
    ...
    public final /* bridge */ boolean contains(java.lang.Object obj) {
        if (obj instanceof kotlin.UShort) {
            return m1434containsxj2QHRw(((kotlin.UShort) obj).getData());
        }
        return false;
    }
    ...
    /* renamed from: constructor-impl, reason: not valid java name */
    public static short[] m1420constructorimpl(int i) {
        return m1421constructorimpl(new short[i]);
    }

    /* renamed from: get-Mh2AYeg, reason: not valid java name */
    public static final short m1426getMh2AYeg(short[] sArr, int i) {
        return kotlin.UShort.m1369constructorimpl(sArr[i]);
    }

    /* renamed from: set-01HTLdE, reason: not valid java name */
    public static final void m1431set01HTLdE(short[] sArr, int i, short s) {
        sArr[i] = s;
    }

    /* renamed from: getSize-impl, reason: not valid java name */
    public static int m1427getSizeimpl(short[] sArr) {
        return sArr.length;
    }
    ...
    public int size() {
        return m1427getSizeimpl(this.storage);
    }

    /* renamed from: iterator-impl, reason: not valid java name */
    public static java.util.Iterator<kotlin.UShort> m1430iteratorimpl(short[] sArr) {
        return new kotlin.UShortArray.Iterator(sArr);
    }

    @Override // java.util.Collection, java.lang.Iterable
    public java.util.Iterator<kotlin.UShort> iterator() {
        return m1430iteratorimpl(this.storage);
    }
    ...
    private static final class Iterator extends kotlin.collections.UShortIterator {
        ...
        public short mo1436nextUShortMh2AYeg() {
            int i = this.index;
    ...
    public boolean m1434containsxj2QHRw(short s) {
        return m1422containsxj2QHRw(this.storage, s);
    }

    /* renamed from: contains-xj2QHRw, reason: not valid java name */
    public static boolean m1422containsxj2QHRw(short[] sArr, short s) {
    ...
    public boolean containsAll(java.util.Collection<? extends java.lang.Object> elements) {
        ...
        return m1423containsAllimpl(this.storage, elements);
    }

    /* renamed from: containsAll-impl, reason: not valid java name */
    public static boolean m1423containsAllimpl(short[] sArr, java.util.Collection<kotlin.UShort> elements) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(elements, "elements");
    ...
    public static boolean m1429isEmptyimpl(short[] sArr) {
        return sArr.length == 0;
    }

    @Override // java.util.Collection
    public boolean isEmpty() {
        return m1429isEmptyimpl(this.storage);
    }
}
