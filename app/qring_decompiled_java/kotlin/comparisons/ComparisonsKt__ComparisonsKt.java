...
public class ComparisonsKt__ComparisonsKt {
    ...
    public static final <T> java.util.Comparator<T> compareBy(final kotlin.jvm.functions.Function1<? super T, ? extends java.lang.Comparable<?>>... selectors) {
        ...
        return new java.util.Comparator() { // from class: kotlin.comparisons.ComparisonsKt__ComparisonsKt$compareBy$1
            @Override // java.util.Comparator
            public final int compare(T t, T t2) {
                int compareValuesByImpl$ComparisonsKt__ComparisonsKt;
                compareValuesByImpl$ComparisonsKt__ComparisonsKt = kotlin.comparisons.ComparisonsKt__ComparisonsKt.compareValuesByImpl$ComparisonsKt__ComparisonsKt(t, t2, selectors);
    ...
    public static final <T> java.util.Comparator<T> then(final java.util.Comparator<T> comparator, final java.util.Comparator<? super T> comparator2) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(comparator, "<this>");
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(comparator2, "comparator");
        return new java.util.Comparator() { // from class: kotlin.comparisons.ComparisonsKt__ComparisonsKt$then$1
            @Override // java.util.Comparator
            public final int compare(T t, T t2) {
                int compare = comparator.compare(t, t2);
    ...
    public static final <T> java.util.Comparator<T> thenDescending(final java.util.Comparator<T> comparator, final java.util.Comparator<? super T> comparator2) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(comparator, "<this>");
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(comparator2, "comparator");
        return new java.util.Comparator() { // from class: kotlin.comparisons.ComparisonsKt__ComparisonsKt$thenDescending$1
            @Override // java.util.Comparator
            public final int compare(T t, T t2) {
                int compare = comparator.compare(t, t2);
    ...
    public static final <T> java.util.Comparator<T> nullsFirst(final java.util.Comparator<? super T> comparator) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(comparator, "comparator");
        return new java.util.Comparator() { // from class: kotlin.comparisons.ComparisonsKt__ComparisonsKt$nullsFirst$1
            @Override // java.util.Comparator
            public final int compare(T t, T t2) {
                if (t == t2) {
                    return 0;
    ...
    public static final <T> java.util.Comparator<T> nullsLast(final java.util.Comparator<? super T> comparator) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(comparator, "comparator");
        return new java.util.Comparator() { // from class: kotlin.comparisons.ComparisonsKt__ComparisonsKt$nullsLast$1
            @Override // java.util.Comparator
            public final int compare(T t, T t2) {
                if (t == t2) {
                    return 0;
    ...
    public static final <T> java.util.Comparator<T> reversed(java.util.Comparator<T> comparator) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(comparator, "<this>");
        return comparator instanceof kotlin.comparisons.ReversedComparator ? ((kotlin.comparisons.ReversedComparator) comparator).getComparator() : kotlin.jvm.internal.Intrinsics.areEqual(comparator, kotlin.comparisons.NaturalOrderComparator.INSTANCE) ? kotlin.comparisons.ReverseOrderComparator.INSTANCE : kotlin.jvm.internal.Intrinsics.areEqual(comparator, kotlin.comparisons.ReverseOrderComparator.INSTANCE) ? kotlin.comparisons.NaturalOrderComparator.INSTANCE : new kotlin.comparisons.ReversedComparator(comparator);
    }
}
