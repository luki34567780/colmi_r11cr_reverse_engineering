...
public abstract class Segment<S extends kotlinx.coroutines.internal.Segment<S>> extends kotlinx.coroutines.internal.ConcurrentLinkedListNode<S> {
    private static final /* synthetic */ java.util.concurrent.atomic.AtomicIntegerFieldUpdater cleanedAndPointers$FU = java.util.concurrent.atomic.AtomicIntegerFieldUpdater.newUpdater(kotlinx.coroutines.internal.Segment.class, "cleanedAndPointers");
    ...
    public final boolean decPointers$kotlinx_coroutines_core() {
        return cleanedAndPointers$FU.addAndGet(this, androidx.core.internal.view.SupportMenu.CATEGORY_MASK) == getMaxSlots() && !isTail();
    }
