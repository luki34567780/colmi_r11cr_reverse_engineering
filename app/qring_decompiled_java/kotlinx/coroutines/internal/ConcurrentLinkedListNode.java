...
public abstract class ConcurrentLinkedListNode<N extends kotlinx.coroutines.internal.ConcurrentLinkedListNode<N>> {
    private static final /* synthetic */ java.util.concurrent.atomic.AtomicReferenceFieldUpdater _next$FU = java.util.concurrent.atomic.AtomicReferenceFieldUpdater.newUpdater(kotlinx.coroutines.internal.ConcurrentLinkedListNode.class, java.lang.Object.class, "_next");
    private static final /* synthetic */ java.util.concurrent.atomic.AtomicReferenceFieldUpdater _prev$FU = java.util.concurrent.atomic.AtomicReferenceFieldUpdater.newUpdater(kotlinx.coroutines.internal.ConcurrentLinkedListNode.class, java.lang.Object.class, "_prev");
    ...
    public final boolean trySetNext(N value) {
        return androidx.concurrent.futures.AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(_next$FU, this, null, value);
    }
    ...
    public final boolean markAsClosed() {
        return androidx.concurrent.futures.AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(_next$FU, this, null, kotlinx.coroutines.internal.ConcurrentLinkedListKt.CLOSED);
    }

    public final void remove() {
        if (kotlinx.coroutines.DebugKt.getASSERTIONS_ENABLED() && !getRemoved()) {
