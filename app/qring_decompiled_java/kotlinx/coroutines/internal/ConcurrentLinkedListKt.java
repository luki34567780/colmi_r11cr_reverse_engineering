...
public final class ConcurrentLinkedListKt {
    ...
    private static final <S extends kotlinx.coroutines.internal.Segment<S>> java.lang.Object findSegmentInternal(S s, long j, kotlin.jvm.functions.Function2<? super java.lang.Long, ? super S, ? extends S> function2) {
        while (true) {
            if (s.getId() >= j && !s.getRemoved()) {
                return kotlinx.coroutines.internal.SegmentOrClosed.m2577constructorimpl(s);
            }
            java.lang.Object obj = s.get_next();
            if (obj == CLOSED) {
                return kotlinx.coroutines.internal.SegmentOrClosed.m2577constructorimpl(CLOSED);
            }
            S s2 = (S) ((kotlinx.coroutines.internal.ConcurrentLinkedListNode) obj);
            if (s2 == null) {
                s2 = function2.invoke(java.lang.Long.valueOf(s.getId() + 1), s);
                if (s.trySetNext(s2)) {
                    if (s.getRemoved()) {
                        s.remove();
                    }
