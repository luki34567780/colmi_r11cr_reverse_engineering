...
final class TimedRunnable implements java.lang.Comparable<kotlinx.coroutines.test.TimedRunnable>, java.lang.Runnable, kotlinx.coroutines.internal.ThreadSafeHeapNode {
    ...
    public TimedRunnable(java.lang.Runnable runnable, long j, long j2) {
        this.run = runnable;
        this.count = j;
        this.time = j2;
    }
    ...
    public int compareTo(kotlinx.coroutines.test.TimedRunnable other) {
        ...
        long j2 = other.time;
        if (j == j2) {
            return kotlin.jvm.internal.Intrinsics.compare(this.count, other.count);
        }
