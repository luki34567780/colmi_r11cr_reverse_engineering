...
public interface SelectInstance<R> {
    ...
    void resumeSelectWithException(java.lang.Throwable exception);

    boolean trySelect();

    java.lang.Object trySelectOther(kotlinx.coroutines.internal.LockFreeLinkedListNode.PrepareOp otherOp);
}
