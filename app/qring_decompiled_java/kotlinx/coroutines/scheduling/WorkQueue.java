...
public final class WorkQueue {
    private static final /* synthetic */ java.util.concurrent.atomic.AtomicReferenceFieldUpdater lastScheduledTask$FU = java.util.concurrent.atomic.AtomicReferenceFieldUpdater.newUpdater(kotlinx.coroutines.scheduling.WorkQueue.class, java.lang.Object.class, "lastScheduledTask");
    private static final /* synthetic */ java.util.concurrent.atomic.AtomicIntegerFieldUpdater producerIndex$FU = java.util.concurrent.atomic.AtomicIntegerFieldUpdater.newUpdater(kotlinx.coroutines.scheduling.WorkQueue.class, "producerIndex");
    private static final /* synthetic */ java.util.concurrent.atomic.AtomicIntegerFieldUpdater consumerIndex$FU = java.util.concurrent.atomic.AtomicIntegerFieldUpdater.newUpdater(kotlinx.coroutines.scheduling.WorkQueue.class, "consumerIndex");
    private static final /* synthetic */ java.util.concurrent.atomic.AtomicIntegerFieldUpdater blockingTasksInBuffer$FU = java.util.concurrent.atomic.AtomicIntegerFieldUpdater.newUpdater(kotlinx.coroutines.scheduling.WorkQueue.class, "blockingTasksInBuffer");
    ...
    public final long tryStealFrom(kotlinx.coroutines.scheduling.WorkQueue victim) {
        if (kotlinx.coroutines.DebugKt.getASSERTIONS_ENABLED()) {
            if (!(getBufferSize$kotlinx_coroutines_core() == 0)) {
                throw new java.lang.AssertionError();
            }
        }
        kotlinx.coroutines.scheduling.Task pollBuffer = victim.pollBuffer();
        if (pollBuffer != null) {
            kotlinx.coroutines.scheduling.Task add$default = add$default(this, pollBuffer, false, 2, null);
            if (!kotlinx.coroutines.DebugKt.getASSERTIONS_ENABLED()) {
                return -1L;
            }
            if (add$default == null) {
    ...
    public final long tryStealBlockingFrom(kotlinx.coroutines.scheduling.WorkQueue victim) {
        if (kotlinx.coroutines.DebugKt.getASSERTIONS_ENABLED()) {
            if (!(getBufferSize$kotlinx_coroutines_core() == 0)) {
                throw new java.lang.AssertionError();
            }
    ...
    private final long tryStealLastScheduled(kotlinx.coroutines.scheduling.WorkQueue victim, boolean blockingOnly) {
        ...
        } while (!androidx.concurrent.futures.AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(lastScheduledTask$FU, victim, task, null));
        add$default(this, task, false, 2, null);
        return -1L;
    }
