...
public final class CoroutineScheduler implements java.util.concurrent.Executor, java.io.Closeable {
    ...
    private static final /* synthetic */ java.util.concurrent.atomic.AtomicLongFieldUpdater parkedWorkersStack$FU = java.util.concurrent.atomic.AtomicLongFieldUpdater.newUpdater(kotlinx.coroutines.scheduling.CoroutineScheduler.class, "parkedWorkersStack");
    static final /* synthetic */ java.util.concurrent.atomic.AtomicLongFieldUpdater controlState$FU = java.util.concurrent.atomic.AtomicLongFieldUpdater.newUpdater(kotlinx.coroutines.scheduling.CoroutineScheduler.class, "controlState");
    private static final /* synthetic */ java.util.concurrent.atomic.AtomicIntegerFieldUpdater _isTerminated$FU = java.util.concurrent.atomic.AtomicIntegerFieldUpdater.newUpdater(kotlinx.coroutines.scheduling.CoroutineScheduler.class, "_isTerminated");
    ...
    public CoroutineScheduler(int i, int i2, long j, java.lang.String str) {
        ...
        this.workers = new kotlinx.coroutines.internal.ResizableAtomicArray<>(i + 1);
    ...
    public void close() {
        shutdown(androidx.work.WorkRequest.MIN_BACKOFF_MILLIS);
    }
    ...
    public final void shutdown(long timeout) {
        ...
        if (_isTerminated$FU.compareAndSet(this, 0, 1)) {
            ...
            while (true) {
                kotlinx.coroutines.scheduling.Task findTask = currentWorker == null ? null : currentWorker.findTask(true);
    ...
    public java.lang.String toString() {
        ...
        while (i6 < currentLength) {
            ...
            if (worker != null) {
                ...
                int i8 = kotlinx.coroutines.scheduling.CoroutineScheduler.WhenMappings.$EnumSwitchMapping$0[worker.state.ordinal()];
                if (i8 == 1) {
                    i3++;
                } else if (i8 == 2) {
                    i2++;
    ...
    public final class Worker extends java.lang.Thread {
        static final /* synthetic */ java.util.concurrent.atomic.AtomicIntegerFieldUpdater workerCtl$FU = java.util.concurrent.atomic.AtomicIntegerFieldUpdater.newUpdater(kotlinx.coroutines.scheduling.CoroutineScheduler.Worker.class, "workerCtl");
        ...
        private final void tryPark() {
            ...
            this.workerCtl = -1;
            while (inStack() && this.workerCtl == -1 && !kotlinx.coroutines.scheduling.CoroutineScheduler.this.isTerminated() && this.state != kotlinx.coroutines.scheduling.CoroutineScheduler.WorkerState.TERMINATED) {
                tryReleaseCpu(kotlinx.coroutines.scheduling.CoroutineScheduler.WorkerState.PARKING);
                java.lang.Thread.interrupted();
                park();
            }
        ...
        private final kotlinx.coroutines.scheduling.Task trySteal(boolean blockingOnly) {
            long tryStealFrom;
            if (kotlinx.coroutines.DebugKt.getASSERTIONS_ENABLED()) {
                if (!(this.localQueue.getSize$kotlinx_coroutines_core() == 0)) {
                    throw new java.lang.AssertionError();
            ...
            int i = (int) (kotlinx.coroutines.scheduling.CoroutineScheduler.this.controlState & 2097151);
            if (i < 2) {
                return null;
            }
            ...
            while (i2 < i) {
                ...
                if (worker != null && worker != this) {
                    ...
                    if (tryStealFrom > 0) {
                        j = java.lang.Math.min(j, tryStealFrom);
                    }
                }
            }
            if (j == Long.MAX_VALUE) {
