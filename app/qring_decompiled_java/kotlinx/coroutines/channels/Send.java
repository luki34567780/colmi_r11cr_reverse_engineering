...
public abstract class Send extends kotlinx.coroutines.internal.LockFreeLinkedListNode {
    ...
    public abstract void resumeSendClosed(kotlinx.coroutines.channels.Closed<?> closed);

    public abstract kotlinx.coroutines.internal.Symbol tryResumeSend(kotlinx.coroutines.internal.LockFreeLinkedListNode.PrepareOp otherOp);
