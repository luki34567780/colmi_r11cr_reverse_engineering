...
public interface SendChannel<E> {
    ...
    java.lang.Object mo2529trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(kotlinx.coroutines.channels.SendChannel<? super E> sendChannel, E e) {
            java.lang.Object mo2529trySendJP2dKIU = sendChannel.mo2529trySendJP2dKIU(e);
            if (kotlinx.coroutines.channels.ChannelResult.m2544isSuccessimpl(mo2529trySendJP2dKIU)) {
                return true;
            }
            java.lang.Throwable m2538exceptionOrNullimpl = kotlinx.coroutines.channels.ChannelResult.m2538exceptionOrNullimpl(mo2529trySendJP2dKIU);
