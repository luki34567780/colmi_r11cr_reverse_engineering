...
public final class Closed<E> extends kotlinx.coroutines.channels.Send implements kotlinx.coroutines.channels.ReceiveOrClosed<E> {
    ...
    @Override // kotlinx.coroutines.channels.Send
    public kotlinx.coroutines.internal.Symbol tryResumeSend(kotlinx.coroutines.internal.LockFreeLinkedListNode.PrepareOp otherOp) {
    ...
    @Override // kotlinx.coroutines.channels.ReceiveOrClosed
    public kotlinx.coroutines.internal.Symbol tryResumeReceive(E value, kotlinx.coroutines.internal.LockFreeLinkedListNode.PrepareOp otherOp) {
        kotlinx.coroutines.internal.Symbol symbol = kotlinx.coroutines.CancellableContinuationImplKt.RESUME_TOKEN;
        if (otherOp != null) {
            otherOp.finishPrepare();
        }
    ...
    @Override // kotlinx.coroutines.channels.Send
    public void resumeSendClosed(kotlinx.coroutines.channels.Closed<?> closed) {
