...
@DebugMetadata(c = "kotlinx.coroutines.channels.ChannelsKt__DeprecatedKt$filterIndexed$1", f = "Deprecated.kt", i = {0, 0, 1, 1, 1, 2, 2}, l = {211, AudioEq.PARSE_EQ_DATA_LENGTH, AudioEq.PARSE_EQ_DATA_LENGTH}, m = "invokeSuspend", n = {"$this$produce", "index", "$this$produce", js.h, "index", "$this$produce", "index"}, s = {"L$0", "I$0", "L$0", "L$2", "I$0", "L$0", "I$0"})
