...
final /* synthetic */ class ChannelsKt__ChannelsKt {
    ...
    public static final <E> Object trySendBlocking(SendChannel<? super E> sendChannel, E e) {
        ...
        Object mo2529trySendJP2dKIU = sendChannel.mo2529trySendJP2dKIU(e);
        if (mo2529trySendJP2dKIU instanceof ChannelResult.Failed) {
        ...
        return ChannelResult.INSTANCE.m2549successJP2dKIU(Unit.INSTANCE);
    }
    ...
    public static final <E> void sendBlocking(SendChannel<? super E> sendChannel, E e) {
        if (ChannelResult.m2544isSuccessimpl(sendChannel.mo2529trySendJP2dKIU(e))) {
            return;
        }
