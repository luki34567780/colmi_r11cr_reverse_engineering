...
public final class CompletionStateKt {
    ...
    public static final <T> Object toState(Object obj, Function1<? super Throwable, Unit> function1) {
        Throwable m1094exceptionOrNullimpl = Result.m1094exceptionOrNullimpl(obj);
        if (m1094exceptionOrNullimpl == null) {
            return function1 != null ? new CompletedWithCancellation(obj, function1) : obj;
        }
        return new CompletedExceptionally(m1094exceptionOrNullimpl, false, 2, null);
    }
        ...
        if (m1094exceptionOrNullimpl != null) {
            if (DebugKt.getRECOVER_STACK_TRACES()) {
                ...
                if (cancellableContinuation2 instanceof CoroutineStackFrame) {
                    m1094exceptionOrNullimpl = StackTraceRecoveryKt.recoverFromStackFrame(m1094exceptionOrNullimpl, (CoroutineStackFrame) cancellableContinuation2);
                }
            }
            obj = new CompletedExceptionally(m1094exceptionOrNullimpl, false, 2, null);
        }
        return obj;
    }
    ...
    public static final <T> Object recoverResult(Object obj, Continuation<? super T> continuation) {
        if (obj instanceof CompletedExceptionally) {
            ...
            return Result.m1091constructorimpl(ResultKt.createFailure(th));
        }
        Result.Companion companion2 = Result.INSTANCE;
        return Result.m1091constructorimpl(obj);
    }
}
