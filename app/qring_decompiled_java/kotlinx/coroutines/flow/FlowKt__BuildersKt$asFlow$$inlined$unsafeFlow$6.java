...
public final class FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$6<T> implements kotlinx.coroutines.flow.Flow<T> {
    ...
    @kotlin.coroutines.jvm.internal.DebugMetadata(c = "kotlinx.coroutines.flow.FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$6", f = "Builders.kt", i = {0}, l = {115}, m = "collect", n = {"$this$asFlow_u24lambda_u2d11"}, s = {"L$0"})
