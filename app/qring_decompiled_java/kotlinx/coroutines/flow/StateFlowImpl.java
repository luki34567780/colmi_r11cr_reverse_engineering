            ...
            if ((i2 & 1) == 0) {
                ...
                while (true) {
                    ...
                    if (stateFlowSlotArr != null) {
                        ...
                        int i4 = 0;
                        while (i4 < length) {
                            kotlinx.coroutines.flow.StateFlowSlot stateFlowSlot = stateFlowSlotArr[i4];
                            i4++;
