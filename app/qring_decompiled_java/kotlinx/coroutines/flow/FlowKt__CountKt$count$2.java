...
final class FlowKt__CountKt$count$2<T> implements kotlinx.coroutines.flow.FlowCollector, kotlin.coroutines.jvm.internal.SuspendFunction {
    final /* synthetic */ kotlin.jvm.internal.Ref.IntRef $i;

    FlowKt__CountKt$count$2(kotlin.jvm.internal.Ref.IntRef intRef) {
        this.$i = intRef;
    }
