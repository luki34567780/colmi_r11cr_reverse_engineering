    ...
    */
    ...
    public boolean tryEmit(T value) {
        ...
        while (i < length) {
            ...
            if (continuation != null) {
                ...
                continuation.resumeWith(Result.m1091constructorimpl(Unit.INSTANCE));
            }
        }
        return z;
    }
    ...
    public final Object emitSuspend(T t, Continuation<? super Unit> continuation) {
        ...
        synchronized (this) {
            if (tryEmitLocked(t)) {
                Result.Companion companion = Result.INSTANCE;
                cancellableContinuationImpl2.resumeWith(Result.m1091constructorimpl(Unit.INSTANCE));
        ...
        while (i < length) {
            ...
            if (continuation2 != null) {
                ...
                continuation2.resumeWith(Result.m1091constructorimpl(Unit.INSTANCE));
            }
        }
