...
public class SkinMaterialTextInputEditText extends com.google.android.material.textfield.TextInputEditText implements skin.support.widget.SkinCompatSupportable {
    ...
    public SkinMaterialTextInputEditText(android.content.Context context) {
        this(context, null);
    }

    public SkinMaterialTextInputEditText(android.content.Context context, android.util.AttributeSet attributeSet) {
        this(context, attributeSet, androidx.appcompat.R.attr.editTextStyle);
    }

    public SkinMaterialTextInputEditText(android.content.Context context, android.util.AttributeSet attributeSet, int i) {
