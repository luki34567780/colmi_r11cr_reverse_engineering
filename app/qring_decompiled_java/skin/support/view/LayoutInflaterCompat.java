...
public final class LayoutInflaterCompat {
    ...
    static class Factory2Wrapper implements android.view.LayoutInflater.Factory2 {
        final skin.support.view.LayoutInflaterFactory mDelegateFactory;

        Factory2Wrapper(skin.support.view.LayoutInflaterFactory layoutInflaterFactory) {
    ...
    public static void setFactory(android.view.LayoutInflater layoutInflater, skin.support.view.LayoutInflaterFactory layoutInflaterFactory) {
        if (android.os.Build.VERSION.SDK_INT >= 21) {
            layoutInflater.setFactory2(layoutInflaterFactory != null ? new skin.support.view.LayoutInflaterCompat.Factory2Wrapper(layoutInflaterFactory) : null);
            return;
        }
        skin.support.view.LayoutInflaterCompat.Factory2Wrapper factory2Wrapper = layoutInflaterFactory != null ? new skin.support.view.LayoutInflaterCompat.Factory2Wrapper(layoutInflaterFactory) : null;
    ...
    @java.lang.Deprecated
    public static skin.support.view.LayoutInflaterFactory getFactory(android.view.LayoutInflater layoutInflater) {
        android.view.LayoutInflater.Factory factory = layoutInflater.getFactory();
        if (factory instanceof skin.support.view.LayoutInflaterCompat.Factory2Wrapper) {
            return ((skin.support.view.LayoutInflaterCompat.Factory2Wrapper) factory).mDelegateFactory;
        }
        return null;
    }
}
