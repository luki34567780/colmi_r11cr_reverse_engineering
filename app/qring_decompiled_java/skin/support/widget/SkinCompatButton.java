...
public class SkinCompatButton extends androidx.appcompat.widget.AppCompatButton implements skin.support.widget.SkinCompatSupportable {
    ...
    public SkinCompatButton(android.content.Context context) {
        this(context, null);
    }

    public SkinCompatButton(android.content.Context context, android.util.AttributeSet attributeSet) {
        this(context, attributeSet, androidx.appcompat.R.attr.buttonStyle);
    }

    public SkinCompatButton(android.content.Context context, android.util.AttributeSet attributeSet, int i) {
