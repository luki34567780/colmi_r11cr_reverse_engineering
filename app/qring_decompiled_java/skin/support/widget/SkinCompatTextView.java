...
public class SkinCompatTextView extends androidx.appcompat.widget.AppCompatTextView implements skin.support.widget.SkinCompatSupportable {
    ...
    public SkinCompatTextView(android.content.Context context) {
        this(context, null);
    }

    public SkinCompatTextView(android.content.Context context, android.util.AttributeSet attributeSet) {
        this(context, attributeSet, android.R.attr.textViewStyle);
    }

    public SkinCompatTextView(android.content.Context context, android.util.AttributeSet attributeSet, int i) {
