...
public class SkinCompatMultiAutoCompleteTextView extends androidx.appcompat.widget.AppCompatMultiAutoCompleteTextView implements skin.support.widget.SkinCompatSupportable {
    ...
    public SkinCompatMultiAutoCompleteTextView(android.content.Context context) {
        this(context, null);
    }

    public SkinCompatMultiAutoCompleteTextView(android.content.Context context, android.util.AttributeSet attributeSet) {
        this(context, attributeSet, skin.support.appcompat.R.attr.editTextStyle);
    }

    public SkinCompatMultiAutoCompleteTextView(android.content.Context context, android.util.AttributeSet attributeSet, int i) {
