...
public class SkinCompatRadioButton extends androidx.appcompat.widget.AppCompatRadioButton implements skin.support.widget.SkinCompatSupportable {
    ...
    public SkinCompatRadioButton(android.content.Context context) {
        this(context, null);
    }

    public SkinCompatRadioButton(android.content.Context context, android.util.AttributeSet attributeSet) {
        this(context, attributeSet, skin.support.appcompat.R.attr.radioButtonStyle);
    }

    public SkinCompatRadioButton(android.content.Context context, android.util.AttributeSet attributeSet, int i) {
