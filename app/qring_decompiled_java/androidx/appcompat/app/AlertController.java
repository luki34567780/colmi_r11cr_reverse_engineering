...
class AlertController {
    ...
    private final android.view.View.OnClickListener mButtonHandler = new android.view.View.OnClickListener() { // from class: androidx.appcompat.app.AlertController.1
        ...
        public void onClick(android.view.View view) {
            ...
            if (view == androidx.appcompat.app.AlertController.this.mButtonPositive && androidx.appcompat.app.AlertController.this.mButtonPositiveMessage != null) {
                obtain = android.os.Message.obtain(androidx.appcompat.app.AlertController.this.mButtonPositiveMessage);
                ...
                obtain = android.os.Message.obtain(androidx.appcompat.app.AlertController.this.mButtonNegativeMessage);
            } else {
                obtain = (view != androidx.appcompat.app.AlertController.this.mButtonNeutral || androidx.appcompat.app.AlertController.this.mButtonNeutralMessage == null) ? null : android.os.Message.obtain(androidx.appcompat.app.AlertController.this.mButtonNeutralMessage);
            }
            if (obtain != null) {
                obtain.sendToTarget();
            }
    ...
    private void setScrollIndicators(android.view.ViewGroup viewGroup, android.view.View view, int i, int i2) {
        final android.view.View findViewById = this.mWindow.findViewById(androidx.appcompat.R.id.scrollIndicatorUp);
        final android.view.View findViewById2 = this.mWindow.findViewById(androidx.appcompat.R.id.scrollIndicatorDown);
        ...
        if (this.mMessage != null) {
            this.mScrollView.setOnScrollChangeListener(new androidx.core.widget.NestedScrollView.OnScrollChangeListener() { // from class: androidx.appcompat.app.AlertController.2
                ...
                public void onScrollChange(androidx.core.widget.NestedScrollView nestedScrollView, int i3, int i4, int i5, int i6) {
                    androidx.appcompat.app.AlertController.manageScrollIndicators(nestedScrollView, findViewById, findViewById2);
                }
            });
            this.mScrollView.post(new java.lang.Runnable() { // from class: androidx.appcompat.app.AlertController.3
                @Override // java.lang.Runnable
                public void run() {
                    androidx.appcompat.app.AlertController.manageScrollIndicators(androidx.appcompat.app.AlertController.this.mScrollView, findViewById, findViewById2);
                }
            });
            return;
        }
        ...
        if (listView != null) {
            listView.setOnScrollListener(new android.widget.AbsListView.OnScrollListener() { // from class: androidx.appcompat.app.AlertController.4
                ...
                public void onScroll(android.widget.AbsListView absListView, int i3, int i4, int i5) {
                    androidx.appcompat.app.AlertController.manageScrollIndicators(absListView, findViewById, findViewById2);
                }
            });
            this.mListView.post(new java.lang.Runnable() { // from class: androidx.appcompat.app.AlertController.5
                @Override // java.lang.Runnable
                public void run() {
                    androidx.appcompat.app.AlertController.manageScrollIndicators(androidx.appcompat.app.AlertController.this.mListView, findViewById, findViewById2);
                }
            });
            return;
        }
        ...
        private void createListView(final androidx.appcompat.app.AlertController alertController) {
            ...
            if (this.mIsMultiChoice) {
                if (this.mCursor == null) {
                    listAdapter = new android.widget.ArrayAdapter<java.lang.CharSequence>(this.mContext, alertController.mMultiChoiceItemLayout, android.R.id.text1, this.mItems) { // from class: androidx.appcompat.app.AlertController.AlertParams.1
                    ...
                    listAdapter = new android.widget.CursorAdapter(this.mContext, this.mCursor, false) { // from class: androidx.appcompat.app.AlertController.AlertParams.2
                ...
                int i2 = i;
                if (this.mCursor != null) {
                    listAdapter = new android.widget.SimpleCursorAdapter(this.mContext, i2, this.mCursor, new java.lang.String[]{this.mLabelColumn}, new int[]{android.R.id.text1});
                } else {
                    listAdapter = this.mAdapter;
                    if (listAdapter == null) {
                        listAdapter = new androidx.appcompat.app.AlertController.CheckedItemAdapter(this.mContext, i2, android.R.id.text1, this.mItems);
                    }
                }
            }
