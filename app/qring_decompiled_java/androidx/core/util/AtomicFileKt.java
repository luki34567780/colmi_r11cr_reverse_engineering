...
public final class AtomicFileKt {
    public static final void tryWrite(android.util.AtomicFile atomicFile, kotlin.jvm.functions.Function1<? super java.io.FileOutputStream, kotlin.Unit> block) {
    ...
    public static final void writeText(android.util.AtomicFile atomicFile, java.lang.String text, java.nio.charset.Charset charset) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(atomicFile, "<this>");
    ...
    public static final byte[] readBytes(android.util.AtomicFile atomicFile) {
        ...
        kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(readFully, "readFully()");
        return readFully;
    }
