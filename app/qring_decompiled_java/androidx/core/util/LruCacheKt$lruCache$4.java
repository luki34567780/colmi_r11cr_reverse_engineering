...
public final class LruCacheKt$lruCache$4<K, V> extends android.util.LruCache<K, V> {
    ...
    public LruCacheKt$lruCache$4(kotlin.jvm.functions.Function2<? super K, ? super V, java.lang.Integer> function2, kotlin.jvm.functions.Function1<? super K, ? extends V> function1, kotlin.jvm.functions.Function4<? super java.lang.Boolean, ? super K, ? super V, ? super V, kotlin.Unit> function4, int i) {
        super(i);
