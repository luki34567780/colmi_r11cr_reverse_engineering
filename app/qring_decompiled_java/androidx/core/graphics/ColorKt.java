...
public final class ColorKt {
    ...
    public static final android.graphics.Color plus(android.graphics.Color color, android.graphics.Color c) {
        ...
        android.graphics.Color compositeColors = androidx.core.graphics.ColorUtils.compositeColors(c, color);
        kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(compositeColors, "compositeColors(c, this)");
    ...
    public static final android.graphics.Color convertTo(android.graphics.Color color, android.graphics.ColorSpace.Named colorSpace) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(color, "<this>");
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(colorSpace, "colorSpace");
        android.graphics.Color convert = color.convert(android.graphics.ColorSpace.get(colorSpace));
        kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(convert, "convert(ColorSpace.get(colorSpace))");
        return convert;
    }
    ...
    public static final android.graphics.Color convertTo(android.graphics.Color color, android.graphics.ColorSpace colorSpace) {
        ...
        kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(convert, "convert(colorSpace)");
        return convert;
    }
