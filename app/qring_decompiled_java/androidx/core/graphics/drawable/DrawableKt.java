...
public final class DrawableKt {
    ...
    public static final android.graphics.Bitmap toBitmap(android.graphics.drawable.Drawable drawable, int i, int i2, android.graphics.Bitmap.Config config) {
        ...
        if ((drawable instanceof android.graphics.drawable.BitmapDrawable) && (config == null || ((android.graphics.drawable.BitmapDrawable) drawable).getBitmap().getConfig() == config)) {
            ...
            kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(createScaledBitmap, "createScaledBitmap(bitmap, width, height, true)");
