...
public class ArcMotion extends androidx.transition.PathMotion {
    ...
    public ArcMotion(android.content.Context context, android.util.AttributeSet attributeSet) {
        ...
        this.mMinimumVerticalTangent = 0.0f;
        this.mMaximumTangent = DEFAULT_MAX_TANGENT;
        android.content.res.TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, androidx.transition.Styleable.ARC_MOTION);
        ...
        setMaximumAngle(androidx.core.content.res.TypedArrayUtils.getNamedFloat(obtainStyledAttributes, xmlPullParser, "maximumAngle", 2, DEFAULT_MAX_ANGLE_DEGREES));
