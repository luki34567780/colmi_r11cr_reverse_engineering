...
class MotionConstrainedPoint implements java.lang.Comparable<androidx.constraintlayout.core.motion.MotionConstrainedPoint> {
    ...
    public void addValues(java.util.HashMap<java.lang.String, androidx.constraintlayout.core.motion.utils.SplineSet> hashMap, int i) {
    ...
    public void setState(androidx.constraintlayout.core.motion.utils.Rect rect, androidx.constraintlayout.core.motion.MotionWidget motionWidget, int i, float f) {
        setBounds(rect.left, rect.f13top, rect.width(), rect.height());
        applyParameters(motionWidget);
