...
public class MotionWidget implements androidx.constraintlayout.core.motion.utils.TypedValues {
    ...
    public java.lang.String toString() {
        return this.widgetFrame.left + ", " + this.widgetFrame.f15top + ", " + this.widgetFrame.right + ", " + this.widgetFrame.bottom;
    }
    ...
    public boolean setValueMotion(int i, int i2) {
        switch (i) {
            case androidx.constraintlayout.core.motion.utils.TypedValues.MotionType.TYPE_ANIMATE_RELATIVE_TO /* 605 */:
            ...
            case androidx.constraintlayout.core.motion.utils.TypedValues.MotionType.TYPE_ANIMATE_CIRCLEANGLE_TO /* 606 */:
                ...
                return true;
            case androidx.constraintlayout.core.motion.utils.TypedValues.MotionType.TYPE_PATHMOTION_ARC /* 607 */:
    ...
    public boolean setValueMotion(int i, float f) {
        switch (i) {
            ...
            case 601:
                ...
                return true;
            case androidx.constraintlayout.core.motion.utils.TypedValues.MotionType.TYPE_QUANTIZE_MOTION_PHASE /* 602 */:
    ...
    public int getId(java.lang.String str) {
        int id = androidx.constraintlayout.core.motion.utils.TypedValues.AttributesType.CC.getId(str);
        return id != -1 ? id : androidx.constraintlayout.core.motion.utils.TypedValues.MotionType.CC.getId(str);
    }

    public int getTop() {
        return this.widgetFrame.f15top;
    }
    ...
    public int getHeight() {
        return this.widgetFrame.bottom - this.widgetFrame.f15top;
    }
