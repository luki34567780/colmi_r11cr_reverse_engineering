...
public class MotionKeyCycle extends androidx.constraintlayout.core.motion.key.MotionKey {
    ...
    public int getId(java.lang.String str) {
        ...
        switch (str.hashCode()) {
            ...
            case -1225497655:
                ...
                break;
            case -1019779949:
                if (str.equals(androidx.constraintlayout.core.motion.utils.TypedValues.CycleType.S_WAVE_OFFSET)) {
                    c = '\b';
                    break;
                }
                c = 65535;
    ...
    public void printAttributes() {
        ...
        for (int i = 0; i < strArr.length; i++) {
            androidx.constraintlayout.core.motion.utils.TypedValues.AttributesType.CC.getId(strArr[i]);
