...
public class SpringStopEngine implements androidx.constraintlayout.core.motion.utils.StopEngine {
    ...
    void log(java.lang.String str) {
        ...
        java.lang.String str2 = ".(" + stackTraceElement.getFileName() + ":" + stackTraceElement.getLineNumber() + ") " + stackTraceElement.getMethodName() + "() ";
    ...
    private void compute(double d) {
        ...
        int sqrt = (int) ((9.0d / ((java.lang.Math.sqrt(d2 / this.mMass) * d) * 4.0d)) + 1.0d);
        double d4 = d / sqrt;
        int i = 0;
        while (i < sqrt) {
            float f = this.mPos;
