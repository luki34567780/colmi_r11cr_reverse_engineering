...
public class HyperSpline {
    ...
    static androidx.constraintlayout.core.motion.utils.HyperSpline.Cubic[] calcNaturalCubic(int i, double[] dArr) {
        ...
        while (i3 < i2) {
            int i9 = i3 + 1;
            cubicArr[i3] = new androidx.constraintlayout.core.motion.utils.HyperSpline.Cubic((float) dArr[i3], dArr4[i3], (((dArr[i9] - dArr[i3]) * 3.0d) - (dArr4[i3] * 2.0d)) - dArr4[i9], ((dArr[i3] - dArr[i9]) * 2.0d) + dArr4[i3] + dArr4[i9]);
            i3 = i9;
        }
        return cubicArr;
    }
