...
public abstract class TimeCycleSplineSet {
    ...
    public static class CustomSet extends androidx.constraintlayout.core.motion.utils.TimeCycleSplineSet {
        ...
        public void setup(int i) {
            ...
            for (int i3 = 0; i3 < size; i3++) {
                ...
                androidx.constraintlayout.core.motion.CustomAttribute valueAt = this.mConstraintAttributeList.valueAt(i3);
    ...
    public void setup(int i) {
        ...
        androidx.constraintlayout.core.motion.utils.TimeCycleSplineSet.Sort.doubleQuickSort(this.mTimePoints, this.mValues, 0, i3 - 1);
        int i4 = 1;
        int i5 = 0;
        while (true) {
            int[] iArr = this.mTimePoints;
        ...
        double[][] dArr2 = (double[][]) java.lang.reflect.Array.newInstance((java.lang.Class<?>) double.class, i5, 3);
        int i6 = 0;
        while (i2 < this.count) {
            if (i2 > 0) {
    ...
    public static class CustomVarSet extends androidx.constraintlayout.core.motion.utils.TimeCycleSplineSet {
        ...
        public void setup(int i) {
            ...
            for (int i3 = 0; i3 < size; i3++) {
                int keyAt = this.mConstraintAttributeList.keyAt(i3);
                androidx.constraintlayout.core.motion.CustomVariable valueAt = this.mConstraintAttributeList.valueAt(i3);
                float[] valueAt2 = this.mWaveProperties.valueAt(i3);
                dArr[i3] = keyAt * 0.01d;
                valueAt.getValuesToInterpolate(this.mTempValues);
                int i4 = 0;
