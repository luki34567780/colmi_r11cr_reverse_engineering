...
public class MotionLabel extends android.view.View implements androidx.constraintlayout.motion.widget.FloatLayout {
    ...
    private void init(android.content.Context context, android.util.AttributeSet attrs) {
        ...
        if (attrs != null) {
            android.content.res.TypedArray obtainStyledAttributes = getContext().obtainStyledAttributes(attrs, androidx.constraintlayout.widget.R.styleable.MotionLabel);
    ...
    android.graphics.Bitmap blur(android.graphics.Bitmap bitmapOriginal, int factor) {
        ...
        android.graphics.Bitmap createScaledBitmap = android.graphics.Bitmap.createScaledBitmap(bitmapOriginal, width, height, true);
        for (int i = 0; i < factor && width >= 32 && height >= 32; i++) {
            width /= 2;
            height /= 2;
            createScaledBitmap = android.graphics.Bitmap.createScaledBitmap(createScaledBitmap, width, height, true);
        }
    ...
    public void layout(int l, int t, int r, int b) {
        ...
        boolean isNaN = java.lang.Float.isNaN(this.mBaseTextSize);
    ...
    private void setTypefaceFromAttrs(java.lang.String familyName, int typefaceIndex, int styleIndex) {
        ...
        if (familyName != null) {
            typeface = android.graphics.Typeface.create(familyName, styleIndex);
            if (typeface != null) {
        ...
        if (styleIndex > 0) {
            if (typeface == null) {
                create = android.graphics.Typeface.defaultFromStyle(styleIndex);
            } else {
                create = android.graphics.Typeface.create(typeface, styleIndex);
            }
            setTypeface(create);
                ...
                if (this.mViewOutlineProvider == null) {
                    android.view.ViewOutlineProvider viewOutlineProvider = new android.view.ViewOutlineProvider() { // from class: androidx.constraintlayout.utils.widget.MotionLabel.1
                        ...
                        public void getOutline(android.view.View view, android.graphics.Outline outline) {
                            outline.setRoundRect(0, 0, androidx.constraintlayout.utils.widget.MotionLabel.this.getWidth(), androidx.constraintlayout.utils.widget.MotionLabel.this.getHeight(), (java.lang.Math.min(r3, r4) * androidx.constraintlayout.utils.widget.MotionLabel.this.mRoundPercent) / 2.0f);
                        }
                    };
