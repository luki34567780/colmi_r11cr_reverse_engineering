...
public class ImageFilterView extends androidx.appcompat.widget.AppCompatImageView {
    ...
    static class ImageMatrix {
        ...
        private void warmth(float warmth) {
            ...
            if (f3 > 66.0f) {
                double d = f3 - 60.0f;
                f = ((float) java.lang.Math.pow(d, -0.13320475816726685d)) * 329.69873f;
            ...
            if (f3 < 66.0f) {
                f2 = f3 > 19.0f ? (((float) java.lang.Math.log(f3 - 10.0f)) * 138.51773f) - 305.0448f : 0.0f;
            } else {
                f2 = 255.0f;
            }
            float min = java.lang.Math.min(255.0f, java.lang.Math.max(f, 0.0f));
            float min2 = java.lang.Math.min(255.0f, java.lang.Math.max(log, 0.0f));
            float min3 = java.lang.Math.min(255.0f, java.lang.Math.max(f2, 0.0f));
            float log2 = (((float) java.lang.Math.log(50.0f)) * 99.4708f) - 161.11957f;
            float log3 = (((float) java.lang.Math.log(40.0f)) * 138.51773f) - 305.0448f;
            float min4 = java.lang.Math.min(255.0f, java.lang.Math.max(255.0f, 0.0f));
            float min5 = java.lang.Math.min(255.0f, java.lang.Math.max(log2, 0.0f));
            float min6 = min3 / java.lang.Math.min(255.0f, java.lang.Math.max(log3, 0.0f));
            float[] fArr = this.m;
            fArr[0] = min / min4;
            fArr[1] = 0.0f;
            fArr[2] = 0.0f;
    ...
    public void draw(android.graphics.Canvas canvas) {
        boolean z;
        if (android.os.Build.VERSION.SDK_INT >= 21 || this.mRoundPercent == 0.0f || this.mPath == null) {
            z = false;
        } else {
            z = true;
            canvas.save();
