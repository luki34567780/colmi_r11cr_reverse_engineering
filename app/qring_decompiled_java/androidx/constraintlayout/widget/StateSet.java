...
public class StateSet {
    ...
    private void load(android.content.Context context, org.xmlpull.v1.XmlPullParser parser) {
        android.content.res.TypedArray obtainStyledAttributes = context.obtainStyledAttributes(android.util.Xml.asAttributeSet(parser), androidx.constraintlayout.widget.R.styleable.StateSet);
    ...
    public boolean needsToChange(int id, float width, float height) {
        ...
        androidx.constraintlayout.widget.StateSet.State valueAt = id == -1 ? this.mStateList.valueAt(0) : this.mStateList.get(i);
    ...
    public int updateConstraints(int currentId, int id, float width, float height) {
        ...
        int findMatch;
        if (currentId != id) {
            androidx.constraintlayout.widget.StateSet.State state2 = this.mStateList.get(id);
            if (state2 == null) {
                return -1;
            }
