...
public class ConstraintSet {
    ...
    static void parseDimensionConstraints(java.lang.Object data, android.content.res.TypedArray a, int attr, int orientation) {
        if (data == null) {
            return;
        }
        ...
        if (value != null) {
            ...
            try {
                if (indexOf2 >= 0 && indexOf2 < length - 1) {
                    java.lang.String substring2 = value.substring(i2, indexOf2);
                    java.lang.String substring3 = value.substring(indexOf2 + 1);
                    ...
                    java.lang.String substring4 = value.substring(i2);
    ...
    static void parseDimensionConstraintsString(java.lang.Object data, java.lang.String value, int orientation) {
        ...
        java.lang.String substring = value.substring(0, indexOf);
        java.lang.String substring2 = value.substring(indexOf + 1);
        if (substring2.length() > 0) {
            ...
            if (KEY_RATIO.equalsIgnoreCase(trim)) {
                ...
                if (data instanceof androidx.constraintlayout.widget.ConstraintSet.Layout) {
                    ((androidx.constraintlayout.widget.ConstraintSet.Layout) data).dimensionRatio = trim2;
                    return;
                } else {
                    if (data instanceof androidx.constraintlayout.widget.ConstraintSet.Constraint.Delta) {
                        ((androidx.constraintlayout.widget.ConstraintSet.Constraint.Delta) data).add(5, trim2);
                        return;
                    }
                    return;
                }
    ...
    public static class Layout {
        ...
        void fillFromAttributeList(android.content.Context context, android.util.AttributeSet attrs) {
            android.content.res.TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attrs, androidx.constraintlayout.widget.R.styleable.Layout);
            this.mApply = true;
                            ...
                            default:
                                switch (i2) {
                                    ...
                                    case 76:
                                        ...
                                        break;
                                    case 77:
                                        this.baselineToTop = androidx.constraintlayout.widget.ConstraintSet.lookupID(obtainStyledAttributes, index, this.baselineToTop);
                                        break;
                                    case 78:
                                        this.baselineToBottom = androidx.constraintlayout.widget.ConstraintSet.lookupID(obtainStyledAttributes, index, this.baselineToBottom);
                                        break;
                                    case 79:
    ...
    public static class Transform {
        ...
        void fillFromAttributeList(android.content.Context context, android.util.AttributeSet attrs) {
            android.content.res.TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attrs, androidx.constraintlayout.widget.R.styleable.Transform);
            this.mApply = true;
            int indexCount = obtainStyledAttributes.getIndexCount();
            for (int i = 0; i < indexCount; i++) {
                int index = obtainStyledAttributes.getIndex(i);
                switch (mapToConstant.get(index)) {
                    ...
                    case 12:
                        this.transformPivotTarget = androidx.constraintlayout.widget.ConstraintSet.lookupID(obtainStyledAttributes, index, this.transformPivotTarget);
                        break;
                }
            }
            obtainStyledAttributes.recycle();
    ...
    public static class PropertySet {
        ...
        void fillFromAttributeList(android.content.Context context, android.util.AttributeSet attrs) {
            android.content.res.TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attrs, androidx.constraintlayout.widget.R.styleable.PropertySet);
            this.mApply = true;
            int indexCount = obtainStyledAttributes.getIndexCount();
            for (int i = 0; i < indexCount; i++) {
                int index = obtainStyledAttributes.getIndex(i);
    ...
    public static class Motion {
        ...
        void fillFromAttributeList(android.content.Context context, android.util.AttributeSet attrs) {
            android.content.res.TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attrs, androidx.constraintlayout.widget.R.styleable.Motion);
            this.mApply = true;
            int indexCount = obtainStyledAttributes.getIndexCount();
            for (int i = 0; i < indexCount; i++) {
                int index = obtainStyledAttributes.getIndex(i);
                switch (mapToConstant.get(index)) {
                    ...
                    case 3:
                        if (obtainStyledAttributes.peekValue(index).type == 3) {
                            ...
                            this.mTransitionEasing = androidx.constraintlayout.core.motion.utils.Easing.NAMED_EASING[obtainStyledAttributes.getInteger(index, 0)];
                            break;
                        }
                    case 4:
    ...
    public static class Constraint {
        ...
        public androidx.constraintlayout.widget.ConstraintSet.Constraint m134clone() {
    ...
    public void parseIntAttributes(androidx.constraintlayout.widget.ConstraintSet.Constraint set, java.lang.String attributes) {
        java.lang.String[] split = attributes.split(",");
        for (int i = 0; i < split.length; i++) {
            java.lang.String[] split2 = split[i].split("=");
            if (split2.length == 2) {
                set.setFloatValue(split2[0], java.lang.Integer.decode(split2[1]).intValue());
            } else {
                android.util.Log.w(TAG, " Unable to parse " + split[i]);
            }
        }
    }
    ...
    public void parseColorAttributes(androidx.constraintlayout.widget.ConstraintSet.Constraint set, java.lang.String attributes) {
        ...
        for (int i = 0; i < split.length; i++) {
            java.lang.String[] split2 = split[i].split("=");
            if (split2.length == 2) {
                set.setColorValue(split2[0], android.graphics.Color.parseColor(split2[1]));
            } else {
                android.util.Log.w(TAG, " Unable to parse " + split[i]);
            }
        }
    ...
    public void parseFloatAttributes(androidx.constraintlayout.widget.ConstraintSet.Constraint set, java.lang.String attributes) {
        ...
        for (int i = 0; i < split.length; i++) {
            java.lang.String[] split2 = split[i].split("=");
            if (split2.length == 2) {
                set.setFloatValue(split2[0], java.lang.Float.parseFloat(split2[1]));
            } else {
                android.util.Log.w(TAG, " Unable to parse " + split[i]);
            }
        }
    ...
    public void parseStringAttributes(androidx.constraintlayout.widget.ConstraintSet.Constraint set, java.lang.String attributes) {
        java.lang.String[] splitString = splitString(attributes);
        for (int i = 0; i < splitString.length; i++) {
            java.lang.String[] split = splitString[i].split("=");
            android.util.Log.w(TAG, " Unable to parse " + splitString[i]);
        ...
        try {
            for (int eventType = xml.getEventType(); eventType != 1; eventType = xml.next()) {
                if (eventType == 0) {
                    ...
                    androidx.constraintlayout.widget.ConstraintSet.Constraint fillFromAttributeList = fillFromAttributeList(context, android.util.Xml.asAttributeSet(xml), false);
    ...
    */
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static int lookupID(android.content.res.TypedArray a, int index, int def) {
    ...
    private androidx.constraintlayout.widget.ConstraintSet.Constraint fillFromAttributeList(android.content.Context context, android.util.AttributeSet attrs, boolean override) {
        androidx.constraintlayout.widget.ConstraintSet.Constraint constraint = new androidx.constraintlayout.widget.ConstraintSet.Constraint();
        android.content.res.TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attrs, override ? androidx.constraintlayout.widget.R.styleable.ConstraintOverride : androidx.constraintlayout.widget.R.styleable.Constraint);
    ...
    public static androidx.constraintlayout.widget.ConstraintSet.Constraint buildDelta(android.content.Context context, org.xmlpull.v1.XmlPullParser parser) {
        android.util.AttributeSet asAttributeSet = android.util.Xml.asAttributeSet(parser);
        androidx.constraintlayout.widget.ConstraintSet.Constraint constraint = new androidx.constraintlayout.widget.ConstraintSet.Constraint();
    ...
    private static void populateOverride(android.content.Context ctx, androidx.constraintlayout.widget.ConstraintSet.Constraint c, android.content.res.TypedArray a) {
            ...
            switch (overrideMapToConstant.get(index)) {
                ...
                case 65:
                    if (a.peekValue(index).type == 3) {
                        ...
                        delta.add(65, androidx.constraintlayout.core.motion.utils.Easing.NAMED_EASING[a.getInteger(index, 0)]);
                        break;
                    }
                case 66:
                ...
                case 85:
                    ...
                    break;
                case 86:
                    android.util.TypedValue peekValue = a.peekValue(index);
                    if (peekValue.type == 1) {
    ...
    private void populateConstraint(android.content.Context ctx, androidx.constraintlayout.widget.ConstraintSet.Constraint c, android.content.res.TypedArray a, boolean override) {
        if (override) {
            ...
            switch (mapToConstant.get(index)) {
                ...
                case 65:
                    if (a.peekValue(index).type == 3) {
                        ...
                        c.motion.mTransitionEasing = androidx.constraintlayout.core.motion.utils.Easing.NAMED_EASING[a.getInteger(index, 0)];
                        break;
                    }
                case 66:
    ...
    private int[] convertReferenceString(android.view.View view, java.lang.String referenceIdString) {
        ...
        while (i2 < split.length) {
            ...
            if (i == 0) {
                i = context.getResources().getIdentifier(trim, com.liulishuo.okdownload.core.breakpoint.BreakpointSQLiteKey.ID, context.getPackageName());
            }
    ...
    class WriteXmlEngine {
        ...
        void writeLayout() throws java.io.IOException {
            ...
            for (java.lang.Integer num : androidx.constraintlayout.widget.ConstraintSet.this.mConstraints.keySet()) {
                ...
                writeEnum("app:barrierDirection", layout.mBarrierDirection, new java.lang.String[]{"left", "right", "top", "bottom", "start", "end"}, -1);
        ...
        java.lang.String getName(int id) {
            ...
            java.lang.String lookup = lookup(id);
            this.idMap.put(java.lang.Integer.valueOf(id), lookup);
            return "@+id/" + lookup + "";
        }
