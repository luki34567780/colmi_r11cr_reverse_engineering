...
public class RotationGestureDetector {
    ...
    private com.yalantis.ucrop.util.RotationGestureDetector.OnRotationGestureListener mListener;
    ...
    public interface OnRotationGestureListener {
        boolean onRotation(com.yalantis.ucrop.util.RotationGestureDetector rotationGestureDetector);
    }

    public static class SimpleOnRotationGestureListener implements com.yalantis.ucrop.util.RotationGestureDetector.OnRotationGestureListener {
    ...
    public RotationGestureDetector(com.yalantis.ucrop.util.RotationGestureDetector.OnRotationGestureListener onRotationGestureListener) {
    ...
    public boolean onTouchEvent(android.view.MotionEvent motionEvent) {
        ...
        if (actionMasked == 0) {
            ...
            com.yalantis.ucrop.util.RotationGestureDetector.OnRotationGestureListener onRotationGestureListener = this.mListener;
    ...
    private float calculateAngleBetweenLines(float f, float f2, float f3, float f4, float f5, float f6, float f7, float f8) {
        return calculateAngleDelta((float) java.lang.Math.toDegrees((float) java.lang.Math.atan2(f2 - f4, f - f3)), (float) java.lang.Math.toDegrees((float) java.lang.Math.atan2(f6 - f8, f5 - f7)));
    }
