...
public class RomUtils {
    ...
    private static boolean isMIUIV6OrAbove() {
        ...
        try {
            return com.luck.picture.lib.utils.ValueOf.toInt(systemProperty) >= 4;
    ...
    public static int getMIUIVersionCode() {
        ...
        try {
            return com.luck.picture.lib.utils.ValueOf.toInt(systemProperty);
        } catch (java.lang.Exception e) {
            e.printStackTrace();
            return 0;
        }
    ...
    private static java.lang.String getSystemProperty() {
        ...
        try {
            bufferedReader = new java.io.BufferedReader(new java.io.InputStreamReader(java.lang.Runtime.getRuntime().exec("getprop ro.miui.ui.version.code").getInputStream()), com.realsil.sdk.bbpro.equalizer.EqConstants.CodeIndex.REALTIME_EQ_2);
            try {
    ...
    public static int stringToInt(java.lang.String str) {
        if (java.util.regex.Pattern.compile("^[-\\+]?[\\d]+$").matcher(str).matches()) {
            return com.luck.picture.lib.utils.ValueOf.toInt(str);
        }
        return 0;
    }
}
