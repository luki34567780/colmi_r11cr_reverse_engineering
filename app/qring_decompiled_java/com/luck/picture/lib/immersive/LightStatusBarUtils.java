...
public class LightStatusBarUtils {
    ...
    public static void setLightStatusBar(android.app.Activity activity, boolean z, boolean z2, boolean z3, boolean z4) {
        int lightStatusBarAvailableRomType = com.luck.picture.lib.immersive.RomUtils.getLightStatusBarAvailableRomType();
        if (lightStatusBarAvailableRomType == 1) {
            if (com.luck.picture.lib.immersive.RomUtils.getMIUIVersionCode() >= 7) {
    ...
    private static boolean setFlymeLightStatusBar(android.app.Activity activity, boolean z, boolean z2, boolean z3, boolean z4) {
        ...
        try {
            ...
            try {
                if (com.luck.picture.lib.immersive.RomUtils.getFlymeVersion() < 7) {
                    return true;
                }
                setAndroidNativeLightStatusBar(activity, z, z2, z3, z4);
                return true;
