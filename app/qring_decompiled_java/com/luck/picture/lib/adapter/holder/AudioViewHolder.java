...
public class AudioViewHolder extends com.luck.picture.lib.adapter.holder.BaseRecyclerMediaHolder {
    private final android.widget.TextView tvDuration;

    public AudioViewHolder(android.view.View view, com.luck.picture.lib.config.SelectorConfig selectorConfig) {
    ...
    protected void loadCover(java.lang.String str) {
        this.ivPicture.setImageResource(com.luck.picture.lib.R.drawable.ps_audio_placeholder);
    }
}
