...
public class LruCache<K, V> {
    ...
    */
    ...
    public final synchronized java.lang.String toString() {
        ...
        i = this.hitCount;
        i2 = this.missCount + i;
        return java.lang.String.format("LruCache[maxSize=%d,hits=%d,misses=%d,hitRate=%d%%]", java.lang.Integer.valueOf(this.maxSize), java.lang.Integer.valueOf(this.hitCount), java.lang.Integer.valueOf(this.missCount), java.lang.Integer.valueOf(i2 != 0 ? (i * 100) / i2 : 0));
    }
}
