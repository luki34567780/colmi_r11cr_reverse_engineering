...
public class BaseUpFetchModule implements com.chad.library.adapter.base.listener.UpFetchListenerImp {
    ...
    private com.chad.library.adapter.base.listener.OnUpFetchListener mUpFetchListener;
    private int startUpFetchPosition;

    public BaseUpFetchModule(com.chad.library.adapter.base.BaseQuickAdapter<?, ?> baseQuickAdapter) {
    ...
    public void setOnUpFetchListener(com.chad.library.adapter.base.listener.OnUpFetchListener listener) {
