...
public class BaseDraggableModule implements com.chad.library.adapter.base.listener.DraggableListenerImp {
    ...
    public androidx.recyclerview.widget.ItemTouchHelper itemTouchHelper;
    public com.chad.library.adapter.base.dragswipe.DragAndSwipeCallback itemTouchHelperCallback;
    private com.chad.library.adapter.base.listener.OnItemDragListener mOnItemDragListener;
    private com.chad.library.adapter.base.listener.OnItemSwipeListener mOnItemSwipeListener;
    private android.view.View.OnLongClickListener mOnToggleViewLongClickListener;
    private android.view.View.OnTouchListener mOnToggleViewTouchListener;
    private int toggleViewId;

    public BaseDraggableModule(com.chad.library.adapter.base.BaseQuickAdapter<?, ?> baseQuickAdapter) {
    ...
    public final androidx.recyclerview.widget.ItemTouchHelper getItemTouchHelper() {
        androidx.recyclerview.widget.ItemTouchHelper itemTouchHelper = this.itemTouchHelper;
        if (itemTouchHelper != null) {
            return itemTouchHelper;
        }
        kotlin.jvm.internal.Intrinsics.throwUninitializedPropertyAccessException("itemTouchHelper");
        return null;
    }

    public final void setItemTouchHelper(androidx.recyclerview.widget.ItemTouchHelper itemTouchHelper) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(itemTouchHelper, "<set-?>");
        this.itemTouchHelper = itemTouchHelper;
    }

    public final com.chad.library.adapter.base.dragswipe.DragAndSwipeCallback getItemTouchHelperCallback() {
        com.chad.library.adapter.base.dragswipe.DragAndSwipeCallback dragAndSwipeCallback = this.itemTouchHelperCallback;
        if (dragAndSwipeCallback != null) {
            return dragAndSwipeCallback;
        }
        kotlin.jvm.internal.Intrinsics.throwUninitializedPropertyAccessException("itemTouchHelperCallback");
        return null;
    }

    public final void setItemTouchHelperCallback(com.chad.library.adapter.base.dragswipe.DragAndSwipeCallback dragAndSwipeCallback) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(dragAndSwipeCallback, "<set-?>");
    ...
    protected final void setMOnToggleViewTouchListener(android.view.View.OnTouchListener onTouchListener) {
    ...
    protected final void setMOnToggleViewLongClickListener(android.view.View.OnLongClickListener onLongClickListener) {
    ...
    protected final void setMOnItemDragListener(com.chad.library.adapter.base.listener.OnItemDragListener onItemDragListener) {
    ...
    protected final void setMOnItemSwipeListener(com.chad.library.adapter.base.listener.OnItemSwipeListener onItemSwipeListener) {
        this.mOnItemSwipeListener = onItemSwipeListener;
    }

    private final void initItemTouch() {
        setItemTouchHelperCallback(new com.chad.library.adapter.base.dragswipe.DragAndSwipeCallback(this));
        setItemTouchHelper(new androidx.recyclerview.widget.ItemTouchHelper(getItemTouchHelperCallback()));
    }

    public final void initView$com_github_CymChad_brvah(com.chad.library.adapter.base.viewholder.BaseViewHolder holder) {
        ...
        if (this.isDragEnabled && hasToggleView() && (findViewById = holder.itemView.findViewById(this.toggleViewId)) != null) {
            findViewById.setTag(com.chad.library.R.id.BaseQuickAdapter_viewholder_support, holder);
    ...
    public final void attachToRecyclerView(androidx.recyclerview.widget.RecyclerView recyclerView) {
    ...
    public void setDragOnLongPressEnabled(boolean z) {
        ...
        if (z) {
            ...
            this.mOnToggleViewLongClickListener = new android.view.View.OnLongClickListener() { // from class: com.chad.library.adapter.base.module.BaseDraggableModule$$ExternalSyntheticLambda0
                @Override // android.view.View.OnLongClickListener
                public final boolean onLongClick(android.view.View view) {
                    boolean m32_set_isDragOnLongPressEnabled_$lambda0;
                    m32_set_isDragOnLongPressEnabled_$lambda0 = com.chad.library.adapter.base.module.BaseDraggableModule.m32_set_isDragOnLongPressEnabled_$lambda0(com.chad.library.adapter.base.module.BaseDraggableModule.this, view);
                    return m32_set_isDragOnLongPressEnabled_$lambda0;
                }
            };
        } else {
            this.mOnToggleViewTouchListener = new android.view.View.OnTouchListener() { // from class: com.chad.library.adapter.base.module.BaseDraggableModule$$ExternalSyntheticLambda1
                @Override // android.view.View.OnTouchListener
                public final boolean onTouch(android.view.View view, android.view.MotionEvent motionEvent) {
                    boolean m33_set_isDragOnLongPressEnabled_$lambda1;
                    m33_set_isDragOnLongPressEnabled_$lambda1 = com.chad.library.adapter.base.module.BaseDraggableModule.m33_set_isDragOnLongPressEnabled_$lambda1(com.chad.library.adapter.base.module.BaseDraggableModule.this, view, motionEvent);
                    return m33_set_isDragOnLongPressEnabled_$lambda1;
                }
            };
    ...
    public static final boolean m32_set_isDragOnLongPressEnabled_$lambda0(com.chad.library.adapter.base.module.BaseDraggableModule baseDraggableModule, android.view.View view) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(baseDraggableModule, "this$0");
        if (!baseDraggableModule.isDragEnabled) {
            return true;
        }
        androidx.recyclerview.widget.ItemTouchHelper itemTouchHelper = baseDraggableModule.getItemTouchHelper();
        java.lang.Object tag = view.getTag(com.chad.library.R.id.BaseQuickAdapter_viewholder_support);
        java.util.Objects.requireNonNull(tag, "null cannot be cast to non-null type androidx.recyclerview.widget.RecyclerView.ViewHolder");
        itemTouchHelper.startDrag((androidx.recyclerview.widget.RecyclerView.ViewHolder) tag);
        return true;
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: _set_isDragOnLongPressEnabled_$lambda-1, reason: not valid java name */
    public static final boolean m33_set_isDragOnLongPressEnabled_$lambda1(com.chad.library.adapter.base.module.BaseDraggableModule baseDraggableModule, android.view.View view, android.view.MotionEvent motionEvent) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(baseDraggableModule, "this$0");
    ...
    protected final int getViewHolderPosition(androidx.recyclerview.widget.RecyclerView.ViewHolder viewHolder) {
    ...
    public void onItemDragStart(androidx.recyclerview.widget.RecyclerView.ViewHolder viewHolder) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(viewHolder, "viewHolder");
        com.chad.library.adapter.base.listener.OnItemDragListener onItemDragListener = this.mOnItemDragListener;
        if (onItemDragListener != null) {
            onItemDragListener.onItemDragStart(viewHolder, getViewHolderPosition(viewHolder));
        }
    }

    public void onItemDragMoving(androidx.recyclerview.widget.RecyclerView.ViewHolder source, androidx.recyclerview.widget.RecyclerView.ViewHolder target) {
        ...
        if (inRange(viewHolderPosition) && inRange(viewHolderPosition2)) {
            if (viewHolderPosition < viewHolderPosition2) {
                ...
                while (i < viewHolderPosition2) {
                    int i2 = i + 1;
                    java.util.Collections.swap(this.baseQuickAdapter.getData(), i, i2);
                    i = i2;
                }
            } else {
                ...
                if (i3 <= viewHolderPosition) {
                    ...
                    while (true) {
                        java.util.Collections.swap(this.baseQuickAdapter.getData(), i4, i4 - 1);
                        if (i4 == i3) {
                            break;
                        } else {
                            i4--;
    ...
    public void onItemDragEnd(androidx.recyclerview.widget.RecyclerView.ViewHolder viewHolder) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(viewHolder, "viewHolder");
        com.chad.library.adapter.base.listener.OnItemDragListener onItemDragListener = this.mOnItemDragListener;
        if (onItemDragListener != null) {
    ...
    public void onItemSwipeStart(androidx.recyclerview.widget.RecyclerView.ViewHolder viewHolder) {
        com.chad.library.adapter.base.listener.OnItemSwipeListener onItemSwipeListener;
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(viewHolder, "viewHolder");
    ...
    public void onItemSwipeClear(androidx.recyclerview.widget.RecyclerView.ViewHolder viewHolder) {
        com.chad.library.adapter.base.listener.OnItemSwipeListener onItemSwipeListener;
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(viewHolder, "viewHolder");
        if (!this.isSwipeEnabled || (onItemSwipeListener = this.mOnItemSwipeListener) == null) {
            return;
    ...
    public void onItemSwiped(androidx.recyclerview.widget.RecyclerView.ViewHolder viewHolder) {
        com.chad.library.adapter.base.listener.OnItemSwipeListener onItemSwipeListener;
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(viewHolder, "viewHolder");
    ...
    public void onItemSwiping(android.graphics.Canvas canvas, androidx.recyclerview.widget.RecyclerView.ViewHolder viewHolder, float dX, float dY, boolean isCurrentlyActive) {
        com.chad.library.adapter.base.listener.OnItemSwipeListener onItemSwipeListener;
        if (!this.isSwipeEnabled || (onItemSwipeListener = this.mOnItemSwipeListener) == null) {
            return;
        }
    ...
    public void setOnItemDragListener(com.chad.library.adapter.base.listener.OnItemDragListener onItemDragListener) {
        this.mOnItemDragListener = onItemDragListener;
    }

    @Override // com.chad.library.adapter.base.listener.DraggableListenerImp
    public void setOnItemSwipeListener(com.chad.library.adapter.base.listener.OnItemSwipeListener onItemSwipeListener) {
        this.mOnItemSwipeListener = onItemSwipeListener;
    }
}
