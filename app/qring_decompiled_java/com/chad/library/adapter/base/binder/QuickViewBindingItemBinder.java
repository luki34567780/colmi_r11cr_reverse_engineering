...
public abstract class QuickViewBindingItemBinder<T, VB extends androidx.viewbinding.ViewBinding> extends com.chad.library.adapter.base.binder.BaseItemBinder<T, com.chad.library.adapter.base.binder.QuickViewBindingItemBinder.BinderVBHolder<VB>> {
    public abstract VB onCreateViewBinding(android.view.LayoutInflater layoutInflater, android.view.ViewGroup parent, int viewType);
    ...
    public com.chad.library.adapter.base.binder.QuickViewBindingItemBinder.BinderVBHolder<VB> onCreateViewHolder(android.view.ViewGroup parent, int viewType) {
