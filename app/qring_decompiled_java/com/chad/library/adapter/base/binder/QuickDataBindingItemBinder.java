...
public abstract class QuickDataBindingItemBinder<T, DB extends androidx.databinding.ViewDataBinding> extends com.chad.library.adapter.base.binder.BaseItemBinder<T, com.chad.library.adapter.base.binder.QuickDataBindingItemBinder.BinderDataBindingHolder<DB>> {
    public abstract DB onCreateDataBinding(android.view.LayoutInflater layoutInflater, android.view.ViewGroup parent, int viewType);
    ...
    public com.chad.library.adapter.base.binder.QuickDataBindingItemBinder.BinderDataBindingHolder<DB> onCreateViewHolder(android.view.ViewGroup parent, int viewType) {
