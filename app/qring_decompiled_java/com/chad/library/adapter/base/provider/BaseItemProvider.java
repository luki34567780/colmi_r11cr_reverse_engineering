...
public abstract class BaseItemProvider<T> {
    ...
    private java.lang.ref.WeakReference<com.chad.library.adapter.base.BaseProviderMultiAdapter<T>> weakAdapter;

    /* renamed from: clickViewIds$delegate, reason: from kotlin metadata */
    private final kotlin.Lazy clickViewIds = kotlin.LazyKt.lazy(kotlin.LazyThreadSafetyMode.NONE, new kotlin.jvm.functions.Function0<java.util.ArrayList<java.lang.Integer>>() { // from class: com.chad.library.adapter.base.provider.BaseItemProvider$clickViewIds$2
    ...
    private final kotlin.Lazy longClickViewIds = kotlin.LazyKt.lazy(kotlin.LazyThreadSafetyMode.NONE, new kotlin.jvm.functions.Function0<java.util.ArrayList<java.lang.Integer>>() { // from class: com.chad.library.adapter.base.provider.BaseItemProvider$longClickViewIds$2
        public final java.util.ArrayList<java.lang.Integer> invoke() {
            return new java.util.ArrayList<>();
        }
    });

    public abstract void convert(com.chad.library.adapter.base.viewholder.BaseViewHolder helper, T item);

    public void convert(com.chad.library.adapter.base.viewholder.BaseViewHolder helper, T item, java.util.List<? extends java.lang.Object> payloads) {
    ...
    public void onChildClick(com.chad.library.adapter.base.viewholder.BaseViewHolder helper, android.view.View view, T data, int position) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(helper, "helper");
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(view, "view");
    }

    public boolean onChildLongClick(com.chad.library.adapter.base.viewholder.BaseViewHolder helper, android.view.View view, T data, int position) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(helper, "helper");
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(view, "view");
        return false;
    }

    public void onClick(com.chad.library.adapter.base.viewholder.BaseViewHolder helper, android.view.View view, T data, int position) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(helper, "helper");
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(view, "view");
    }

    public boolean onLongClick(com.chad.library.adapter.base.viewholder.BaseViewHolder helper, android.view.View view, T data, int position) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(helper, "helper");
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(view, "view");
        return false;
    }
    ...
    public final void setAdapter$com_github_CymChad_brvah(com.chad.library.adapter.base.BaseProviderMultiAdapter<T> adapter) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(adapter, "adapter");
        this.weakAdapter = new java.lang.ref.WeakReference<>(adapter);
    }

    public com.chad.library.adapter.base.BaseProviderMultiAdapter<T> getAdapter() {
        java.lang.ref.WeakReference<com.chad.library.adapter.base.BaseProviderMultiAdapter<T>> weakReference = this.weakAdapter;
