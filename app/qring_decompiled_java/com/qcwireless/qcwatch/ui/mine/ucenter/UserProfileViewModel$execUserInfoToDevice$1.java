...
@kotlin.coroutines.jvm.internal.DebugMetadata(c = "com.qcwireless.qcwatch.ui.mine.ucenter.UserProfileViewModel$execUserInfoToDevice$1", f = "UserProfileViewModel.kt", i = {}, l = {316, 317}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: /tmp/dex/classes2.dex */
final class UserProfileViewModel$execUserInfoToDevice$1 extends kotlin.coroutines.jvm.internal.SuspendLambda implements kotlin.jvm.functions.Function2<kotlinx.coroutines.CoroutineScope, kotlin.coroutines.Continuation<? super kotlin.Unit>, java.lang.Object> {
    ...
    UserProfileViewModel$execUserInfoToDevice$1(int i, int i2, int i3, int i4, kotlin.coroutines.Continuation<? super com.qcwireless.qcwatch.ui.mine.ucenter.UserProfileViewModel$execUserInfoToDevice$1> continuation) {
    ...
    public final kotlin.coroutines.Continuation<kotlin.Unit> create(java.lang.Object obj, kotlin.coroutines.Continuation<?> continuation) {
        return new com.qcwireless.qcwatch.ui.mine.ucenter.UserProfileViewModel$execUserInfoToDevice$1(this.$boy, this.$age, this.$height, this.$weight, continuation);
    }
    ...
    public final java.lang.Object invokeSuspend(java.lang.Object obj) {
        ...
        this.label = 2;
        if (((kotlinx.coroutines.flow.Flow) obj).collect(new com.qcwireless.qcwatch.ui.mine.ucenter.UserProfileViewModel$execUserInfoToDevice$1.AnonymousClass1(this.$boy, this.$age, this.$height, this.$weight), (kotlin.coroutines.Continuation) this) == coroutine_suspended) {
            return coroutine_suspended;
        }
        return kotlin.Unit.INSTANCE;
    }
    ...
    /* renamed from: com.qcwireless.qcwatch.ui.mine.ucenter.UserProfileViewModel$execUserInfoToDevice$1$1, reason: invalid class name */
    static final class AnonymousClass1<T> implements kotlinx.coroutines.flow.FlowCollector {
        ...
        public static final void m1362emit$lambda0(com.oudmon.ble.base.communication.rsp.TimeFormatRsp timeFormatRsp) {
        }
            ...
            if (deviceSetting != null) {
                com.oudmon.ble.base.communication.CommandHandle.getInstance().executeReqCmd(com.oudmon.ble.base.communication.req.TimeFormatReq.getWriteInstance(deviceSetting.getTimeFormat() == 0, deviceSetting.getMetricUnit(), this.$boy, this.$age, this.$height, this.$weight, 120, 90, 160), new com.oudmon.ble.base.communication.ICommandResponse() { // from class: com.qcwireless.qcwatch.ui.mine.ucenter.UserProfileViewModel$execUserInfoToDevice$1$1$$ExternalSyntheticLambda0
                    ...
                    public final void onDataResponse(com.oudmon.ble.base.communication.rsp.BaseRspCmd baseRspCmd) {
                        com.qcwireless.qcwatch.ui.mine.ucenter.UserProfileViewModel$execUserInfoToDevice$1.AnonymousClass1.m1362emit$lambda0((com.oudmon.ble.base.communication.rsp.TimeFormatRsp) baseRspCmd);
                    }
                });
            }
            return kotlin.Unit.INSTANCE;
