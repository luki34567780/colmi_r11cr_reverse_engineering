...
@kotlin.coroutines.jvm.internal.DebugMetadata(c = "com.qcwireless.qcwatch.ui.mine.login.LoginViewModel$loginChina$1", f = "LoginViewModel.kt", i = {}, l = {46, 46}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: /tmp/dex/classes2.dex */
final class LoginViewModel$loginChina$1 extends kotlin.coroutines.jvm.internal.SuspendLambda implements kotlin.jvm.functions.Function2<kotlinx.coroutines.CoroutineScope, kotlin.coroutines.Continuation<? super kotlin.Unit>, java.lang.Object> {
    ...
    LoginViewModel$loginChina$1(com.qcwireless.qcwatch.ui.mine.login.LoginViewModel loginViewModel, java.lang.String str, java.lang.String str2, int i, kotlin.coroutines.Continuation<? super com.qcwireless.qcwatch.ui.mine.login.LoginViewModel$loginChina$1> continuation) {
    ...
    public final kotlin.coroutines.Continuation<kotlin.Unit> create(java.lang.Object obj, kotlin.coroutines.Continuation<?> continuation) {
        return new com.qcwireless.qcwatch.ui.mine.login.LoginViewModel$loginChina$1(this.this$0, this.$account, this.$password, this.$type, continuation);
    }
    ...
    public final java.lang.Object invokeSuspend(java.lang.Object obj) {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            obj = this.this$0.getRepository().loginChina(this.$account, this.$password, this.$type, (kotlin.coroutines.Continuation) this);
        ...
        this.label = 2;
        if (((kotlinx.coroutines.flow.Flow) obj).collect(new kotlinx.coroutines.flow.FlowCollector() { // from class: com.qcwireless.qcwatch.ui.mine.login.LoginViewModel$loginChina$1.1
