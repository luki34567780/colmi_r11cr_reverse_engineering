...
public final class QSettingItemWithClickSystem extends androidx.constraintlayout.widget.ConstraintLayout implements skin.support.widget.SkinCompatSupportable {
    ...
    private com.qcwireless.qcwatch.ui.base.view.QSettingItemWithClickSystem.OnLSettingItemWithClickSystem mOnLSettingItemClick;
    ...
    /* compiled from: QSettingItemWithClickSystem.kt */
    @kotlin.Metadata(d1 = {"\u0000\u001c\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\b\n\u0000\n\u0002\u0010\u000b\n\u0000\bf\u0018\u00002\u00020\u0001J\u0018\u0010\u0002\u001a\u00020\u00032\u0006\u0010\u0004\u001a\u00020\u00052\u0006\u0010\u0006\u001a\u00020\u0007H&¨\u0006\b"}, d2 = {"Lcom/qcwireless/qcwatch/ui/base/view/QSettingItemWithClickSystem$OnLSettingItemWithClickSystem;", "", "click", "", com.liulishuo.okdownload.core.breakpoint.BreakpointSQLiteKey.ID, "", "isChecked", "", "app_championRelease"}, k = 1, mv = {1, 6, 0}, xi = 48)
    public interface OnLSettingItemWithClickSystem {
        void click(int id, boolean isChecked);
    }

    public final void setmOnLSettingItemWithClick(com.qcwireless.qcwatch.ui.base.view.QSettingItemWithClickSystem.OnLSettingItemWithClickSystem mOnLSettingItemClick) {
        this.mOnLSettingItemClick = mOnLSettingItemClick;
    }

    public final void setQSettingItemCheckListener(android.widget.CompoundButton.OnCheckedChangeListener mOnCheckChangeListener) {
    ...
    public QSettingItemWithClickSystem(android.content.Context context) {
        super(context);
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public QSettingItemWithClickSystem(android.content.Context context, android.util.AttributeSet attributeSet) {
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public QSettingItemWithClickSystem(android.content.Context context, android.util.AttributeSet attributeSet, int i) {
    ...
    public final void getCustomStyle(android.content.Context context, android.util.AttributeSet attrs, int defStyleAttr) {
        ...
        constraintLayout.setOnClickListener(new android.view.View.OnClickListener() { // from class: com.qcwireless.qcwatch.ui.base.view.QSettingItemWithClickSystem$$ExternalSyntheticLambda0
            @Override // android.view.View.OnClickListener
            public final void onClick(android.view.View view2) {
                com.qcwireless.qcwatch.ui.base.view.QSettingItemWithClickSystem.m594getCustomStyle$lambda0(com.qcwireless.qcwatch.ui.base.view.QSettingItemWithClickSystem.this, view2);
            }
        });
        ...
        appCompatCheckBox.setOnCheckedChangeListener(new android.widget.CompoundButton.OnCheckedChangeListener() { // from class: com.qcwireless.qcwatch.ui.base.view.QSettingItemWithClickSystem$$ExternalSyntheticLambda1
            @Override // android.widget.CompoundButton.OnCheckedChangeListener
            public final void onCheckedChanged(android.widget.CompoundButton compoundButton, boolean z) {
                com.qcwireless.qcwatch.ui.base.view.QSettingItemWithClickSystem.m595getCustomStyle$lambda1(com.qcwireless.qcwatch.ui.base.view.QSettingItemWithClickSystem.this, compoundButton, z);
            }
        });
    ...
    public static final void m594getCustomStyle$lambda0(com.qcwireless.qcwatch.ui.base.view.QSettingItemWithClickSystem qSettingItemWithClickSystem, android.view.View view) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(qSettingItemWithClickSystem, "this$0");
        qSettingItemWithClickSystem.clickOn(view.getId());
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: getCustomStyle$lambda-1, reason: not valid java name */
    public static final void m595getCustomStyle$lambda1(com.qcwireless.qcwatch.ui.base.view.QSettingItemWithClickSystem qSettingItemWithClickSystem, android.widget.CompoundButton compoundButton, boolean z) {
        com.qcwireless.qcwatch.ui.base.view.QSettingItemWithClickSystem.OnLSettingItemWithClickSystem onLSettingItemWithClickSystem;
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(qSettingItemWithClickSystem, "this$0");
        if (compoundButton.isPressed() && (onLSettingItemWithClickSystem = qSettingItemWithClickSystem.mOnLSettingItemClick) != null) {
            kotlin.jvm.internal.Intrinsics.checkNotNull(onLSettingItemWithClickSystem);
    ...
    private final void initView(android.content.Context context) {
        android.view.View inflate = androidx.constraintlayout.widget.ConstraintLayout.inflate(context, com.qcwireless.qcwatch.R.layout.qc_device_item_with_click_system, (android.view.ViewGroup) this);
        kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(inflate, "inflate(context, R.layou…_with_click_system, this)");
    ...
    private final void clickOn(int id) {
        ...
        if (i == 0 || i == 1) {
            com.qcwireless.qcwatch.ui.base.view.QSettingItemWithClickSystem.OnLSettingItemWithClickSystem onLSettingItemWithClickSystem2 = this.mOnLSettingItemClick;
            if (onLSettingItemWithClickSystem2 != null) {
                kotlin.jvm.internal.Intrinsics.checkNotNull(onLSettingItemWithClickSystem2);
