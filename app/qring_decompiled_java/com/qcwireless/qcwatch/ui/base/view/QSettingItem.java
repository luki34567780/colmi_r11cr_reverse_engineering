...
public final class QSettingItem extends androidx.constraintlayout.widget.ConstraintLayout implements skin.support.widget.SkinCompatSupportable {
    ...
    private com.qcwireless.qcwatch.ui.base.view.QSettingItem.OnLSettingItemClick mOnLSettingItemClick;
    ...
    private com.qcwireless.qcwatch.ui.base.view.QSwitchCompat mRightIcon_switch;
    ...
    /* compiled from: QSettingItem.kt */
    @kotlin.Metadata(d1 = {"\u0000\u001c\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\b\n\u0000\n\u0002\u0010\u000b\n\u0000\bf\u0018\u00002\u00020\u0001J\u0018\u0010\u0002\u001a\u00020\u00032\u0006\u0010\u0004\u001a\u00020\u00052\u0006\u0010\u0006\u001a\u00020\u0007H&¨\u0006\b"}, d2 = {"Lcom/qcwireless/qcwatch/ui/base/view/QSettingItem$OnLSettingItemClick;", "", "click", "", com.liulishuo.okdownload.core.breakpoint.BreakpointSQLiteKey.ID, "", "isChecked", "", "app_championRelease"}, k = 1, mv = {1, 6, 0}, xi = 48)
    public interface OnLSettingItemClick {
        void click(int id, boolean isChecked);
    }

    public final void setmOnLSettingItemClick(com.qcwireless.qcwatch.ui.base.view.QSettingItem.OnLSettingItemClick mOnLSettingItemClick) {
        this.mOnLSettingItemClick = mOnLSettingItemClick;
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public QSettingItem(android.content.Context context) {
        super(context);
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public QSettingItem(android.content.Context context, android.util.AttributeSet attributeSet) {
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public QSettingItem(android.content.Context context, android.util.AttributeSet attributeSet, int i) {
    ...
    public final void getCustomStyle(android.content.Context context, android.util.AttributeSet attrs, int defStyleAttr) {
        ...
        for (int i = 0; i < indexCount; i++) {
            ...
            switch (index) {
                ...
                case 7:
                    ...
                    android.graphics.drawable.Drawable drawable = obtainStyledAttributes.getDrawable(index);
                ...
                case 10:
                    ...
                    android.widget.TextView textView5 = this.mTvLeftText;
                ...
                case 11:
                    ...
                    android.view.ViewGroup.LayoutParams layoutParams3 = textView6.getLayoutParams();
                ...
                case 13:
                    ...
                    break;
                case 14:
                    android.widget.TextView textView8 = this.mTvRightText;
                    kotlin.jvm.internal.Intrinsics.checkNotNull(textView8);
                    textView8.setText(obtainStyledAttributes.getString(index));
                    break;
                case 15:
                    ...
                    break;
                case 16:
                    this.mRightTextSize = obtainStyledAttributes.getFloat(index, 12.0f);
        ...
        constraintLayout.setOnClickListener(new android.view.View.OnClickListener() { // from class: com.qcwireless.qcwatch.ui.base.view.QSettingItem$$ExternalSyntheticLambda0
            @Override // android.view.View.OnClickListener
            public final void onClick(android.view.View view2) {
                com.qcwireless.qcwatch.ui.base.view.QSettingItem.m586getCustomStyle$lambda0(com.qcwireless.qcwatch.ui.base.view.QSettingItem.this, view2);
            }
        });
        ...
        appCompatCheckBox.setOnCheckedChangeListener(new android.widget.CompoundButton.OnCheckedChangeListener() { // from class: com.qcwireless.qcwatch.ui.base.view.QSettingItem$$ExternalSyntheticLambda2
            @Override // android.widget.CompoundButton.OnCheckedChangeListener
            public final void onCheckedChanged(android.widget.CompoundButton compoundButton, boolean z) {
                com.qcwireless.qcwatch.ui.base.view.QSettingItem.m587getCustomStyle$lambda1(com.qcwireless.qcwatch.ui.base.view.QSettingItem.this, compoundButton, z);
            }
        });
        com.qcwireless.qcwatch.ui.base.view.QSwitchCompat qSwitchCompat = this.mRightIcon_switch;
        kotlin.jvm.internal.Intrinsics.checkNotNull(qSwitchCompat);
        qSwitchCompat.setOnCheckedChangeListener(new android.widget.CompoundButton.OnCheckedChangeListener() { // from class: com.qcwireless.qcwatch.ui.base.view.QSettingItem$$ExternalSyntheticLambda1
            @Override // android.widget.CompoundButton.OnCheckedChangeListener
            public final void onCheckedChanged(android.widget.CompoundButton compoundButton, boolean z) {
                com.qcwireless.qcwatch.ui.base.view.QSettingItem.m588getCustomStyle$lambda2(com.qcwireless.qcwatch.ui.base.view.QSettingItem.this, compoundButton, z);
            }
        });
    ...
    public static final void m586getCustomStyle$lambda0(com.qcwireless.qcwatch.ui.base.view.QSettingItem qSettingItem, android.view.View view) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(qSettingItem, "this$0");
        qSettingItem.clickOn(view.getId());
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: getCustomStyle$lambda-1, reason: not valid java name */
    public static final void m587getCustomStyle$lambda1(com.qcwireless.qcwatch.ui.base.view.QSettingItem qSettingItem, android.widget.CompoundButton compoundButton, boolean z) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(qSettingItem, "this$0");
        com.qcwireless.qcwatch.ui.base.view.QSettingItem.OnLSettingItemClick onLSettingItemClick = qSettingItem.mOnLSettingItemClick;
        if (onLSettingItemClick != null) {
            kotlin.jvm.internal.Intrinsics.checkNotNull(onLSettingItemClick);
    ...
    public static final void m588getCustomStyle$lambda2(com.qcwireless.qcwatch.ui.base.view.QSettingItem qSettingItem, android.widget.CompoundButton compoundButton, boolean z) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(qSettingItem, "this$0");
        com.qcwireless.qcwatch.ui.base.view.QSettingItem.OnLSettingItemClick onLSettingItemClick = qSettingItem.mOnLSettingItemClick;
        if (onLSettingItemClick != null) {
            kotlin.jvm.internal.Intrinsics.checkNotNull(onLSettingItemClick);
    ...
    private final void switchRightStyle(int mRightStyle) {
        ...
        if (mRightStyle == 2) {
            ...
            com.qcwireless.qcwatch.ui.base.view.QSwitchCompat qSwitchCompat2 = this.mRightIcon_switch;
            kotlin.jvm.internal.Intrinsics.checkNotNull(qSwitchCompat2);
        ...
        com.qcwireless.qcwatch.ui.base.view.QSwitchCompat qSwitchCompat3 = this.mRightIcon_switch;
        kotlin.jvm.internal.Intrinsics.checkNotNull(qSwitchCompat3);
        qSwitchCompat3.setVisibility(0);
    }

    /* JADX WARN: Multi-variable type inference failed */
    private final void initView(android.content.Context context) {
        android.view.View inflate = androidx.constraintlayout.widget.ConstraintLayout.inflate(context, com.qcwireless.qcwatch.R.layout.qc_device_item, (android.view.ViewGroup) this);
        kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(inflate, "inflate(context, R.layout.qc_device_item, this)");
        ...
        this.mRightIcon_switch = (com.qcwireless.qcwatch.ui.base.view.QSwitchCompat) inflate.findViewById(com.qcwireless.qcwatch.R.id.rightswitch);
        this.mTvLeftSubText = (android.widget.TextView) inflate.findViewById(com.qcwireless.qcwatch.R.id.tv_left_sub_text);
        this.mErrorIcon = (android.widget.ImageView) inflate.findViewById(com.qcwireless.qcwatch.R.id.image_error);
    }

    private final void clickOn(int id) {
        int i = this.mRightStyle;
        if (i == 0 || i == 1) {
            com.qcwireless.qcwatch.ui.base.view.QSettingItem.OnLSettingItemClick onLSettingItemClick = this.mOnLSettingItemClick;
            if (onLSettingItemClick != null) {
                kotlin.jvm.internal.Intrinsics.checkNotNull(onLSettingItemClick);
        ...
        com.qcwireless.qcwatch.ui.base.view.QSwitchCompat qSwitchCompat = this.mRightIcon_switch;
        kotlin.jvm.internal.Intrinsics.checkNotNull(qSwitchCompat);
        kotlin.jvm.internal.Intrinsics.checkNotNull(this.mRightIcon_switch);
    ...
    public final void setErrorIcon(boolean flag) {
        if (flag) {
            com.qcwireless.qcwatch.base.view.ViewKt.visible(this.mErrorIcon);
        } else {
            com.qcwireless.qcwatch.base.view.ViewKt.gone(this.mErrorIcon);
        }
    }
