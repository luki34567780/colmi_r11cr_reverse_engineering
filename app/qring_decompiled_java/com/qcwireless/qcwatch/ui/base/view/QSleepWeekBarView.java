...
public class QSleepWeekBarView extends com.qcwireless.qcwatch.ui.base.view.BaseChartView {
    private com.qcwireless.qcwatch.ui.base.view.QSleepWeekBarView.SleepDataBean currBean;
    private java.util.List<com.qcwireless.qcwatch.ui.base.view.QSleepWeekBarView.SleepDataBean> data;
    private java.util.Map<java.lang.String, com.qcwireless.qcwatch.ui.base.view.QSleepWeekBarView.SleepDataBean> hashData;
    ...
    private com.qcwireless.qcwatch.ui.base.view.QSleepWeekBarView.OnSelectedListener listener;
    private int maxSleepTime;
    private android.graphics.Paint sleepPaint;
    private int[] timeArray;

    public interface OnSelectedListener {
        void onSelected(com.qcwireless.qcwatch.ui.base.view.QSleepWeekBarView.SleepDataBean bean);
    }

    public com.qcwireless.qcwatch.ui.base.view.QSleepWeekBarView.OnSelectedListener getListener() {
        return this.listener;
    }

    public void setListener(com.qcwireless.qcwatch.ui.base.view.QSleepWeekBarView.OnSelectedListener listener) {
        this.listener = listener;
    }

    public QSleepWeekBarView(android.content.Context context) {
        super(context);
    ...
    public QSleepWeekBarView(android.content.Context context, android.util.AttributeSet attrs) {
        super(context, attrs);
        this.leftRightOffset = 100;
        this.maxSleepTime = 540;
        this.data = new java.util.ArrayList();
    ...
    public QSleepWeekBarView(android.content.Context context, android.util.AttributeSet attrs, int defStyleAttr) {
    ...
    public QSleepWeekBarView(android.content.Context context, android.util.AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    protected void onDraw(android.graphics.Canvas canvas) {
        ...
        for (int i2 = 0; i2 < this.data.size(); i2++) {
            com.qcwireless.qcwatch.ui.base.view.QSleepWeekBarView.SleepDataBean sleepDataBean = this.data.get(i2);
            ...
            canvas.drawLine(this.leftRightOffset + i3, ((this.lineHeight - this.bottomOffset) - deepScale) - lightScale, this.leftRightOffset + i3, (((this.lineHeight - this.bottomOffset) - deepScale) - lightScale) - awakeScale, this.sleepPaint);
        }
    ...
    public void initXLabel(java.util.List<com.qcwireless.qcwatch.ui.base.view.QSleepWeekBarView.SleepDataBean> data) {
        int i = (this.width - (this.leftRightOffset * 2)) / 6;
    ...
    public boolean onTouchEvent(android.view.MotionEvent event) {
        ...
        com.qcwireless.qcwatch.ui.base.view.QSleepWeekBarView.OnSelectedListener onSelectedListener = this.listener;
    ...
    public void setData(java.util.List<com.qcwireless.qcwatch.ui.base.view.QSleepWeekBarView.SleepDataBean> data) {
        this.data.clear();
        this.data.addAll(data);
        for (com.qcwireless.qcwatch.ui.base.view.QSleepWeekBarView.SleepDataBean sleepDataBean : data) {
        ...
        int i = (this.width - (this.leftRightOffset * 2)) / 6;
        for (int i2 = 0; i2 < data.size(); i2++) {
            com.qcwireless.qcwatch.ui.base.view.QSleepWeekBarView.SleepDataBean sleepDataBean2 = data.get(i2);
            int i3 = i2 * i;
