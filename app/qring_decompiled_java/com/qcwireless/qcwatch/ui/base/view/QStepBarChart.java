...
public class QStepBarChart extends com.qcwireless.qcwatch.ui.base.view.BaseChartView {
    static final /* synthetic */ boolean $assertionsDisabled = false;
    private com.qcwireless.qcwatch.ui.base.view.QStepBarChart.StepDataBean currBean;
    private java.util.List<com.qcwireless.qcwatch.ui.base.view.QStepBarChart.StepDataBean> data;
    java.text.DecimalFormat df;
    private java.util.Map<java.lang.String, com.qcwireless.qcwatch.ui.base.view.QStepBarChart.StepDataBean> hashData;
    ...
    protected com.qcwireless.qcwatch.ui.base.view.QStepBarChart.OnSelectedListener listener;
    private com.qcwireless.qcwatch.ui.base.view.animator.ChartAnimator mAnimator;
    private int maxStep;
    private int[] timeArray;

    public interface OnSelectedListener {
        void onSelected(com.qcwireless.qcwatch.ui.base.view.QStepBarChart.StepDataBean bean);
    }

    public QStepBarChart(android.content.Context context) {
        super(context);
    ...
    public QStepBarChart(android.content.Context context, android.util.AttributeSet attrs) {
        super(context, attrs);
        this.data = new java.util.ArrayList();
        this.hashData = new androidx.collection.ArrayMap();
        this.labelsList = new java.util.ArrayList();
    ...
    public QStepBarChart(android.content.Context context, android.util.AttributeSet attrs, int defStyleAttr) {
    ...
    public QStepBarChart(android.content.Context context, android.util.AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    public com.qcwireless.qcwatch.ui.base.view.QStepBarChart.OnSelectedListener getListener() {
        return this.listener;
    }

    public void setListener(com.qcwireless.qcwatch.ui.base.view.QStepBarChart.OnSelectedListener listener) {
        this.listener = listener;
    }

    public java.util.List<com.qcwireless.qcwatch.ui.base.view.QStepBarChart.StepDataBean> getData() {
        return this.data;
    }

    public void setData(java.util.List<com.qcwireless.qcwatch.ui.base.view.QStepBarChart.StepDataBean> data) {
        this.data = data;
        this.maxStep = 1000;
        ...
        if (this.hashData.get(intValue + "") != null) {
            com.qcwireless.qcwatch.ui.base.view.QStepBarChart.StepDataBean stepDataBean = this.hashData.get(intValue + "");
            this.currBean = stepDataBean;
            this.valueSelected = stepDataBean.getSteps();
        } else {
            this.currBean = new com.qcwireless.qcwatch.ui.base.view.QStepBarChart.StepDataBean(43200L, 0, 0, 0);
            this.valueSelected = 0;
        }
        com.qcwireless.qcwatch.ui.base.view.QStepBarChart.OnSelectedListener onSelectedListener = this.listener;
    ...
    private void init(android.content.Context context, android.util.AttributeSet attrs) {
        ...
        this.mAnimator = new com.qcwireless.qcwatch.ui.base.view.animator.ChartAnimator(new android.animation.ValueAnimator.AnimatorUpdateListener() { // from class: com.qcwireless.qcwatch.ui.base.view.QStepBarChart.1
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public void onAnimationUpdate(android.animation.ValueAnimator animation) {
                com.qcwireless.qcwatch.ui.base.view.QStepBarChart.this.postInvalidate();
            }
        });
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (this.hashData.get(intValue + "") != null) {
            ...
            this.currBean = new com.qcwireless.qcwatch.ui.base.view.QStepBarChart.StepDataBean(dateUtil.getHour() * 3600, 0, 0, 0);
            this.valueSelected = 0;
        }
        initXLabels();
    ...
    protected void onDraw(android.graphics.Canvas canvas) {
        java.util.Iterator<com.qcwireless.qcwatch.ui.base.view.QStepBarChart.StepDataBean> it;
        super.onDraw(canvas);
        ...
        java.util.Iterator<com.qcwireless.qcwatch.ui.base.view.QStepBarChart.StepDataBean> it2 = this.data.iterator();
        while (true) {
            if (it2.hasNext()) {
                com.qcwireless.qcwatch.ui.base.view.QStepBarChart.StepDataBean next = it2.next();
                if (next.getSteps() != 0) {
    ...
    public boolean onTouchEvent(android.view.MotionEvent event) {
        ...
        if (action == 0) {
            ...
            if (this.hashData.get(intValue2 + "") != null) {
                com.qcwireless.qcwatch.ui.base.view.QStepBarChart.StepDataBean stepDataBean2 = this.hashData.get(intValue2 + "");
