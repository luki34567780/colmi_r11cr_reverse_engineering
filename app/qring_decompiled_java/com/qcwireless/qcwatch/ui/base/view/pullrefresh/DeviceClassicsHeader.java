...
public class DeviceClassicsHeader extends com.qcwireless.qcwatch.ui.base.view.pullrefresh.ClassicsAbstract<com.qcwireless.qcwatch.ui.base.view.pullrefresh.DeviceClassicsHeader> implements com.scwang.smart.refresh.layout.api.RefreshHeader {
    ...
    public DeviceClassicsHeader(android.content.Context context) {
        this(context, null);
        this.mContext = context;
    }

    /* JADX WARN: Multi-variable type inference failed */
    public DeviceClassicsHeader(android.content.Context context, android.util.AttributeSet attrs) {
    ...
    public void onStateChanged(com.scwang.smart.refresh.layout.api.RefreshLayout refreshLayout, com.scwang.smart.refresh.layout.constant.RefreshState oldState, com.scwang.smart.refresh.layout.constant.RefreshState newState) {
        ...
        switch (com.qcwireless.qcwatch.ui.base.view.pullrefresh.DeviceClassicsHeader.AnonymousClass1.$SwitchMap$com$scwang$smart$refresh$layout$constant$RefreshState[newState.ordinal()]) {
            case 1:
                textView.setVisibility(this.mEnableLastTime ? 0 : 8);
                break;
            case 2:
    ...
    /* JADX WARN: Multi-variable type inference failed */
    public com.qcwireless.qcwatch.ui.base.view.pullrefresh.DeviceClassicsHeader setLastUpdateTime(java.util.Date time) {
        this.mLastTime = time;
    ...
    public long getLastUpdateTime() {
        android.content.SharedPreferences sharedPreferences = this.mContext.getSharedPreferences("DeviceClassicsHeader", 0);
        this.mShared = sharedPreferences;
        return sharedPreferences.getLong(this.KEY_LAST_UPDATE_TIME, 0L);
    }

    public com.qcwireless.qcwatch.ui.base.view.pullrefresh.DeviceClassicsHeader setLastUpdateText(java.lang.CharSequence text) {
        this.mLastTime = null;
    ...
    @Override // com.qcwireless.qcwatch.ui.base.view.pullrefresh.ClassicsAbstract
    public com.qcwireless.qcwatch.ui.base.view.pullrefresh.DeviceClassicsHeader setAccentColor(int accentColor) {
        this.mLastUpdateText.setTextColor((16777215 & accentColor) | (-872415232));
        return (com.qcwireless.qcwatch.ui.base.view.pullrefresh.DeviceClassicsHeader) super.setAccentColor(accentColor);
    }

    public com.qcwireless.qcwatch.ui.base.view.pullrefresh.DeviceClassicsHeader setEnableLastTime(boolean enable) {
        android.widget.TextView textView = this.mLastUpdateText;
    ...
    public com.qcwireless.qcwatch.ui.base.view.pullrefresh.DeviceClassicsHeader setTextSizeTime(float size) {
    ...
    public com.qcwireless.qcwatch.ui.base.view.pullrefresh.DeviceClassicsHeader setTextSizeTime(int unit, float size) {
    ...
    public com.qcwireless.qcwatch.ui.base.view.pullrefresh.DeviceClassicsHeader setTextTimeMarginTop(float dp) {
        android.widget.TextView textView = this.mLastUpdateText;
    ...
    public com.qcwireless.qcwatch.ui.base.view.pullrefresh.DeviceClassicsHeader setTextTimeMarginTopPx(int px) {
