...
public class QSleepCirclePieView extends android.view.View {
    private int a;
    ...
    private java.util.List<com.qcwireless.qcwatch.ui.base.view.QSleepCirclePieView.CakeValue> mPieItems;
    private int mSweep;
    ...
    public QSleepCirclePieView(android.content.Context context) {
        super(context);
        this.a = 0;
        this.mSweep = 0;
        this.sweep = 0;
    ...
    public QSleepCirclePieView(android.content.Context context, android.util.AttributeSet attrs) {
        super(context, attrs);
        this.a = 0;
        this.mSweep = 0;
        this.sweep = 0;
    ...
    public QSleepCirclePieView(android.content.Context context, android.util.AttributeSet attrs, int defStyleAttr) {
    ...
    public QSleepCirclePieView(android.content.Context context, android.util.AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void init(android.content.Context context) {
        ...
        this.awakePaint.setTextSize(dp2px(context, 6.0f));
        ...
        this.lightPaint.setTextSize(dp2px(context, 6.0f));
        ...
        this.deepPaint.setTextSize(dp2px(context, 6.0f));
    }
    ...
    protected void onDraw(android.graphics.Canvas canvas) {
        super.onDraw(canvas);
        java.util.List<com.qcwireless.qcwatch.ui.base.view.QSleepCirclePieView.CakeValue> list = this.mPieItems;
        if (list != null && list.size() > 0) {
            this.mSweep = this.sweep + this.a;
            for (int i = 0; i < this.mPieItems.size(); i++) {
                com.qcwireless.qcwatch.ui.base.view.QSleepCirclePieView.CakeValue cakeValue = this.mPieItems.get(i);
                ...
                if (this.mPieItems.get(i).getItemType() == 1) {
                    drawSliceLabel(canvas, this.mSweep, this.mPieItems.get(i).getSw(), com.qcwireless.qc_utils.date.DateUtil.dayMinToStrShow((int) cakeValue.getItemValue()), this.mPieItems.get(i).getItemType());
        ...
        java.util.List<com.qcwireless.qcwatch.ui.base.view.QSleepCirclePieView.CakeValue> list2 = this.mPieItems;
        if (list2 != null) {
            list2.size();
    ...
    private void drawSliceLabel(android.graphics.Canvas canvas, float angle, int mSweep, java.lang.String label, int type) {
        ...
        float min = (java.lang.Math.min(getWidth(), getHeight()) / 2.0f) * 0.5f;
    ...
    public void setData(java.util.List<com.qcwireless.qcwatch.ui.base.view.QSleepCirclePieView.CakeValue> pieItems) {
        java.util.ArrayList arrayList = new java.util.ArrayList();
        this.totalValue = 0.0f;
        java.util.Iterator<com.qcwireless.qcwatch.ui.base.view.QSleepCirclePieView.CakeValue> it = pieItems.iterator();
        while (it.hasNext()) {
    ...
    public void dataInit(int[] data) {
        java.util.ArrayList arrayList = new java.util.ArrayList();
        arrayList.add(new com.qcwireless.qcwatch.ui.base.view.QSleepCirclePieView.CakeValue(1, data[0], androidx.core.content.ContextCompat.getColor(this.context, com.qcwireless.qcwatch.R.color.pubu_sleep_3), androidx.core.content.ContextCompat.getColor(this.context, com.qcwireless.qcwatch.R.color.pubu_sleep_3)));
        arrayList.add(new com.qcwireless.qcwatch.ui.base.view.QSleepCirclePieView.CakeValue(2, data[1], androidx.core.content.ContextCompat.getColor(this.context, com.qcwireless.qcwatch.R.color.pubu_sleep_2), androidx.core.content.ContextCompat.getColor(this.context, com.qcwireless.qcwatch.R.color.pubu_sleep_2)));
        arrayList.add(new com.qcwireless.qcwatch.ui.base.view.QSleepCirclePieView.CakeValue(3, data[2], androidx.core.content.ContextCompat.getColor(this.context, com.qcwireless.qcwatch.R.color.pubu_sleep_1), androidx.core.content.ContextCompat.getColor(this.context, com.qcwireless.qcwatch.R.color.pubu_sleep_1)));
        arrayList.add(new com.qcwireless.qcwatch.ui.base.view.QSleepCirclePieView.CakeValue(4, data[3], androidx.core.content.ContextCompat.getColor(this.context, com.qcwireless.qcwatch.R.color.q_view_circle_pie_8), androidx.core.content.ContextCompat.getColor(this.context, com.qcwireless.qcwatch.R.color.q_view_circle_pie_9)));
        arrayList.add(new com.qcwireless.qcwatch.ui.base.view.QSleepCirclePieView.CakeValue(5, data[4], androidx.core.content.ContextCompat.getColor(this.context, com.qcwireless.qcwatch.R.color.q_view_circle_pie_10), androidx.core.content.ContextCompat.getColor(this.context, com.qcwireless.qcwatch.R.color.q_view_circle_pie_11)));
        setData(arrayList);
    }
}
