...
public class QBloodSugarLineChartHomeView extends android.view.View {
    private java.util.List<com.qcwireless.qcwatch.ui.base.view.QBloodSugarLineChartHomeView.DataBean> boList;
    ...
    private java.util.Map<java.lang.String, com.qcwireless.qcwatch.ui.base.view.QBloodSugarLineChartHomeView.DataBean> hashData;
    private int height;
    ...
    public interface OnSelectedListener {
        void onSelected(com.qcwireless.qcwatch.ui.base.view.QBloodSugarLineChartHomeView.DataBean bean);
    }

    public QBloodSugarLineChartHomeView(android.content.Context context) {
        super(context);
    ...
    public QBloodSugarLineChartHomeView(android.content.Context context, android.util.AttributeSet attrs) {
        super(context, attrs);
        this.timeArray = new int[24];
        this.boList = new java.util.ArrayList();
        this.leftRightOffset = 20;
    ...
    public QBloodSugarLineChartHomeView(android.content.Context context, android.util.AttributeSet attrs, int defStyleAttr) {
    ...
    public QBloodSugarLineChartHomeView(android.content.Context context, android.util.AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void init(android.content.Context context, android.util.AttributeSet attrs) {
        ...
        this.colors = new int[]{androidx.core.content.ContextCompat.getColor(context, com.qcwireless.qcwatch.R.color.q_view_blood_sugar_1), androidx.core.content.ContextCompat.getColor(context, com.qcwireless.qcwatch.R.color.q_view_blood_sugar_2), androidx.core.content.ContextCompat.getColor(context, com.qcwireless.qcwatch.R.color.color_FFFFFF)};
        ...
        this.paint.setColor(androidx.core.content.ContextCompat.getColor(context, com.qcwireless.qcwatch.R.color.q_view_blood_sugar_1));
    ...
    public void setData(java.util.List<com.qcwireless.qcwatch.ui.base.view.QBloodSugarLineChartHomeView.DataBean> data) {
        this.boList = data;
        this.hashData.clear();
        this.path.reset();
        if (this.width > 0) {
            for (com.qcwireless.qcwatch.ui.base.view.QBloodSugarLineChartHomeView.DataBean dataBean : data) {
                ...
                if (dataBean.getMinValue() > 0.0f && dataBean.getMaxValue() > 0.0f) {
                    ...
                    path.moveTo(((seconds * (i - (i2 * 2))) / 86400) + i2, (this.lineHeight - this.bottomOffset) - ((dataBean.getMinValue() * (this.height - this.bottomOffset)) / 20.0f));
                    android.graphics.Path path2 = this.path;
                    int seconds2 = dataBean.getSeconds();
                    int i3 = this.width;
                    int i4 = this.leftRightOffset;
                    path2.lineTo(((seconds2 * (i3 - (i4 * 2))) / 86400) + i4, (this.lineHeight - this.bottomOffset) - ((dataBean.getMaxValue() * (this.height - this.bottomOffset)) / 20.0f));
                }
            }
        } else {
