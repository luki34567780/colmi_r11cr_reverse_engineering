...
public final class QStepComponentView extends androidx.constraintlayout.widget.ConstraintLayout {
    ...
    public QStepComponentView(android.content.Context context) {
        super(context);
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public QStepComponentView(android.content.Context context, android.util.AttributeSet attributeSet) {
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public QStepComponentView(android.content.Context context, android.util.AttributeSet attributeSet, int i) {
    ...
    private final void initView(android.content.Context context, android.util.AttributeSet attrs) {
        android.view.View inflate = androidx.constraintlayout.widget.ConstraintLayout.inflate(context, com.qcwireless.qcwatch.R.layout.view_step_component, (android.view.ViewGroup) this);
    ...
    public final void setTitleUnit(java.lang.String unit) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(unit, "unit");
        android.widget.TextView textView = this.tvUnit1;
        if (textView == null) {
            kotlin.jvm.internal.Intrinsics.throwUninitializedPropertyAccessException("tvUnit1");
            textView = null;
        }
