...
public class QPressureWeekHistoryBarChart extends com.qcwireless.qcwatch.ui.base.view.BaseChartView {
    int[] colors;
    private com.qcwireless.qcwatch.ui.base.view.QPressureWeekHistoryBarChart.StepDataBean currBean;
    private java.util.List<com.qcwireless.qcwatch.ui.base.view.QPressureWeekHistoryBarChart.StepDataBean> data;
    java.text.DecimalFormat df;
    private java.util.Map<java.lang.String, com.qcwireless.qcwatch.ui.base.view.QPressureWeekHistoryBarChart.StepDataBean> hashData;
    ...
    protected com.qcwireless.qcwatch.ui.base.view.QPressureWeekHistoryBarChart.OnSelectedListener listener;
    private int max;
    private int maxPressure;
    private int[] timeArray;

    public interface OnSelectedListener {
        void onSelected(com.qcwireless.qcwatch.ui.base.view.QPressureWeekHistoryBarChart.StepDataBean bean);
    }

    public QPressureWeekHistoryBarChart(android.content.Context context) {
        super(context);
    ...
    public QPressureWeekHistoryBarChart(android.content.Context context, android.util.AttributeSet attrs) {
        super(context, attrs);
        this.data = new java.util.ArrayList();
        this.hashData = new androidx.collection.ArrayMap();
        this.labelsList = new java.util.ArrayList();
    ...
    public QPressureWeekHistoryBarChart(android.content.Context context, android.util.AttributeSet attrs, int defStyleAttr) {
    ...
    public QPressureWeekHistoryBarChart(android.content.Context context, android.util.AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    public java.util.List<com.qcwireless.qcwatch.ui.base.view.QPressureWeekHistoryBarChart.StepDataBean> getData() {
        return this.data;
    }

    public void setData(java.util.List<com.qcwireless.qcwatch.ui.base.view.QPressureWeekHistoryBarChart.StepDataBean> data) {
        this.maxPressure = 100;
        this.data = data;
        if (this.width > 0) {
    ...
    public com.qcwireless.qcwatch.ui.base.view.QPressureWeekHistoryBarChart.OnSelectedListener getListener() {
        return this.listener;
    }

    public void setListener(com.qcwireless.qcwatch.ui.base.view.QPressureWeekHistoryBarChart.OnSelectedListener listener) {
    ...
    public void initXLabel(java.util.List<com.qcwireless.qcwatch.ui.base.view.QPressureWeekHistoryBarChart.StepDataBean> data) {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (this.hashData.get(intValue + "") != null) {
            java.util.Map<java.lang.String, com.qcwireless.qcwatch.ui.base.view.QPressureWeekHistoryBarChart.StepDataBean> map = this.hashData;
    ...
    protected void onDraw(android.graphics.Canvas canvas) {
        ...
        for (com.qcwireless.qcwatch.ui.base.view.QPressureWeekHistoryBarChart.StepDataBean stepDataBean : this.data) {
    ...
    public boolean onTouchEvent(android.view.MotionEvent event) {
        ...
        if (action == 0) {
            ...
            if (this.hashData.get(intValue2 + "") != null) {
                ...
                java.util.Map<java.lang.String, com.qcwireless.qcwatch.ui.base.view.QPressureWeekHistoryBarChart.StepDataBean> map2 = this.hashData;
                this.fingerX = map2.get(intValue2 + "").x;
            }
            postInvalidate();
        }
        com.qcwireless.qcwatch.ui.base.view.QPressureWeekHistoryBarChart.OnSelectedListener onSelectedListener = this.listener;
    ...
    private void filterData(java.util.List<com.qcwireless.qcwatch.ui.base.view.QPressureWeekHistoryBarChart.StepDataBean> data) {
        for (com.qcwireless.qcwatch.ui.base.view.QPressureWeekHistoryBarChart.StepDataBean stepDataBean : data) {
        ...
        int textWidth = (int) (((this.width - (this.leftRightOffset * 2)) - getTextWidth(this.avgLinePaint, "00")) / 6.0f);
        for (int i = 0; i < data.size(); i++) {
            com.qcwireless.qcwatch.ui.base.view.QPressureWeekHistoryBarChart.StepDataBean stepDataBean2 = data.get(i);
            int i2 = i * textWidth;
