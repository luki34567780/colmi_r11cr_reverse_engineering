...
public class QHealthyProgressCircle extends android.view.View {
    ...
    public QHealthyProgressCircle(android.content.Context context) {
        this(context, null);
        this.context = context;
    }

    public QHealthyProgressCircle(android.content.Context context, android.util.AttributeSet attrs) {
        this(context, attrs, 0);
        this.context = context;
    }

    public QHealthyProgressCircle(android.content.Context context, android.util.AttributeSet attrs, int defStyleAttr) {
    ...
    private void init() {
        ...
        paint.setColor(androidx.core.content.ContextCompat.getColor(this.context, com.qcwireless.qcwatch.R.color.healthy_module_bg));
        ...
        paint2.setColor(skin.support.content.res.SkinCompatResources.getColor(this.context, com.qcwireless.qcwatch.R.color.healthy_module_value_bg));
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        this.radius = ((java.lang.Math.max(this.width, this.height) - 40) - ((int) dp2px(this.context, 6.0f))) / 2;
        postInvalidate();
    }
