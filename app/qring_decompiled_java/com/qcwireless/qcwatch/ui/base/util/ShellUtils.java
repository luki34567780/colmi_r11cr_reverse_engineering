...
public class ShellUtils {
    ...
    public static com.qcwireless.qcwatch.ui.base.util.ShellUtils.CommandResult execCommand(java.lang.String command, boolean isRoot) {
        return execCommand(new java.lang.String[]{command}, isRoot, true);
    }

    public static com.qcwireless.qcwatch.ui.base.util.ShellUtils.CommandResult execCommand(java.util.List<java.lang.String> commands, boolean isRoot) {
        return execCommand(commands == null ? null : (java.lang.String[]) commands.toArray(new java.lang.String[0]), isRoot, true);
    }

    public static com.qcwireless.qcwatch.ui.base.util.ShellUtils.CommandResult execCommand(java.lang.String[] commands, boolean isRoot) {
        return execCommand(commands, isRoot, true);
    }

    public static com.qcwireless.qcwatch.ui.base.util.ShellUtils.CommandResult execCommand(java.lang.String command, boolean isRoot, boolean isNeedResultMsg) {
        return execCommand(new java.lang.String[]{command}, isRoot, isNeedResultMsg);
    }

    public static com.qcwireless.qcwatch.ui.base.util.ShellUtils.CommandResult execCommand(java.util.List<java.lang.String> commands, boolean isRoot, boolean isNeedResultMsg) {
    ...
    */
    public static com.qcwireless.qcwatch.ui.base.util.ShellUtils.CommandResult execCommand(java.lang.String[] r8, boolean r9, boolean r10) {
        /*
