...
public final class QueueImageListener extends com.liulishuo.okdownload.core.listener.DownloadListener1 {
    ...
    public /* synthetic */ class WhenMappings {
        ...
        static {
            ...
            iArr[com.liulishuo.okdownload.core.cause.EndCause.ERROR.ordinal()] = 2;
    ...
    public void taskEnd(final com.liulishuo.okdownload.DownloadTask task, com.liulishuo.okdownload.core.cause.EndCause cause, java.lang.Exception realCause, com.liulishuo.okdownload.core.listener.assist.Listener1Assist.Listener1Model model) {
        ...
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(cause, "cause");
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(model, "model");
        int i = com.qcwireless.qcwatch.ui.base.repository.watchface.QueueImageListener.WhenMappings.$EnumSwitchMapping$0[cause.ordinal()];
        if (i == 1) {
            com.qcwireless.qcwatch.base.ktx.ThreadExtKt.ktxRunOnBgSingle(this, new kotlin.jvm.functions.Function1<com.qcwireless.qcwatch.ui.base.repository.watchface.QueueImageListener, kotlin.Unit>() { // from class: com.qcwireless.qcwatch.ui.base.repository.watchface.QueueImageListener$taskEnd$1
                {
                    super(1);
                }

                public /* bridge */ /* synthetic */ java.lang.Object invoke(java.lang.Object obj) {
                    invoke((com.qcwireless.qcwatch.ui.base.repository.watchface.QueueImageListener) obj);
                    return kotlin.Unit.INSTANCE;
                }

                public final void invoke(com.qcwireless.qcwatch.ui.base.repository.watchface.QueueImageListener queueImageListener) {
                    ...
                    kotlin.jvm.internal.Intrinsics.checkNotNullParameter(queueImageListener, "$this$ktxRunOnBgSingle");
                    java.lang.String obj = com.liulishuo.okdownload.DownloadTask.this.getTag().toString();
                    qcWatchFaceDao = queueImageListener.watchFaceDao;
                    ...
                    if (queryWatchFaceByNameAndHdVersion != null) {
                        ...
                        qcWatchFaceDao2 = queueImageListener.watchFaceDao;
        ...
        if (i == 2) {
            ...
            com.iwown.awlog.AwLog.i(com.iwown.awlog.Author.HeZhiYuan, cause.toString());
            return;
        }
        java.lang.String obj = task.getTag().toString();
        com.oudmon.ble.base.util.LogToFile.getInstance().wtf(obj + ':' + cause.name());
    }
}
