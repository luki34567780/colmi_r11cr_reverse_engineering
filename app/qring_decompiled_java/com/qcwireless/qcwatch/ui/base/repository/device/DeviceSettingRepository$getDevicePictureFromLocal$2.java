...
@kotlin.coroutines.jvm.internal.DebugMetadata(c = "com.qcwireless.qcwatch.ui.base.repository.device.DeviceSettingRepository$getDevicePictureFromLocal$2", f = "DeviceSettingRepository.kt", i = {}, l = {118}, m = "invokeSuspend", n = {}, s = {})
...
final class DeviceSettingRepository$getDevicePictureFromLocal$2 extends kotlin.coroutines.jvm.internal.SuspendLambda implements kotlin.jvm.functions.Function2<kotlinx.coroutines.flow.FlowCollector<? super com.qcwireless.qcwatch.ui.base.repository.entity.DeviceSettingEntity>, kotlin.coroutines.Continuation<? super kotlin.Unit>, java.lang.Object> {
    ...
    DeviceSettingRepository$getDevicePictureFromLocal$2(com.qcwireless.qcwatch.ui.base.repository.device.DeviceSettingRepository deviceSettingRepository, java.lang.String str, kotlin.coroutines.Continuation<? super com.qcwireless.qcwatch.ui.base.repository.device.DeviceSettingRepository$getDevicePictureFromLocal$2> continuation) {
    ...
    public final kotlin.coroutines.Continuation<kotlin.Unit> create(java.lang.Object obj, kotlin.coroutines.Continuation<?> continuation) {
        kotlin.coroutines.Continuation<kotlin.Unit> deviceSettingRepository$getDevicePictureFromLocal$2 = new com.qcwireless.qcwatch.ui.base.repository.device.DeviceSettingRepository$getDevicePictureFromLocal$2(this.this$0, this.$mac, continuation);
        deviceSettingRepository$getDevicePictureFromLocal$2.L$0 = obj;
        return deviceSettingRepository$getDevicePictureFromLocal$2;
    }
    ...
    public final java.lang.Object invokeSuspend(java.lang.Object obj) {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            if (flowCollector.emit(qcDeviceSettingDao.queryByMacAndAction(this.$mac, com.qcwireless.qcwatch.ui.base.repository.base.DeviceSettingAction.DevicePicture), (kotlin.coroutines.Continuation) this) == coroutine_suspended) {
