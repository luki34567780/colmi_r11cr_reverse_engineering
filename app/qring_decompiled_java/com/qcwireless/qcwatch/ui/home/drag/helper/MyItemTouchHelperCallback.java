...
public final class MyItemTouchHelperCallback extends androidx.recyclerview.widget.ItemTouchHelper.Callback {
    private com.qcwireless.qcwatch.ui.home.drag.helper.IItemTouchHelperAdapter adapter;
    ...
    public MyItemTouchHelperCallback(com.qcwireless.qcwatch.ui.home.drag.helper.IItemTouchHelperAdapter iItemTouchHelperAdapter) {
    ...
    public void onSelectedChanged(androidx.recyclerview.widget.RecyclerView.ViewHolder viewHolder, int actionState) {
        if (actionState != 0 && (viewHolder instanceof com.qcwireless.qcwatch.ui.home.drag.helper.IItemTouchHelperViewHolder)) {
            ((com.qcwireless.qcwatch.ui.home.drag.helper.IItemTouchHelperViewHolder) viewHolder).onItemSelected();
        }
    ...
    public void clearView(androidx.recyclerview.widget.RecyclerView recyclerView, androidx.recyclerview.widget.RecyclerView.ViewHolder viewHolder) {
        ...
        if (viewHolder instanceof com.qcwireless.qcwatch.ui.home.drag.helper.IItemTouchHelperViewHolder) {
            ((com.qcwireless.qcwatch.ui.home.drag.helper.IItemTouchHelperViewHolder) viewHolder).onItemClear();
        }
    }
}
