...
public final class MonthSleepFragmentViewModel extends com.qcwireless.qcwatch.ui.base.BaseViewModel {
    private final androidx.lifecycle.MutableLiveData<java.util.List<com.qcwireless.qcwatch.ui.base.view.QSleepMonthBarView.SleepDataBean>> _uiState;
    private final com.qcwireless.qcwatch.ui.base.repository.healthy.SleepDetailRepository sleepDetailRepository;

    public MonthSleepFragmentViewModel(com.qcwireless.qcwatch.ui.base.repository.healthy.SleepDetailRepository sleepDetailRepository) {
    ...
    public final androidx.lifecycle.LiveData<java.util.List<com.qcwireless.qcwatch.ui.base.view.QSleepMonthBarView.SleepDataBean>> getUiState() {
    ...
    public final void queryWeekSleepHistory(final com.qcwireless.qc_utils.date.DateUtil start) {
        ...
        com.qcwireless.qcwatch.base.ktx.ThreadExtKt.ktxRunOnBgSingle(this, new kotlin.jvm.functions.Function1<com.qcwireless.qcwatch.ui.home.sleep.month.MonthSleepFragmentViewModel, kotlin.Unit>() { // from class: com.qcwireless.qcwatch.ui.home.sleep.month.MonthSleepFragmentViewModel$queryWeekSleepHistory$1
            {
                super(1);
            }

            public /* bridge */ /* synthetic */ java.lang.Object invoke(java.lang.Object obj) {
                invoke((com.qcwireless.qcwatch.ui.home.sleep.month.MonthSleepFragmentViewModel) obj);
                return kotlin.Unit.INSTANCE;
            }

            public final void invoke(com.qcwireless.qcwatch.ui.home.sleep.month.MonthSleepFragmentViewModel monthSleepFragmentViewModel) {
                ...
                kotlin.jvm.internal.Intrinsics.checkNotNullParameter(monthSleepFragmentViewModel, "$this$ktxRunOnBgSingle");
                if (!com.qcwireless.qcwatch.base.pref.UserConfig.INSTANCE.getInstance().getNewSleepProtocol()) {
                    ...
                    int daysOfMonth = com.qcwireless.qc_utils.date.DateUtil.getDaysOfMonth(dateUtil.toDate());
                    for (int i = 0; i < daysOfMonth; i++) {
                        sleepDetailRepository2 = monthSleepFragmentViewModel.sleepDetailRepository;
                        ...
                        sleepDetailRepository3 = monthSleepFragmentViewModel.sleepDetailRepository;
                        ...
                        if (querySleepByDate != null && querySleepTotalByDate == null) {
                            monthSleepFragmentViewModel.showDaySleepView(dateUtil);
                        }
                        dateUtil.addDay(1);
                    }
                }
                sleepDetailRepository = monthSleepFragmentViewModel.sleepDetailRepository;
                java.util.List<com.qcwireless.qcwatch.ui.base.view.QSleepMonthBarView.SleepDataBean> querySleepMonth = sleepDetailRepository.querySleepMonth(com.qcwireless.qc_utils.date.DateUtil.this);
                mutableLiveData = monthSleepFragmentViewModel._uiState;
                mutableLiveData.postValue(querySleepMonth);
            }
        });
    }
    ...
    public final void showDaySleepView(final com.qcwireless.qc_utils.date.DateUtil dateUtil) {
        com.qcwireless.qcwatch.base.ktx.ThreadExtKt.ktxRunOnBgSingle(this, new kotlin.jvm.functions.Function1<com.qcwireless.qcwatch.ui.home.sleep.month.MonthSleepFragmentViewModel, kotlin.Unit>() { // from class: com.qcwireless.qcwatch.ui.home.sleep.month.MonthSleepFragmentViewModel$showDaySleepView$1
            {
                super(1);
            }
