...
public class EbookSortComparator implements java.util.Comparator {
    private int compareCallNum = 0;

    @Override // java.util.Comparator
    public int compare(java.lang.Object o1, java.lang.Object o2) {
        com.qcwireless.qcwatch.ui.device.ebook.bean.Ebook ebook = (com.qcwireless.qcwatch.ui.device.ebook.bean.Ebook) o1;
        if (ebook.getFirstName().equals("#") && !((com.qcwireless.qcwatch.ui.device.ebook.bean.Ebook) o2).getFirstName().equals("#")) {
            return 1;
        }
        if (ebook.getFirstName().equals("#") || !((com.qcwireless.qcwatch.ui.device.ebook.bean.Ebook) o2).getFirstName().equals("#")) {
            return ebook.getFirstName().compareToIgnoreCase(((com.qcwireless.qcwatch.ui.device.ebook.bean.Ebook) o2).getFirstName());
        }
        return -1;
    }
