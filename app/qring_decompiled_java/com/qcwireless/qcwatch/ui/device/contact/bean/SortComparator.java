...
public class SortComparator implements java.util.Comparator {
    private int compareCallNum = 0;

    @Override // java.util.Comparator
    public int compare(java.lang.Object o1, java.lang.Object o2) {
        com.qcwireless.qcwatch.ui.device.contact.bean.ContactBean contactBean = (com.qcwireless.qcwatch.ui.device.contact.bean.ContactBean) o1;
        if (contactBean.getFirstName().equals("#") && !((com.qcwireless.qcwatch.ui.device.contact.bean.ContactBean) o2).getFirstName().equals("#")) {
            return 1;
        }
        if (contactBean.getFirstName().equals("#") || !((com.qcwireless.qcwatch.ui.device.contact.bean.ContactBean) o2).getFirstName().equals("#")) {
            return contactBean.getFirstName().compareToIgnoreCase(((com.qcwireless.qcwatch.ui.device.contact.bean.ContactBean) o2).getFirstName());
        }
        return -1;
    }
