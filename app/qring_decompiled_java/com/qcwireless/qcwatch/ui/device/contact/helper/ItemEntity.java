...
public final /* data */ class ItemEntity {
    ...
    public static /* synthetic */ com.qcwireless.qcwatch.ui.device.contact.helper.ItemEntity copy$default(com.qcwireless.qcwatch.ui.device.contact.helper.ItemEntity itemEntity, java.lang.String str, boolean z, int i, boolean z2, int i2, java.lang.Object obj) {
        if ((i2 & 1) != 0) {
            str = itemEntity.text;
        }
        if ((i2 & 2) != 0) {
    ...
    public final com.qcwireless.qcwatch.ui.device.contact.helper.ItemEntity copy(java.lang.String text, boolean isChecked, int modelType, boolean showOrNot) {
        return new com.qcwireless.qcwatch.ui.device.contact.helper.ItemEntity(text, isChecked, modelType, showOrNot);
    }
    ...
    public boolean equals(java.lang.Object other) {
        ...
        if (!(other instanceof com.qcwireless.qcwatch.ui.device.contact.helper.ItemEntity)) {
            return false;
        }
        com.qcwireless.qcwatch.ui.device.contact.helper.ItemEntity itemEntity = (com.qcwireless.qcwatch.ui.device.contact.helper.ItemEntity) other;
