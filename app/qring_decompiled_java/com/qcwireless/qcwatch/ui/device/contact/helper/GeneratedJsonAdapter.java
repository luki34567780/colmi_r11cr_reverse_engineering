...
public final class GeneratedJsonAdapter extends com.squareup.moshi.JsonAdapter<com.qcwireless.qcwatch.ui.device.contact.helper.ItemEntity> {
    private final com.squareup.moshi.JsonAdapter<java.lang.Boolean> booleanAdapter;
    private volatile java.lang.reflect.Constructor<com.qcwireless.qcwatch.ui.device.contact.helper.ItemEntity> constructorRef;
    ...
    public com.qcwireless.qcwatch.ui.device.contact.helper.ItemEntity m686fromJson(com.squareup.moshi.JsonReader reader) {
        ...
        if (i == -9) {
            if (bool2 != null) {
                ...
                if (num != null) {
                    return new com.qcwireless.qcwatch.ui.device.contact.helper.ItemEntity(str, booleanValue, num.intValue(), bool.booleanValue());
                }
        ...
        java.lang.reflect.Constructor<com.qcwireless.qcwatch.ui.device.contact.helper.ItemEntity> constructor = this.constructorRef;
        if (constructor == null) {
            constructor = com.qcwireless.qcwatch.ui.device.contact.helper.ItemEntity.class.getDeclaredConstructor(java.lang.String.class, java.lang.Boolean.TYPE, java.lang.Integer.TYPE, java.lang.Boolean.TYPE, java.lang.Integer.TYPE, com.squareup.moshi.internal.Util.DEFAULT_CONSTRUCTOR_MARKER);
        ...
        if (bool2 != null) {
            ...
            objArr[5] = null;
            com.qcwireless.qcwatch.ui.device.contact.helper.ItemEntity newInstance = constructor.newInstance(objArr);
    ...
    public void toJson(com.squareup.moshi.JsonWriter writer, com.qcwireless.qcwatch.ui.device.contact.helper.ItemEntity value_) {
