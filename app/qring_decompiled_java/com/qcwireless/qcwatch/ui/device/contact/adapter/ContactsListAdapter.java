...
public final class ContactsListAdapter extends com.qcwireless.qcwatch.base.dialog.adapter.EasyAdapter<com.qcwireless.qcwatch.ui.device.contact.adapter.ContactsListAdapter.MyViewHolder> {
    private final android.content.Context context;
    private java.util.List<com.qcwireless.qcwatch.ui.device.contact.bean.ContactBean> data;
    ...
    public final java.util.List<com.qcwireless.qcwatch.ui.device.contact.bean.ContactBean> getData() {
        return this.data;
    }

    public final void setData(java.util.List<com.qcwireless.qcwatch.ui.device.contact.bean.ContactBean> list) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(list, "<set-?>");
        this.data = list;
    }

    public ContactsListAdapter(android.content.Context context, java.util.List<com.qcwireless.qcwatch.ui.device.contact.bean.ContactBean> list) {
    ...
    public void whenBindViewHolder(com.qcwireless.qcwatch.ui.device.contact.adapter.ContactsListAdapter.MyViewHolder holder, int position) {
        ...
        com.qcwireless.qcwatch.ui.device.contact.bean.ContactBean contactBean = this.data.get(position);
        android.widget.TextView tvKey = holder.getTvKey();
        java.lang.String upperCase = contactBean.getFirstName().toUpperCase(java.util.Locale.ROOT);
        ...
        if (contactBean.getSelect()) {
            holder.getSelectImage().setImageDrawable(skin.support.content.res.SkinCompatResources.getDrawable(this.context, com.qcwireless.qcwatch.R.mipmap.qc_check_on));
        } else {
            holder.getSelectImage().setImageDrawable(skin.support.content.res.SkinCompatResources.getDrawable(this.context, com.qcwireless.qcwatch.R.mipmap.qc_check_off));
        }
    }

    /* compiled from: ContactsListAdapter.kt */
    @kotlin.Metadata(d1 = {"\u0000\"\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\b\n\u0002\u0018\u0002\n\u0002\b\b\u0018\u00002\u00020\u0001B\r\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0002\u0010\u0004R\u001a\u0010\u0005\u001a\u00020\u0006X\u0086\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\u0007\u0010\b\"\u0004\b\t\u0010\nR\u001a\u0010\u000b\u001a\u00020\u0006X\u0086\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\f\u0010\b\"\u0004\b\r\u0010\nR\u001a\u0010\u000e\u001a\u00020\u000fX\u0086\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\u0010\u0010\u0011\"\u0004\b\u0012\u0010\u0013R\u001a\u0010\u0014\u001a\u00020\u0006X\u0086\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\u0015\u0010\b\"\u0004\b\u0016\u0010\n¨\u0006\u0017"}, d2 = {"Lcom/qcwireless/qcwatch/ui/device/contact/adapter/ContactsListAdapter$MyViewHolder;", "Landroidx/recyclerview/widget/RecyclerView$ViewHolder;", "itemView", "Landroid/view/View;", "(Landroid/view/View;)V", "name", "Landroid/widget/TextView;", "getName", "()Landroid/widget/TextView;", "setName", "(Landroid/widget/TextView;)V", "number", "getNumber", "setNumber", "selectImage", "Landroid/widget/ImageView;", "getSelectImage", "()Landroid/widget/ImageView;", "setSelectImage", "(Landroid/widget/ImageView;)V", "tvKey", "getTvKey", "setTvKey", "app_championRelease"}, k = 1, mv = {1, 6, 0}, xi = 48)
    public static final class MyViewHolder extends androidx.recyclerview.widget.RecyclerView.ViewHolder {
        ...
        public MyViewHolder(android.view.View view) {
            ...
            this.number = (android.widget.TextView) findViewById2;
            android.view.View findViewById3 = view.findViewById(com.qcwireless.qcwatch.R.id.image_select);
            kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(findViewById3, "itemView.findViewById(R.id.image_select)");
            this.selectImage = (android.widget.ImageView) findViewById3;
            android.view.View findViewById4 = view.findViewById(com.qcwireless.qcwatch.R.id.key_word);
            kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(findViewById4, "itemView.findViewById(R.id.key_word)");
            this.tvKey = (android.widget.TextView) findViewById4;
        }
        ...
        public final void setNumber(android.widget.TextView textView) {
            kotlin.jvm.internal.Intrinsics.checkNotNullParameter(textView, "<set-?>");
    ...
    public com.qcwireless.qcwatch.ui.device.contact.adapter.ContactsListAdapter.MyViewHolder onCreateViewHolder(android.view.ViewGroup parent, int viewType) {
        ...
        android.view.View inflate = from.inflate(com.qcwireless.qcwatch.R.layout.recycleview_item_add_contact, parent, false);
        kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(inflate, "view");
        return new com.qcwireless.qcwatch.ui.device.contact.adapter.ContactsListAdapter.MyViewHolder(inflate);
    }
}
