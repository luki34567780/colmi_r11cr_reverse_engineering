...
@kotlin.coroutines.jvm.internal.DebugMetadata(c = "com.qcwireless.qcwatch.ui.device.dfu.vm.DeviceFirmwareUpdateViewModel$checkOta$1", f = "DeviceFirmwareUpdateViewModel.kt", i = {}, l = {47, 50}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: /tmp/dex/classes2.dex */
final class DeviceFirmwareUpdateViewModel$checkOta$1 extends kotlin.coroutines.jvm.internal.SuspendLambda implements kotlin.jvm.functions.Function2<kotlinx.coroutines.CoroutineScope, kotlin.coroutines.Continuation<? super kotlin.Unit>, java.lang.Object> {
    java.lang.Object L$0;
    int label;
    final /* synthetic */ com.qcwireless.qcwatch.ui.device.dfu.vm.DeviceFirmwareUpdateViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    DeviceFirmwareUpdateViewModel$checkOta$1(com.qcwireless.qcwatch.ui.device.dfu.vm.DeviceFirmwareUpdateViewModel deviceFirmwareUpdateViewModel, kotlin.coroutines.Continuation<? super com.qcwireless.qcwatch.ui.device.dfu.vm.DeviceFirmwareUpdateViewModel$checkOta$1> continuation) {
        super(2, continuation);
        this.this$0 = deviceFirmwareUpdateViewModel;
    }

    public final kotlin.coroutines.Continuation<kotlin.Unit> create(java.lang.Object obj, kotlin.coroutines.Continuation<?> continuation) {
        return new com.qcwireless.qcwatch.ui.device.dfu.vm.DeviceFirmwareUpdateViewModel$checkOta$1(this.this$0, continuation);
    }
    ...
    public final java.lang.Object invokeSuspend(java.lang.Object obj) {
        ...
        kotlinx.coroutines.flow.FlowCollector flowCollector = new kotlinx.coroutines.flow.FlowCollector() { // from class: com.qcwireless.qcwatch.ui.device.dfu.vm.DeviceFirmwareUpdateViewModel$checkOta$1$1$1
            ...
            public final java.lang.Object emit(com.qcwireless.qcwatch.ui.base.repository.mine.NetState<com.qcwireless.qcwatch.ui.base.bean.response.device.FirmwareOtaResp> netState, kotlin.coroutines.Continuation<? super kotlin.Unit> continuation) {
                ...
                try {
                    ...
                    if (isSuccess != null) {
                        com.qcwireless.qcwatch.ui.device.dfu.vm.DeviceFirmwareUpdateViewModel.this.saveDeviceDfuInformation(isSuccess);
                    }
                    mutableLiveData = com.qcwireless.qcwatch.ui.device.dfu.vm.DeviceFirmwareUpdateViewModel.this._updateUiInfo;
                    com.qcwireless.qcwatch.ui.base.bean.response.device.FirmwareOtaResp isSuccess2 = netState.isSuccess();
                    kotlin.jvm.internal.Intrinsics.checkNotNull(isSuccess2);
                    mutableLiveData.postValue(isSuccess2);
