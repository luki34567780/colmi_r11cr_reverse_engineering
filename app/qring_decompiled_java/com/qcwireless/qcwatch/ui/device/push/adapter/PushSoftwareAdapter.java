...
public final class PushSoftwareAdapter extends com.chad.library.adapter.base.BaseQuickAdapter<com.qcwireless.qcwatch.ui.device.push.bean.SoftwarePush, com.chad.library.adapter.base.viewholder.BaseViewHolder> {
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public PushSoftwareAdapter(android.content.Context context, java.util.List<com.qcwireless.qcwatch.ui.device.push.bean.SoftwarePush> list) {
        super(com.qcwireless.qcwatch.R.layout.recycleview_item_msg_push, list);
    ...
    public void convert(com.chad.library.adapter.base.viewholder.BaseViewHolder holder, com.qcwireless.qcwatch.ui.device.push.bean.SoftwarePush item) {
        ...
        android.widget.ImageView imageView = (android.widget.ImageView) holder.getView(com.qcwireless.qcwatch.R.id.right_switch);
        if (item.getSwitch()) {
            imageView.setImageResource(com.qcwireless.qcwatch.R.mipmap.check_on);
        } else {
            imageView.setImageResource(com.qcwireless.qcwatch.R.mipmap.check_off);
        }
    }
}
