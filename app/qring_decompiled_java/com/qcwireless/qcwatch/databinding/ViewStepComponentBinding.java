...
public final class ViewStepComponentBinding implements androidx.viewbinding.ViewBinding {
    ...
    public static com.qcwireless.qcwatch.databinding.ViewStepComponentBinding inflate(android.view.LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static com.qcwireless.qcwatch.databinding.ViewStepComponentBinding inflate(android.view.LayoutInflater inflater, android.view.ViewGroup parent, boolean attachToParent) {
        android.view.View inflate = inflater.inflate(com.qcwireless.qcwatch.R.layout.view_step_component, parent, false);
        if (attachToParent) {
    ...
    public static com.qcwireless.qcwatch.databinding.ViewStepComponentBinding bind(android.view.View rootView) {
                        ...
                        if (textView4 != null) {
                            ...
                            if (textView5 != null) {
                                ...
                                if (textView6 != null) {
                                    ...
                                    if (textView7 != null) {
                                        return new com.qcwireless.qcwatch.databinding.ViewStepComponentBinding((androidx.constraintlayout.widget.ConstraintLayout) rootView, textView, findChildViewById, textView2, textView3, textView4, textView5, textView6, textView7);
                                    }
                                }
                            }
                        }
