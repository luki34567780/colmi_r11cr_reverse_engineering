...
public final class LayoutDialogYmdViewBinding implements androidx.viewbinding.ViewBinding {
    ...
    public static com.qcwireless.qcwatch.databinding.LayoutDialogYmdViewBinding inflate(android.view.LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static com.qcwireless.qcwatch.databinding.LayoutDialogYmdViewBinding inflate(android.view.LayoutInflater inflater, android.view.ViewGroup parent, boolean attachToParent) {
        android.view.View inflate = inflater.inflate(com.qcwireless.qcwatch.R.layout.layout_dialog_ymd_view, parent, false);
        if (attachToParent) {
    ...
    public static com.qcwireless.qcwatch.databinding.LayoutDialogYmdViewBinding bind(android.view.View rootView) {
                ...
                if (textView3 != null) {
                    ...
                    if (wheelView != null) {
                        ...
                        if (wheelView2 != null) {
                            ...
                            if (wheelView3 != null) {
                                return new com.qcwireless.qcwatch.databinding.LayoutDialogYmdViewBinding((androidx.constraintlayout.widget.ConstraintLayout) rootView, textView, textView2, textView3, wheelView, wheelView2, wheelView3);
                            }
                        }
                    }
                }
