...
public final class ActivityDeviceFirmwareUpdateBinding implements androidx.viewbinding.ViewBinding {
    ...
    private ActivityDeviceFirmwareUpdateBinding(androidx.constraintlayout.widget.ConstraintLayout rootView, com.qcwireless.qcwatch.ui.base.view.QProgressCircle progressValue, com.qcwireless.qcwatch.databinding.LayoutTitleBarBinding titleBar, android.widget.TextView tvError, android.widget.TextView tvProgressUnit, android.widget.TextView tvProgressValue, android.widget.TextView tvWarming) {
    ...
    public static com.qcwireless.qcwatch.databinding.ActivityDeviceFirmwareUpdateBinding inflate(android.view.LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static com.qcwireless.qcwatch.databinding.ActivityDeviceFirmwareUpdateBinding inflate(android.view.LayoutInflater inflater, android.view.ViewGroup parent, boolean attachToParent) {
        android.view.View inflate = inflater.inflate(com.qcwireless.qcwatch.R.layout.activity_device_firmware_update, parent, false);
        if (attachToParent) {
    ...
    public static com.qcwireless.qcwatch.databinding.ActivityDeviceFirmwareUpdateBinding bind(android.view.View rootView) {
                ...
                if (textView != null) {
                    ...
                    if (textView2 != null) {
                        ...
                        if (textView3 != null) {
                            ...
                            android.widget.TextView textView4 = (android.widget.TextView) androidx.viewbinding.ViewBindings.findChildViewById(rootView, com.qcwireless.qcwatch.R.id.tv_warming);
                            if (textView4 != null) {
                                return new com.qcwireless.qcwatch.databinding.ActivityDeviceFirmwareUpdateBinding((androidx.constraintlayout.widget.ConstraintLayout) rootView, qProgressCircle, bind, textView, textView2, textView3, textView4);
                            }
                        }
                    }
                }
