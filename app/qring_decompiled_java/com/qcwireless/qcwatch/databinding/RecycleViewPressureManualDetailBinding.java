...
public final class RecycleViewPressureManualDetailBinding implements androidx.viewbinding.ViewBinding {
    ...
    private RecycleViewPressureManualDetailBinding(androidx.constraintlayout.widget.ConstraintLayout rootView, android.widget.ImageView imageSpo2, android.widget.TextView pressureTime, android.widget.TextView pressureValue, android.widget.TextView pressureValueStatus) {
    ...
    public static com.qcwireless.qcwatch.databinding.RecycleViewPressureManualDetailBinding inflate(android.view.LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static com.qcwireless.qcwatch.databinding.RecycleViewPressureManualDetailBinding inflate(android.view.LayoutInflater inflater, android.view.ViewGroup parent, boolean attachToParent) {
        android.view.View inflate = inflater.inflate(com.qcwireless.qcwatch.R.layout.recycle_view_pressure_manual_detail, parent, false);
        if (attachToParent) {
    ...
    public static com.qcwireless.qcwatch.databinding.RecycleViewPressureManualDetailBinding bind(android.view.View rootView) {
        ...
        if (imageView != null) {
            ...
            if (textView != null) {
                ...
                if (textView2 != null) {
                    ...
                    if (textView3 != null) {
                        return new com.qcwireless.qcwatch.databinding.RecycleViewPressureManualDetailBinding((androidx.constraintlayout.widget.ConstraintLayout) rootView, imageView, textView, textView2, textView3);
                    }
                }
            }
        }
