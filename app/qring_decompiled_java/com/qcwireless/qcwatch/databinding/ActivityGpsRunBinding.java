...
public final class ActivityGpsRunBinding implements androidx.viewbinding.ViewBinding {
    ...
    public static com.qcwireless.qcwatch.databinding.ActivityGpsRunBinding inflate(android.view.LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static com.qcwireless.qcwatch.databinding.ActivityGpsRunBinding inflate(android.view.LayoutInflater inflater, android.view.ViewGroup parent, boolean attachToParent) {
        android.view.View inflate = inflater.inflate(com.qcwireless.qcwatch.R.layout.activity_gps_run, parent, false);
        if (attachToParent) {
    ...
    public static com.qcwireless.qcwatch.databinding.ActivityGpsRunBinding bind(android.view.View rootView) {
                                                ...
                                                if (lockView != null) {
                                                    ...
                                                    if (textView != null) {
                                                        ...
                                                        if (textView2 != null) {
                                                            ...
                                                            if (textView3 != null) {
                                                                return new com.qcwireless.qcwatch.databinding.ActivityGpsRunBinding((androidx.constraintlayout.widget.ConstraintLayout) rootView, qSportItemView, qSportItemView2, qSportItemView3, qSportItemView4, qSportItemView5, imageView, gpsStartView, gpsEndView, imageView2, imageView3, lockView, textView, textView2, textView3);
                                                            }
                                                        }
                                                    }
                                                }
