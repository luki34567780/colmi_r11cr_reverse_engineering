...
public final class RecycleviewItemMenuMusicBinding implements androidx.viewbinding.ViewBinding {
    ...
    private RecycleviewItemMenuMusicBinding(androidx.constraintlayout.widget.ConstraintLayout rootView, android.widget.ImageView imageShowPop, android.view.View itemLine, android.widget.TextView rcvDeviceAddress, android.widget.TextView rcvDeviceName) {
    ...
    public static com.qcwireless.qcwatch.databinding.RecycleviewItemMenuMusicBinding inflate(android.view.LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static com.qcwireless.qcwatch.databinding.RecycleviewItemMenuMusicBinding inflate(android.view.LayoutInflater inflater, android.view.ViewGroup parent, boolean attachToParent) {
        android.view.View inflate = inflater.inflate(com.qcwireless.qcwatch.R.layout.recycleview_item_menu_music, parent, false);
        if (attachToParent) {
    ...
    public static com.qcwireless.qcwatch.databinding.RecycleviewItemMenuMusicBinding bind(android.view.View rootView) {
        ...
        if (imageView != null) {
            ...
            if (findChildViewById != null) {
                ...
                if (textView != null) {
                    ...
                    if (textView2 != null) {
                        return new com.qcwireless.qcwatch.databinding.RecycleviewItemMenuMusicBinding((androidx.constraintlayout.widget.ConstraintLayout) rootView, imageView, findChildViewById, textView, textView2);
                    }
                }
            }
        }
