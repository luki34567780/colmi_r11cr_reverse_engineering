...
public final class FragmentWeekSportBinding implements androidx.viewbinding.ViewBinding {
    ...
    private FragmentWeekSportBinding(androidx.core.widget.NestedScrollView rootView, android.widget.ImageView imageSportNoData, androidx.constraintlayout.widget.ConstraintLayout noDataLayout, com.qcwireless.qcwatch.ui.base.view.QDateWeekSwitchView qcDateChange, androidx.recyclerview.widget.RecyclerView sportDetailRcv, com.qcwireless.qcwatch.ui.base.view.QSportItemView totalCal, com.qcwireless.qcwatch.ui.base.view.QSportItemView totalDays, com.qcwireless.qcwatch.ui.base.view.QSportItemView totalTimes, android.widget.TextView tvRecent, android.widget.TextView weekTotal) {
    ...
    public static com.qcwireless.qcwatch.databinding.FragmentWeekSportBinding inflate(android.view.LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static com.qcwireless.qcwatch.databinding.FragmentWeekSportBinding inflate(android.view.LayoutInflater inflater, android.view.ViewGroup parent, boolean attachToParent) {
        android.view.View inflate = inflater.inflate(com.qcwireless.qcwatch.R.layout.fragment_week_sport, parent, false);
        if (attachToParent) {
    ...
    public static com.qcwireless.qcwatch.databinding.FragmentWeekSportBinding bind(android.view.View rootView) {
                        ...
                        if (qSportItemView != null) {
                            ...
                            if (qSportItemView2 != null) {
                                ...
                                if (qSportItemView3 != null) {
                                    ...
                                    android.widget.TextView textView = (android.widget.TextView) androidx.viewbinding.ViewBindings.findChildViewById(rootView, com.qcwireless.qcwatch.R.id.tv_recent);
                                    if (textView != null) {
                                        i = com.qcwireless.qcwatch.R.id.week_total;
                                        android.widget.TextView textView2 = (android.widget.TextView) androidx.viewbinding.ViewBindings.findChildViewById(rootView, com.qcwireless.qcwatch.R.id.week_total);
                                        if (textView2 != null) {
                                            return new com.qcwireless.qcwatch.databinding.FragmentWeekSportBinding((androidx.core.widget.NestedScrollView) rootView, imageView, findChildViewById, qDateWeekSwitchView, findChildViewById2, qSportItemView, qSportItemView2, qSportItemView3, textView, textView2);
                                        }
                                    }
                                }
                            }
