...
public final class ActivitySportDetailCalorieBinding implements androidx.viewbinding.ViewBinding {
    ...
    public static com.qcwireless.qcwatch.databinding.ActivitySportDetailCalorieBinding inflate(android.view.LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static com.qcwireless.qcwatch.databinding.ActivitySportDetailCalorieBinding inflate(android.view.LayoutInflater inflater, android.view.ViewGroup parent, boolean attachToParent) {
        android.view.View inflate = inflater.inflate(com.qcwireless.qcwatch.R.layout.activity_sport_detail_calorie, parent, false);
        if (attachToParent) {
    ...
    public static com.qcwireless.qcwatch.databinding.ActivitySportDetailCalorieBinding bind(android.view.View rootView) {
                                                                                                    ...
                                                                                                    if (textView17 != null) {
                                                                                                        ...
                                                                                                        if (textView18 != null) {
                                                                                                            ...
                                                                                                            if (textView19 != null) {
                                                                                                                ...
                                                                                                                if (textView20 != null) {
                                                                                                                    return new com.qcwireless.qcwatch.databinding.ActivitySportDetailCalorieBinding((androidx.constraintlayout.widget.ConstraintLayout) rootView, findChildViewById, qCirclePieView, findChildViewById2, qHeartSportDetailLineChartView, qSportDetailItem, qSportDetailItem2, bind, textView, textView2, textView3, textView4, textView5, textView6, textView7, textView8, textView9, textView10, textView11, textView12, textView13, textView14, textView15, textView16, textView17, textView18, textView19, textView20);
                                                                                                                }
                                                                                                            }
                                                                                                        }
                                                                                                    }
