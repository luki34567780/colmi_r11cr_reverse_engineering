...
public final class FragmentHeightBinding implements androidx.viewbinding.ViewBinding {
    ...
    public static com.qcwireless.qcwatch.databinding.FragmentHeightBinding inflate(android.view.LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static com.qcwireless.qcwatch.databinding.FragmentHeightBinding inflate(android.view.LayoutInflater inflater, android.view.ViewGroup parent, boolean attachToParent) {
        android.view.View inflate = inflater.inflate(com.qcwireless.qcwatch.R.layout.fragment_height, parent, false);
        if (attachToParent) {
    ...
    public static com.qcwireless.qcwatch.databinding.FragmentHeightBinding bind(android.view.View rootView) {
                ...
                if (textView != null) {
                    ...
                    if (textView2 != null) {
                        ...
                        if (wheelView != null) {
                            ...
                            if (wheelView2 != null) {
                                return new com.qcwireless.qcwatch.databinding.FragmentHeightBinding((androidx.constraintlayout.widget.ConstraintLayout) rootView, button, findChildViewById, textView, textView2, wheelView, wheelView2);
                            }
                        }
                    }
                }
