...
public final class QcDeviceItemBinding implements androidx.viewbinding.ViewBinding {
    public final android.widget.ImageView imageError;
    ...
    public static com.qcwireless.qcwatch.databinding.QcDeviceItemBinding inflate(android.view.LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static com.qcwireless.qcwatch.databinding.QcDeviceItemBinding inflate(android.view.LayoutInflater inflater, android.view.ViewGroup parent, boolean attachToParent) {
        android.view.View inflate = inflater.inflate(com.qcwireless.qcwatch.R.layout.qc_device_item, parent, false);
        if (attachToParent) {
    ...
    public static com.qcwireless.qcwatch.databinding.QcDeviceItemBinding bind(android.view.View rootView) {
        int i = com.qcwireless.qcwatch.R.id.image_error;
        android.widget.ImageView imageView = (android.widget.ImageView) androidx.viewbinding.ViewBindings.findChildViewById(rootView, com.qcwireless.qcwatch.R.id.image_error);
        if (imageView != null) {
            i = com.qcwireless.qcwatch.R.id.iv_lefticon;
            android.widget.ImageView imageView2 = (android.widget.ImageView) androidx.viewbinding.ViewBindings.findChildViewById(rootView, com.qcwireless.qcwatch.R.id.iv_lefticon);
            if (imageView2 != null) {
                i = com.qcwireless.qcwatch.R.id.iv_righticon;
                android.widget.ImageView imageView3 = (android.widget.ImageView) androidx.viewbinding.ViewBindings.findChildViewById(rootView, com.qcwireless.qcwatch.R.id.iv_righticon);
                if (imageView3 != null) {
                            ...
                            if (qSwitchCompat != null) {
                                ...
                                if (textView != null) {
                                    ...
                                    if (textView2 != null) {
                                        ...
                                        if (textView3 != null) {
                                            return new com.qcwireless.qcwatch.databinding.QcDeviceItemBinding(constraintLayout, imageView, imageView2, imageView3, findChildViewById, frameLayout, qSwitchCompat, constraintLayout, textView, textView2, textView3);
                                        }
                                    }
                                }
                            }
