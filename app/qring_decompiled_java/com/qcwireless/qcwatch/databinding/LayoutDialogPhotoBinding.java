...
public final class LayoutDialogPhotoBinding implements androidx.viewbinding.ViewBinding {
    ...
    private LayoutDialogPhotoBinding(androidx.constraintlayout.widget.ConstraintLayout rootView, android.view.View line1, android.widget.TextView tvCancel, android.widget.TextView tvTakePhoto, android.widget.TextView tvTakePicture) {
    ...
    public static com.qcwireless.qcwatch.databinding.LayoutDialogPhotoBinding inflate(android.view.LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static com.qcwireless.qcwatch.databinding.LayoutDialogPhotoBinding inflate(android.view.LayoutInflater inflater, android.view.ViewGroup parent, boolean attachToParent) {
        android.view.View inflate = inflater.inflate(com.qcwireless.qcwatch.R.layout.layout_dialog_photo, parent, false);
        if (attachToParent) {
    ...
    public static com.qcwireless.qcwatch.databinding.LayoutDialogPhotoBinding bind(android.view.View rootView) {
        ...
        if (findChildViewById != null) {
            ...
            if (textView != null) {
                ...
                if (textView2 != null) {
                    ...
                    if (textView3 != null) {
                        return new com.qcwireless.qcwatch.databinding.LayoutDialogPhotoBinding((androidx.constraintlayout.widget.ConstraintLayout) rootView, findChildViewById, textView, textView2, textView3);
                    }
                }
            }
        }
