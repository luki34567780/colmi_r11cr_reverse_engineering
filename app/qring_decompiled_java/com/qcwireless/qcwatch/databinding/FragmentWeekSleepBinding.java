...
public final class FragmentWeekSleepBinding implements androidx.viewbinding.ViewBinding {
    ...
    public static com.qcwireless.qcwatch.databinding.FragmentWeekSleepBinding inflate(android.view.LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static com.qcwireless.qcwatch.databinding.FragmentWeekSleepBinding inflate(android.view.LayoutInflater inflater, android.view.ViewGroup parent, boolean attachToParent) {
        android.view.View inflate = inflater.inflate(com.qcwireless.qcwatch.R.layout.fragment_week_sleep, parent, false);
        if (attachToParent) {
    ...
    public static com.qcwireless.qcwatch.databinding.FragmentWeekSleepBinding bind(android.view.View rootView) {
                                                        ...
                                                        if (textView7 != null) {
                                                            ...
                                                            if (textView8 != null) {
                                                                ...
                                                                if (textView9 != null) {
                                                                    ...
                                                                    if (textView10 != null) {
                                                                        i = com.qcwireless.qcwatch.R.id.week_sleep_bar_view;
                                                                        com.qcwireless.qcwatch.ui.base.view.QSleepWeekBarView qSleepWeekBarView = (com.qcwireless.qcwatch.ui.base.view.QSleepWeekBarView) androidx.viewbinding.ViewBindings.findChildViewById(rootView, com.qcwireless.qcwatch.R.id.week_sleep_bar_view);
                                                                        if (qSleepWeekBarView != null) {
                                                                            return new com.qcwireless.qcwatch.databinding.FragmentWeekSleepBinding((androidx.core.widget.NestedScrollView) rootView, findChildViewById, qDateWeekSwitchView, qSleepAnalysisView, qSleepAnalysisView2, qSleepAnalysisView3, qSleepAnalysisView4, textView, textView2, textView3, textView4, textView5, textView6, textView7, textView8, textView9, textView10, qSleepWeekBarView);
                                                                        }
                                                                    }
                                                                }
                                                            }
