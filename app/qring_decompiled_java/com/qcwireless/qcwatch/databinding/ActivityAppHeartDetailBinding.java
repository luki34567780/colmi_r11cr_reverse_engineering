...
public final class ActivityAppHeartDetailBinding implements androidx.viewbinding.ViewBinding {
    ...
    public static com.qcwireless.qcwatch.databinding.ActivityAppHeartDetailBinding inflate(android.view.LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static com.qcwireless.qcwatch.databinding.ActivityAppHeartDetailBinding inflate(android.view.LayoutInflater inflater, android.view.ViewGroup parent, boolean attachToParent) {
        android.view.View inflate = inflater.inflate(com.qcwireless.qcwatch.R.layout.activity_app_heart_detail, parent, false);
        if (attachToParent) {
    ...
    public static com.qcwireless.qcwatch.databinding.ActivityAppHeartDetailBinding bind(android.view.View rootView) {
                ...
                if (findChildViewById2 != null) {
                    ...
                    if (findChildViewById3 != null) {
                        ...
                        if (textView != null) {
                            ...
                            if (textView2 != null) {
                                return new com.qcwireless.qcwatch.databinding.ActivityAppHeartDetailBinding((androidx.constraintlayout.widget.ConstraintLayout) rootView, imageView, findChildViewById, findChildViewById2, bind, textView, textView2);
                            }
                        }
                    }
                }
