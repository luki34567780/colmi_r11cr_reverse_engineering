...
public final class FragmentMonthPressureBinding implements androidx.viewbinding.ViewBinding {
    ...
    public final com.qcwireless.qcwatch.ui.base.view.QPressureMonthHistoryBarChart qcPressureChart;
    ...
    public static com.qcwireless.qcwatch.databinding.FragmentMonthPressureBinding inflate(android.view.LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static com.qcwireless.qcwatch.databinding.FragmentMonthPressureBinding inflate(android.view.LayoutInflater inflater, android.view.ViewGroup parent, boolean attachToParent) {
        android.view.View inflate = inflater.inflate(com.qcwireless.qcwatch.R.layout.fragment_month_pressure, parent, false);
        if (attachToParent) {
    ...
    public static com.qcwireless.qcwatch.databinding.FragmentMonthPressureBinding bind(android.view.View rootView) {
                ...
                if (qStepComponentView != null) {
                    ...
                    if (qStepComponentView2 != null) {
                        ...
                        if (qDateMonthSwitchView != null) {
                            ...
                            com.qcwireless.qcwatch.ui.base.view.QPressureMonthHistoryBarChart qPressureMonthHistoryBarChart = (com.qcwireless.qcwatch.ui.base.view.QPressureMonthHistoryBarChart) androidx.viewbinding.ViewBindings.findChildViewById(rootView, com.qcwireless.qcwatch.R.id.qc_pressure_chart);
                                                                                        ...
                                                                                        if (textView15 != null) {
                                                                                            ...
                                                                                            if (textView16 != null) {
                                                                                                ...
                                                                                                if (textView17 != null) {
                                                                                                    ...
                                                                                                    if (textView18 != null) {
                                                                                                        return new com.qcwireless.qcwatch.databinding.FragmentMonthPressureBinding((androidx.constraintlayout.widget.ConstraintLayout) rootView, findChildViewById, qCirclePieView, qStepComponentView, qStepComponentView2, qDateMonthSwitchView, qPressureMonthHistoryBarChart, textView, textView2, textView3, textView4, textView5, textView6, textView7, textView8, textView9, textView10, textView11, textView12, textView13, textView14, textView15, textView16, textView17, textView18);
                                                                                                    }
                                                                                                }
                                                                                            }
                                                                                        }
