...
public final class FragmentMonthStepBinding implements androidx.viewbinding.ViewBinding {
    public final com.qcwireless.qcwatch.ui.base.view.QStepMonthHistoryBarChart monthStepBarView;
    ...
    public static com.qcwireless.qcwatch.databinding.FragmentMonthStepBinding inflate(android.view.LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static com.qcwireless.qcwatch.databinding.FragmentMonthStepBinding inflate(android.view.LayoutInflater inflater, android.view.ViewGroup parent, boolean attachToParent) {
        android.view.View inflate = inflater.inflate(com.qcwireless.qcwatch.R.layout.fragment_month_step, parent, false);
        if (attachToParent) {
    ...
    public static com.qcwireless.qcwatch.databinding.FragmentMonthStepBinding bind(android.view.View rootView) {
        int i = com.qcwireless.qcwatch.R.id.month_step_bar_view;
        com.qcwireless.qcwatch.ui.base.view.QStepMonthHistoryBarChart qStepMonthHistoryBarChart = (com.qcwireless.qcwatch.ui.base.view.QStepMonthHistoryBarChart) androidx.viewbinding.ViewBindings.findChildViewById(rootView, com.qcwireless.qcwatch.R.id.month_step_bar_view);
                                ...
                                if (textView != null) {
                                    ...
                                    if (textView2 != null) {
                                        ...
                                        if (textView3 != null) {
                                            ...
                                            if (textView4 != null) {
                                                return new com.qcwireless.qcwatch.databinding.FragmentMonthStepBinding((androidx.constraintlayout.widget.ConstraintLayout) rootView, qStepMonthHistoryBarChart, qDateMonthSwitchView, qStepComponentView, qStepComponentView2, qStepComponentView3, qStepComponentView4, textView, textView2, textView3, textView4);
                                            }
                                        }
                                    }
                                }
