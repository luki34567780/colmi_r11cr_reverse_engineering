...
public final class QcDeviceItemWithClickSystemBinding implements androidx.viewbinding.ViewBinding {
    ...
    public static com.qcwireless.qcwatch.databinding.QcDeviceItemWithClickSystemBinding inflate(android.view.LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static com.qcwireless.qcwatch.databinding.QcDeviceItemWithClickSystemBinding inflate(android.view.LayoutInflater inflater, android.view.ViewGroup parent, boolean attachToParent) {
        android.view.View inflate = inflater.inflate(com.qcwireless.qcwatch.R.layout.qc_device_item_with_click_system, parent, false);
        if (attachToParent) {
    ...
    public static com.qcwireless.qcwatch.databinding.QcDeviceItemWithClickSystemBinding bind(android.view.View rootView) {
                        ...
                        if (qSwitchCompat != null) {
                            ...
                            if (textView != null) {
                                ...
                                if (textView2 != null) {
                                    ...
                                    if (textView3 != null) {
                                        return new com.qcwireless.qcwatch.databinding.QcDeviceItemWithClickSystemBinding(constraintLayout, imageView, imageView2, findChildViewById, frameLayout, qSwitchCompat, constraintLayout, textView, textView2, textView3);
                                    }
                                }
                            }
                        }
