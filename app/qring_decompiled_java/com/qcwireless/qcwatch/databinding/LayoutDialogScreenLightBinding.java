...
public final class LayoutDialogScreenLightBinding implements androidx.viewbinding.ViewBinding {
    ...
    private LayoutDialogScreenLightBinding(androidx.constraintlayout.widget.ConstraintLayout rootView, android.widget.TextView subTitle1, android.widget.TextView tvDialogCancel, android.widget.TextView tvDialogConfirm, android.widget.TextView tvDialogTitle, com.contrarywind.view.WheelView wheelViewSecond) {
    ...
    public static com.qcwireless.qcwatch.databinding.LayoutDialogScreenLightBinding inflate(android.view.LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static com.qcwireless.qcwatch.databinding.LayoutDialogScreenLightBinding inflate(android.view.LayoutInflater inflater, android.view.ViewGroup parent, boolean attachToParent) {
        android.view.View inflate = inflater.inflate(com.qcwireless.qcwatch.R.layout.layout_dialog_screen_light, parent, false);
        if (attachToParent) {
    ...
    public static com.qcwireless.qcwatch.databinding.LayoutDialogScreenLightBinding bind(android.view.View rootView) {
            ...
            if (textView2 != null) {
                ...
                if (textView3 != null) {
                    ...
                    if (textView4 != null) {
                        ...
                        if (wheelView != null) {
                            return new com.qcwireless.qcwatch.databinding.LayoutDialogScreenLightBinding((androidx.constraintlayout.widget.ConstraintLayout) rootView, textView, textView2, textView3, textView4, wheelView);
                        }
                    }
                }
            }
