...
public final class ActivityGpsMapCnBinding implements androidx.viewbinding.ViewBinding {
    ...
    public static com.qcwireless.qcwatch.databinding.ActivityGpsMapCnBinding inflate(android.view.LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static com.qcwireless.qcwatch.databinding.ActivityGpsMapCnBinding inflate(android.view.LayoutInflater inflater, android.view.ViewGroup parent, boolean attachToParent) {
        android.view.View inflate = inflater.inflate(com.qcwireless.qcwatch.R.layout.activity_gps_map_cn, parent, false);
        if (attachToParent) {
    ...
    public static com.qcwireless.qcwatch.databinding.ActivityGpsMapCnBinding bind(android.view.View rootView) {
            ...
            if (qSportItemView2 != null) {
                ...
                if (qSportItemView3 != null) {
                    ...
                    if (imageView != null) {
                        ...
                        com.amap.api.maps.MapView findChildViewById = androidx.viewbinding.ViewBindings.findChildViewById(rootView, com.qcwireless.qcwatch.R.id.map_view);
                        if (findChildViewById != null) {
                            return new com.qcwireless.qcwatch.databinding.ActivityGpsMapCnBinding((androidx.constraintlayout.widget.ConstraintLayout) rootView, qSportItemView, qSportItemView2, qSportItemView3, imageView, findChildViewById);
                        }
                    }
                }
            }
