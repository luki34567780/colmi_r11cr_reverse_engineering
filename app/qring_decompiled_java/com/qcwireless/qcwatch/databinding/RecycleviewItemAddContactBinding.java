...
public final class RecycleviewItemAddContactBinding implements androidx.viewbinding.ViewBinding {
    ...
    private RecycleviewItemAddContactBinding(androidx.constraintlayout.widget.ConstraintLayout rootView, android.widget.ImageView imageSelect, android.view.View itemLine, android.widget.TextView keyWord, android.widget.TextView rcvDeviceAddress, android.widget.TextView rcvDeviceName) {
    ...
    public static com.qcwireless.qcwatch.databinding.RecycleviewItemAddContactBinding inflate(android.view.LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static com.qcwireless.qcwatch.databinding.RecycleviewItemAddContactBinding inflate(android.view.LayoutInflater inflater, android.view.ViewGroup parent, boolean attachToParent) {
        android.view.View inflate = inflater.inflate(com.qcwireless.qcwatch.R.layout.recycleview_item_add_contact, parent, false);
        if (attachToParent) {
    ...
    public static com.qcwireless.qcwatch.databinding.RecycleviewItemAddContactBinding bind(android.view.View rootView) {
            ...
            if (findChildViewById != null) {
                ...
                if (textView != null) {
                    ...
                    if (textView2 != null) {
                        ...
                        if (textView3 != null) {
                            return new com.qcwireless.qcwatch.databinding.RecycleviewItemAddContactBinding((androidx.constraintlayout.widget.ConstraintLayout) rootView, imageView, findChildViewById, textView, textView2, textView3);
                        }
                    }
                }
            }
