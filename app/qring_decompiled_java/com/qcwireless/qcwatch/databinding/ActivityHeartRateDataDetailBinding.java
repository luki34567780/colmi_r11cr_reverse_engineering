...
public final class ActivityHeartRateDataDetailBinding implements androidx.viewbinding.ViewBinding {
    ...
    public final androidx.recyclerview.widget.RecyclerView rcvHeartRateDetail;
    ...
    private ActivityHeartRateDataDetailBinding(androidx.constraintlayout.widget.ConstraintLayout rootView, android.widget.ImageView imageSportNoData, androidx.constraintlayout.widget.ConstraintLayout noDataView, androidx.recyclerview.widget.RecyclerView rcvHeartRateDetail, com.qcwireless.qcwatch.databinding.LayoutTitleBarBinding titleBar, android.widget.TextView tvDataDate, android.widget.TextView tvErrorText) {
    ...
    public static com.qcwireless.qcwatch.databinding.ActivityHeartRateDataDetailBinding inflate(android.view.LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static com.qcwireless.qcwatch.databinding.ActivityHeartRateDataDetailBinding inflate(android.view.LayoutInflater inflater, android.view.ViewGroup parent, boolean attachToParent) {
        android.view.View inflate = inflater.inflate(com.qcwireless.qcwatch.R.layout.activity_heart_rate_data_detail, parent, false);
        if (attachToParent) {
    ...
    public static com.qcwireless.qcwatch.databinding.ActivityHeartRateDataDetailBinding bind(android.view.View rootView) {
        ...
        if (imageView != null) {
            ...
            if (findChildViewById != null) {
                i = com.qcwireless.qcwatch.R.id.rcv_heart_rate_detail;
                androidx.recyclerview.widget.RecyclerView findChildViewById2 = androidx.viewbinding.ViewBindings.findChildViewById(rootView, com.qcwireless.qcwatch.R.id.rcv_heart_rate_detail);
                if (findChildViewById2 != null) {
                    ...
                    if (findChildViewById3 != null) {
                        ...
                        if (textView != null) {
                            ...
                            if (textView2 != null) {
                                return new com.qcwireless.qcwatch.databinding.ActivityHeartRateDataDetailBinding((androidx.constraintlayout.widget.ConstraintLayout) rootView, imageView, findChildViewById, findChildViewById2, bind, textView, textView2);
                            }
                        }
                    }
                }
