...
public final class ActivityTemperatureGuideBinding implements androidx.viewbinding.ViewBinding {
    ...
    private ActivityTemperatureGuideBinding(androidx.constraintlayout.widget.ConstraintLayout rootView, com.qcwireless.qcwatch.databinding.LayoutTitleBarBinding titleBar, android.widget.TextView tvInfo1, android.widget.TextView tvInfo2, android.widget.ImageView watchDisplay) {
    ...
    public static com.qcwireless.qcwatch.databinding.ActivityTemperatureGuideBinding inflate(android.view.LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static com.qcwireless.qcwatch.databinding.ActivityTemperatureGuideBinding inflate(android.view.LayoutInflater inflater, android.view.ViewGroup parent, boolean attachToParent) {
        android.view.View inflate = inflater.inflate(com.qcwireless.qcwatch.R.layout.activity_temperature_guide, parent, false);
        if (attachToParent) {
    ...
    public static com.qcwireless.qcwatch.databinding.ActivityTemperatureGuideBinding bind(android.view.View rootView) {
        int i = 2131297388;
        ...
        if (findChildViewById != null) {
            ...
            if (textView != null) {
                ...
                if (textView2 != null) {
                    ...
                    if (imageView != null) {
                        return new com.qcwireless.qcwatch.databinding.ActivityTemperatureGuideBinding((androidx.constraintlayout.widget.ConstraintLayout) rootView, bind, textView, textView2, imageView);
                    }
                }
            }
        }
