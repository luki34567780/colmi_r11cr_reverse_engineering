...
public final class LayoutDialogBirthdayViewBinding implements androidx.viewbinding.ViewBinding {
    ...
    public static com.qcwireless.qcwatch.databinding.LayoutDialogBirthdayViewBinding inflate(android.view.LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static com.qcwireless.qcwatch.databinding.LayoutDialogBirthdayViewBinding inflate(android.view.LayoutInflater inflater, android.view.ViewGroup parent, boolean attachToParent) {
        android.view.View inflate = inflater.inflate(com.qcwireless.qcwatch.R.layout.layout_dialog_birthday_view, parent, false);
        if (attachToParent) {
    ...
    public static com.qcwireless.qcwatch.databinding.LayoutDialogBirthdayViewBinding bind(android.view.View rootView) {
                ...
                if (textView3 != null) {
                    ...
                    if (textView4 != null) {
                        ...
                        if (wheelView != null) {
                            ...
                            if (wheelView2 != null) {
                                return new com.qcwireless.qcwatch.databinding.LayoutDialogBirthdayViewBinding((androidx.constraintlayout.widget.ConstraintLayout) rootView, textView, textView2, textView3, textView4, wheelView, wheelView2);
                            }
                        }
                    }
                }
