...
public final class zzg implements android.os.Parcelable.Creator {
    ...
    public final /* bridge */ /* synthetic */ java.lang.Object createFromParcel(android.os.Parcel parcel) {
        ...
        while (parcel.dataPosition() < validateObjectHeader) {
            ...
            if (fieldId == 1) {
                arrayList = com.google.android.gms.common.internal.safeparcel.SafeParcelReader.createTypedList(parcel, readHeader, com.google.android.gms.fitness.data.Subscription.CREATOR);
            } else if (fieldId != 2) {
        ...
        return new com.google.android.gms.fitness.result.ListSubscriptionsResult(arrayList, status);
    }
