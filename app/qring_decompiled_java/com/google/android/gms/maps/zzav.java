...
final class zzav extends com.google.android.gms.dynamic.DeferredLifecycleHelper {
    ...
    zzav(androidx.fragment.app.Fragment fragment) {
        this.zzb = fragment;
    }

    static /* synthetic */ void zza(com.google.android.gms.maps.zzav zzavVar, android.app.Activity activity) {
    ...
    public final void zzb(com.google.android.gms.maps.OnMapReadyCallback onMapReadyCallback) {
        if (getDelegate() != null) {
            ((com.google.android.gms.maps.zzau) getDelegate()).getMapAsync(onMapReadyCallback);
        } else {
    ...
    public final void zzc() {
        ...
        try {
            ...
            this.zza.onDelegateCreated(new com.google.android.gms.maps.zzau(this.zzb, zzf));
            java.util.Iterator it = this.zzd.iterator();
            while (it.hasNext()) {
                ((com.google.android.gms.maps.zzau) getDelegate()).getMapAsync((com.google.android.gms.maps.OnMapReadyCallback) it.next());
            }
            this.zzd.clear();
