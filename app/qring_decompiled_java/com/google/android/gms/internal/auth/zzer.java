...
final class zzer extends com.google.android.gms.internal.auth.zzdn<java.lang.Integer> implements java.util.RandomAccess, com.google.android.gms.internal.auth.zzeu, com.google.android.gms.internal.auth.zzfx {
    private static final com.google.android.gms.internal.auth.zzer zza;
    private int[] zzb;
    private int zzc;

    static {
        com.google.android.gms.internal.auth.zzer zzerVar = new com.google.android.gms.internal.auth.zzer(new int[0], 0);
        zza = zzerVar;
        zzerVar.zzb();
    }
    ...
    public final /* bridge */ /* synthetic */ com.google.android.gms.internal.auth.zzeu zzd(int i) {
        if (i >= this.zzc) {
            return new com.google.android.gms.internal.auth.zzer(java.util.Arrays.copyOf(this.zzb, i), this.zzc);
        }
