...
public final class MaterialContainerTransform extends android.transition.Transition {
        ...
        if (transitionValues != null && transitionValues2 != null) {
            ...
            if (rectF == null || shapeAppearanceModel == null) {
                ...
                if (this.drawingViewId == view3.getId()) {
                    ...
                    findAncestorById = com.google.android.material.transition.platform.TransitionUtils.findAncestorById(view3, this.drawingViewId);
                    view3 = null;
                }
    ...
    private static final class TransitionDrawable extends android.graphics.drawable.Drawable {
        ...
        private void updateProgress(float f) {
            ...
            float lerp = com.google.android.material.transition.platform.TransitionUtils.lerp(this.startElevation, this.endElevation, f);
            ...
            float lerp2 = com.google.android.material.transition.platform.TransitionUtils.lerp(0.0f, 1.0f, floatValue, floatValue2, f);
