...
public final class StringUtils {
    ...
    public static java.lang.String guessEncoding(byte[] bArr, java.util.Map<com.google.zxing.DecodeHintType, ?> map) {
        ...
        while (i3 < length && (z || z3 || z4)) {
            ...
            if (z4) {
                if (i4 > 0) {
                    if ((i13 & com.realsil.sdk.bbpro.equalizer.EqConstants.CodeIndex.BUILD_IN_EQ_4) != 0) {
                        i4--;
                    }
                    z4 = false;
                } else if ((i13 & com.realsil.sdk.bbpro.equalizer.EqConstants.CodeIndex.BUILD_IN_EQ_4) != 0) {
                    if ((i13 & 64) != 0) {
                        i4++;
                        if ((i13 & 32) == 0) {
                            i6++;
