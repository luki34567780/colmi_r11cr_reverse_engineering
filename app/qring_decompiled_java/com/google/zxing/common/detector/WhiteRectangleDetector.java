...
public final class WhiteRectangleDetector {
    ...
    private com.google.zxing.ResultPoint[] centerEdges(com.google.zxing.ResultPoint resultPoint, com.google.zxing.ResultPoint resultPoint2, com.google.zxing.ResultPoint resultPoint3, com.google.zxing.ResultPoint resultPoint4) {
        ...
        return x < ((float) this.width) / 2.0f ? new com.google.zxing.ResultPoint[]{new com.google.zxing.ResultPoint(x4 - 1.0f, y4 + 1.0f), new com.google.zxing.ResultPoint(x2 + 1.0f, y2 + 1.0f), new com.google.zxing.ResultPoint(x3 - 1.0f, y3 - 1.0f), new com.google.zxing.ResultPoint(x + 1.0f, y - 1.0f)} : new com.google.zxing.ResultPoint[]{new com.google.zxing.ResultPoint(x4 + 1.0f, y4 + 1.0f), new com.google.zxing.ResultPoint(x2 + 1.0f, y2 - 1.0f), new com.google.zxing.ResultPoint(x3 - 1.0f, y3 + 1.0f), new com.google.zxing.ResultPoint(x - 1.0f, y - 1.0f)};
    }
