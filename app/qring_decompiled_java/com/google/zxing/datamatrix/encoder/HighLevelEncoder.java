    ...
    static int lookAheadTest(java.lang.CharSequence charSequence, int i, int i2) {
        ...
        while (true) {
            ...
            if (i4 == charSequence.length()) {
                ...
                int[] iArr = new int[6];
                int findMinimums = findMinimums(fArr, iArr, com.google.android.gms.common.api.Api.BaseClientBuilder.API_PRIORITY_OTHER, bArr);
            ...
            if (i3 >= 4) {
                ...
                findMinimums(fArr, iArr2, com.google.android.gms.common.api.Api.BaseClientBuilder.API_PRIORITY_OTHER, bArr2);
