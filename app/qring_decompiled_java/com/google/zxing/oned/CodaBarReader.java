...
public final class CodaBarReader extends com.google.zxing.oned.OneDReader {
    ...
    public com.google.zxing.Result decodeRow(int i, com.google.zxing.common.BitArray bitArray, java.util.Map<com.google.zxing.DecodeHintType, ?> map) throws com.google.zxing.NotFoundException {
        ...
        float f2 = i;
        return new com.google.zxing.Result(this.decodeRowResult.toString(), null, new com.google.zxing.ResultPoint[]{new com.google.zxing.ResultPoint(f, f2), new com.google.zxing.ResultPoint(i8, f2)}, com.google.zxing.BarcodeFormat.CODABAR);
    }
    ...
    */
    ...
    private int toNarrowWidePattern(int i) {
        ...
        int i4 = 0;
        int i5 = com.google.android.gms.common.api.Api.BaseClientBuilder.API_PRIORITY_OTHER;
        int i6 = 0;
        ...
        int i13 = (i3 + i10) / 2;
        int i14 = com.realsil.sdk.bbpro.equalizer.EqConstants.CodeIndex.BUILD_IN_EQ_4;
        int i15 = 0;
