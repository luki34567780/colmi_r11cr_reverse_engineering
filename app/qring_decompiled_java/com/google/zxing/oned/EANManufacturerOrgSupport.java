...
final class EANManufacturerOrgSupport {
    ...
    private synchronized void initIfNeeded() {
        if (this.ranges.isEmpty()) {
            ...
            add(new int[]{478}, "UZ");
            add(new int[]{479}, "LK");
            add(new int[]{com.king.zxing.util.CodeUtils.DEFAULT_REQ_WIDTH}, "PH");
            add(new int[]{481}, "BY");
            add(new int[]{482}, "UA");
            add(new int[]{484}, "MD");
            add(new int[]{485}, "AM");
            ...
            add(new int[]{628}, "SA");
            add(new int[]{629}, "AE");
            add(new int[]{com.king.zxing.util.CodeUtils.DEFAULT_REQ_HEIGHT, 649}, "FI");
            ...
            add(new int[]{880}, "KR");
            add(new int[]{885}, "TH");
            add(new int[]{com.qcwireless.qcwatch.ui.home.healthy.vm.HealthyViewModel.Type_Sync_TimeOut}, "SG");
            add(new int[]{890}, "IN");
            add(new int[]{893}, "VN");
            add(new int[]{896}, "PK");
            add(new int[]{899}, "ID");
