...
public class SppHandle {
    ...
    private static com.oudmon.ble.base.bluetooth.spp.jieli.SppHandle mInstance;
    ...
    private int sizeA = 1;
    private int sizeB = 1;
    private com.oudmon.ble.base.bluetooth.spp.SerialListener serialListener = new com.oudmon.ble.base.bluetooth.spp.SerialListener() { // from class: com.oudmon.ble.base.bluetooth.spp.jieli.SppHandle.1
        ...
        public void onSerialConnect() {
            if (com.oudmon.ble.base.bluetooth.spp.jieli.SppHandle.this.outSerialListener != null) {
                com.oudmon.ble.base.bluetooth.spp.jieli.SppHandle.this.outSerialListener.onSerialConnect();
            }
        }
        ...
        public void onSerialConnectError(java.lang.Exception exc) {
            if (com.oudmon.ble.base.bluetooth.spp.jieli.SppHandle.this.outSerialListener != null) {
                com.oudmon.ble.base.bluetooth.spp.jieli.SppHandle.this.outSerialListener.onSerialConnectError(exc);
            }
        }
        ...
        public void onSerialRead(byte[] bArr) {
            if (bArr != null) {
                if ((bArr[0] & 255) == 188 && bArr[1] == 49) {
                    ...
                    com.oudmon.ble.base.bluetooth.spp.jieli.SppHandle.this.cmdSendPacket();
                    return;
                }
                if ((bArr[0] & 255) == 188 && bArr[1] == 50) {
                    ...
                    if (bytesToInt == 0) {
                        if (com.oudmon.ble.base.bluetooth.spp.jieli.SppHandle.this.readNextBigPocket()) {
                            float parseFloat = java.lang.Float.parseFloat(new java.text.DecimalFormat("#.00", new java.text.DecimalFormatSymbols(java.util.Locale.US)).format((((com.oudmon.ble.base.bluetooth.spp.jieli.SppHandle.this.mPocketIndex * com.oudmon.ble.base.bluetooth.spp.jieli.SppHandle.LongBagLength) * 1.0f) * 100.0f) / com.oudmon.ble.base.bluetooth.spp.jieli.SppHandle.this.totalSize));
                            com.iwown.awlog.AwLog.i(com.iwown.awlog.Author.HeZhiYuan, "向手环发送数据进度: " + parseFloat + ", 包序: " + ((int) com.oudmon.ble.base.bluetooth.spp.jieli.SppHandle.this.mPocketIndex) + "总包:" + com.oudmon.ble.base.bluetooth.spp.jieli.SppHandle.this.totalSize);
                            com.oudmon.ble.base.bluetooth.spp.jieli.SppHandle.this.mCallback.onProgress(java.lang.Math.min(parseFloat, 100.0f));
                            return;
                        }
                        com.iwown.awlog.AwLog.i(com.iwown.awlog.Author.HeZhiYuan, "向手环发送数据完毕, 包序: " + ((int) com.oudmon.ble.base.bluetooth.spp.jieli.SppHandle.this.mPocketIndex));
                        com.oudmon.ble.base.bluetooth.spp.jieli.SppHandle.this.cmdCheck();
                        return;
                    }
                    com.oudmon.ble.base.bluetooth.spp.jieli.SppHandle.this.mCallback.onDeleteSuccess(bytesToInt);
                    return;
                }
                if ((bArr[0] & 255) == 188 && bArr[1] == 51) {
                    com.iwown.awlog.AwLog.i(com.iwown.awlog.Author.HeZhiYuan, "===============回调 onComplete");
                    com.oudmon.ble.base.bluetooth.spp.jieli.SppHandle.this.mFileSend = new byte[0];
                    com.oudmon.ble.base.bluetooth.spp.jieli.SppHandle.this.mCallback.onComplete();
                    return;
                }
                if ((bArr[0] & 255) != 188 || bArr[1] != Byte.MIN_VALUE) {
                    if (com.oudmon.ble.base.bluetooth.spp.jieli.SppHandle.this.mReceiving) {
                        java.lang.System.arraycopy(bArr, 0, com.oudmon.ble.base.bluetooth.spp.jieli.SppHandle.this.mReceivedData, com.oudmon.ble.base.bluetooth.spp.jieli.SppHandle.this.mReceivedCount, bArr.length);
                        com.oudmon.ble.base.bluetooth.spp.jieli.SppHandle.access$812(com.oudmon.ble.base.bluetooth.spp.jieli.SppHandle.this, bArr.length);
                        com.oudmon.ble.base.bluetooth.spp.jieli.SppHandle sppHandle = com.oudmon.ble.base.bluetooth.spp.jieli.SppHandle.this;
                        sppHandle.mReceiving = sppHandle.mReceivedCount < com.oudmon.ble.base.bluetooth.spp.jieli.SppHandle.this.mTotalCount;
                        if (com.oudmon.ble.base.bluetooth.spp.jieli.SppHandle.this.mReceiving) {
                            return;
                        }
                        int bytesToInt2 = com.oudmon.ble.base.communication.utils.ByteUtil.bytesToInt(java.util.Arrays.copyOfRange(com.oudmon.ble.base.bluetooth.spp.jieli.SppHandle.this.mReceivedData, 1, 2));
                        if (com.oudmon.ble.base.communication.utils.ByteUtil.bytesToInt(java.util.Arrays.copyOfRange(com.oudmon.ble.base.bluetooth.spp.jieli.SppHandle.this.mReceivedData, 2, 3)) == 0) {
                            com.oudmon.ble.base.bluetooth.spp.jieli.SppHandle.this.fileNames = new java.util.ArrayList();
                        }
                        com.iwown.awlog.AwLog.i(com.iwown.awlog.Author.HeZhiYuan, java.lang.Integer.valueOf(bytesToInt2));
                        if (bytesToInt2 > 0) {
                            int bytesToInt3 = com.oudmon.ble.base.communication.utils.ByteUtil.bytesToInt(java.util.Arrays.copyOfRange(com.oudmon.ble.base.bluetooth.spp.jieli.SppHandle.this.mReceivedData, 4, 5));
                            com.oudmon.ble.base.bluetooth.spp.jieli.SppHandle sppHandle2 = com.oudmon.ble.base.bluetooth.spp.jieli.SppHandle.this;
                            sppHandle2.parseEbookData(sppHandle2.mReceivedData, 5, bytesToInt3, bytesToInt2, 0);
                            return;
                        }
                        com.oudmon.ble.base.bluetooth.spp.jieli.SppHandle.this.mCallback.onFileNames(com.oudmon.ble.base.bluetooth.spp.jieli.SppHandle.this.fileNames);
                        return;
                    }
                    if ((bArr[0] & 255) == 188 && bArr[1] == -127) {
                        com.oudmon.ble.base.bluetooth.spp.jieli.SppHandle.this.mCallback.onDeleteSuccess(com.oudmon.ble.base.communication.utils.ByteUtil.bytesToInt(java.util.Arrays.copyOfRange(bArr, 6, 7)));
                        return;
                    }
                    return;
                }
                com.oudmon.ble.base.bluetooth.spp.jieli.SppHandle.this.mTotalCount = com.qcwireless.qc_utils.bytes.DataTransferUtils.bytesToShort(bArr, 2);
                com.oudmon.ble.base.bluetooth.spp.jieli.SppHandle.this.mReceivedCount = bArr.length - 6;
                com.oudmon.ble.base.bluetooth.spp.jieli.SppHandle sppHandle3 = com.oudmon.ble.base.bluetooth.spp.jieli.SppHandle.this;
                sppHandle3.mReceivedData = new byte[sppHandle3.mTotalCount];
                java.lang.System.arraycopy(bArr, 6, com.oudmon.ble.base.bluetooth.spp.jieli.SppHandle.this.mReceivedData, 0, com.oudmon.ble.base.bluetooth.spp.jieli.SppHandle.this.mReceivedCount);
                com.oudmon.ble.base.bluetooth.spp.jieli.SppHandle sppHandle4 = com.oudmon.ble.base.bluetooth.spp.jieli.SppHandle.this;
                sppHandle4.mReceiving = sppHandle4.mReceivedCount < com.oudmon.ble.base.bluetooth.spp.jieli.SppHandle.this.mTotalCount;
                if (com.oudmon.ble.base.bluetooth.spp.jieli.SppHandle.this.mReceiving) {
                    return;
                }
                int bytesToInt4 = com.oudmon.ble.base.communication.utils.ByteUtil.bytesToInt(java.util.Arrays.copyOfRange(com.oudmon.ble.base.bluetooth.spp.jieli.SppHandle.this.mReceivedData, 1, 2));
                if (com.oudmon.ble.base.communication.utils.ByteUtil.bytesToInt(java.util.Arrays.copyOfRange(com.oudmon.ble.base.bluetooth.spp.jieli.SppHandle.this.mReceivedData, 2, 3)) == 0) {
                    com.oudmon.ble.base.bluetooth.spp.jieli.SppHandle.this.fileNames = new java.util.ArrayList();
                }
                com.iwown.awlog.AwLog.i(com.iwown.awlog.Author.HeZhiYuan, java.lang.Integer.valueOf(bytesToInt4));
                if (bytesToInt4 > 0) {
                    int bytesToInt5 = com.oudmon.ble.base.communication.utils.ByteUtil.bytesToInt(java.util.Arrays.copyOfRange(com.oudmon.ble.base.bluetooth.spp.jieli.SppHandle.this.mReceivedData, 4, 5));
                    com.oudmon.ble.base.bluetooth.spp.jieli.SppHandle sppHandle5 = com.oudmon.ble.base.bluetooth.spp.jieli.SppHandle.this;
                    sppHandle5.parseEbookData(sppHandle5.mReceivedData, 5, bytesToInt5, bytesToInt4, 0);
                    return;
                }
                com.oudmon.ble.base.bluetooth.spp.jieli.SppHandle.this.mCallback.onFileNames(com.oudmon.ble.base.bluetooth.spp.jieli.SppHandle.this.fileNames);
            }
        ...
        public void onSerialIoError(java.lang.Exception exc) {
            if (com.oudmon.ble.base.bluetooth.spp.jieli.SppHandle.this.outSerialListener != null) {
                com.oudmon.ble.base.bluetooth.spp.jieli.SppHandle.this.outSerialListener.onSerialIoError(exc);
            }
        }
    };
    private com.oudmon.ble.base.communication.file.IEbookCallback mCallback = new com.oudmon.ble.base.communication.file.IEbookCallback() { // from class: com.oudmon.ble.base.bluetooth.spp.jieli.SppHandle.2
        ...
        public void onFileNames(java.util.ArrayList<java.lang.String> arrayList) {
            java.util.Iterator it = com.oudmon.ble.base.bluetooth.spp.jieli.SppHandle.this.mCallbackArray.iterator();
            while (it.hasNext()) {
    ...
    private com.oudmon.ble.base.bluetooth.OnGattEventCallback callback = new com.oudmon.ble.base.bluetooth.OnGattEventCallback() { // from class: com.oudmon.ble.base.bluetooth.spp.jieli.SppHandle.3
            ...
            if (bArr != null) {
                ...
                if ((bArr[0] & 255) != 188 || bArr[1] != Byte.MIN_VALUE) {
                    if (com.oudmon.ble.base.bluetooth.spp.jieli.SppHandle.this.mReceiving) {
                        ...
                        com.oudmon.ble.base.bluetooth.spp.jieli.SppHandle sppHandle = com.oudmon.ble.base.bluetooth.spp.jieli.SppHandle.this;
                        sppHandle.mReceiving = sppHandle.mReceivedCount < com.oudmon.ble.base.bluetooth.spp.jieli.SppHandle.this.mTotalCount;
                        com.iwown.awlog.AwLog.i(com.iwown.awlog.Author.HeZhiYuan, "文件：->3 mTotalCount: " + com.oudmon.ble.base.bluetooth.spp.jieli.SppHandle.this.mTotalCount + ", mReceivedCount: " + com.oudmon.ble.base.bluetooth.spp.jieli.SppHandle.this.mReceivedCount + ", mReceiving: " + com.oudmon.ble.base.bluetooth.spp.jieli.SppHandle.this.mReceiving);
                        if (com.oudmon.ble.base.bluetooth.spp.jieli.SppHandle.this.mReceiving) {
                            return;
                        }
                        com.iwown.awlog.AwLog.i(com.iwown.awlog.Author.HeZhiYuan, "文件：->4 ->" + com.qcwireless.qc_utils.bytes.DataTransferUtils.getHexString(com.oudmon.ble.base.bluetooth.spp.jieli.SppHandle.this.mReceivedData));
                        int bytesToInt2 = com.oudmon.ble.base.communication.utils.ByteUtil.bytesToInt(java.util.Arrays.copyOfRange(com.oudmon.ble.base.bluetooth.spp.jieli.SppHandle.this.mReceivedData, 1, 2));
                        if (com.oudmon.ble.base.communication.utils.ByteUtil.bytesToInt(java.util.Arrays.copyOfRange(com.oudmon.ble.base.bluetooth.spp.jieli.SppHandle.this.mReceivedData, 2, 3)) == 0) {
                            com.oudmon.ble.base.bluetooth.spp.jieli.SppHandle.this.fileNames = new java.util.ArrayList();
                        }
                ...
                com.oudmon.ble.base.bluetooth.spp.jieli.SppHandle sppHandle4 = com.oudmon.ble.base.bluetooth.spp.jieli.SppHandle.this;
                sppHandle4.mReceiving = sppHandle4.mReceivedCount < com.oudmon.ble.base.bluetooth.spp.jieli.SppHandle.this.mTotalCount;
                com.iwown.awlog.AwLog.i(com.iwown.awlog.Author.HeZhiYuan, "文件：-> 1mTotalCount: " + com.oudmon.ble.base.bluetooth.spp.jieli.SppHandle.this.mTotalCount + ", mReceivedCount: " + com.oudmon.ble.base.bluetooth.spp.jieli.SppHandle.this.mReceivedCount + ", mReceiving: " + com.oudmon.ble.base.bluetooth.spp.jieli.SppHandle.this.mReceiving);
                if (com.oudmon.ble.base.bluetooth.spp.jieli.SppHandle.this.mReceiving) {
                    return;
                }
                com.iwown.awlog.AwLog.i(com.iwown.awlog.Author.HeZhiYuan, "文件：->2->" + com.qcwireless.qc_utils.bytes.DataTransferUtils.getHexString(com.oudmon.ble.base.bluetooth.spp.jieli.SppHandle.this.mReceivedData));
                int bytesToInt4 = com.oudmon.ble.base.communication.utils.ByteUtil.bytesToInt(java.util.Arrays.copyOfRange(com.oudmon.ble.base.bluetooth.spp.jieli.SppHandle.this.mReceivedData, 1, 2));
                if (com.oudmon.ble.base.communication.utils.ByteUtil.bytesToInt(java.util.Arrays.copyOfRange(com.oudmon.ble.base.bluetooth.spp.jieli.SppHandle.this.mReceivedData, 2, 3)) == 0) {
                    com.oudmon.ble.base.bluetooth.spp.jieli.SppHandle.this.fileNames = new java.util.ArrayList();
                }
    ...
    static /* synthetic */ int access$812(com.oudmon.ble.base.bluetooth.spp.jieli.SppHandle sppHandle, int i) {
    ...
    public static com.oudmon.ble.base.bluetooth.spp.jieli.SppHandle getInstance() {
        if (mInstance == null) {
            synchronized (com.oudmon.ble.base.bluetooth.spp.jieli.SppHandle.class) {
                if (mInstance == null) {
                    mInstance = new com.oudmon.ble.base.bluetooth.spp.jieli.SppHandle();
                }
            }
        }
        return mInstance;
    ...
    public void cleanSppListener() {
        com.oudmon.ble.base.bluetooth.spp.SerialSocket.getInstance().setListener(null);
        ...
        try {
            ...
            if (i2 < i3) {
                if (this.mFileSend.length > 0) {
                    int min = java.lang.Math.min(i, i3 - (s * i));
                    byte[] bArr = new byte[min];
                    java.lang.System.arraycopy(this.mFileSend, this.mPocketIndex * LongBagLength, bArr, 0, min);
                ...
                int i5 = this.sizeA;
                if (i4 < i5) {
                    int min2 = java.lang.Math.min(com.realsil.sdk.bbpro.equalizer.EqConstants.CodeIndex.REALTIME_EQ_2, i5 - (s2 * 1024));
