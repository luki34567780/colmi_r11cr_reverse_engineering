...
public class SppHandleBackup {
    ...
    private static com.oudmon.ble.base.bluetooth.spp.jieli.SppHandleBackup mInstance;
    ...
    private int sizeA = 1;
    private int sizeB = 1;
    private com.oudmon.ble.base.bluetooth.spp.SerialListener serialListener = new com.oudmon.ble.base.bluetooth.spp.SerialListener() { // from class: com.oudmon.ble.base.bluetooth.spp.jieli.SppHandleBackup.1
        ...
        public void onSerialConnect() {
            if (com.oudmon.ble.base.bluetooth.spp.jieli.SppHandleBackup.this.outSerialListener != null) {
                com.oudmon.ble.base.bluetooth.spp.jieli.SppHandleBackup.this.outSerialListener.onSerialConnect();
            }
        }
        ...
        public void onSerialConnectError(java.lang.Exception exc) {
            if (com.oudmon.ble.base.bluetooth.spp.jieli.SppHandleBackup.this.outSerialListener != null) {
                com.oudmon.ble.base.bluetooth.spp.jieli.SppHandleBackup.this.outSerialListener.onSerialConnectError(exc);
            }
        }
        ...
        public void onSerialRead(byte[] bArr) {
            if (bArr != null) {
                if ((bArr[0] & 255) == 188 && bArr[1] == 49) {
                    ...
                    com.oudmon.ble.base.bluetooth.spp.jieli.SppHandleBackup.this.cmdSendPacket();
                    return;
                }
                if ((bArr[0] & 255) == 188 && bArr[1] == 50) {
                    ...
                    if (bytesToInt == 0) {
                        if (com.oudmon.ble.base.bluetooth.spp.jieli.SppHandleBackup.this.readNextBigPocket()) {
                            float parseFloat = java.lang.Float.parseFloat(new java.text.DecimalFormat("#.00", new java.text.DecimalFormatSymbols(java.util.Locale.US)).format((((com.oudmon.ble.base.bluetooth.spp.jieli.SppHandleBackup.this.mPocketIndex * 1024) * 1.0f) * 100.0f) / com.oudmon.ble.base.bluetooth.spp.jieli.SppHandleBackup.this.totalSize));
                            com.iwown.awlog.AwLog.i(com.iwown.awlog.Author.HeZhiYuan, "向手环发送数据进度: " + parseFloat + ", 包序: " + ((int) com.oudmon.ble.base.bluetooth.spp.jieli.SppHandleBackup.this.mPocketIndex) + "总包:" + com.oudmon.ble.base.bluetooth.spp.jieli.SppHandleBackup.this.totalSize);
                            com.oudmon.ble.base.bluetooth.spp.jieli.SppHandleBackup.this.mCallback.onProgress(java.lang.Math.min(parseFloat, 100.0f));
                            return;
                        }
                        com.iwown.awlog.AwLog.i(com.iwown.awlog.Author.HeZhiYuan, "向手环发送数据完毕, 包序: " + ((int) com.oudmon.ble.base.bluetooth.spp.jieli.SppHandleBackup.this.mPocketIndex));
                        com.oudmon.ble.base.bluetooth.spp.jieli.SppHandleBackup.this.cmdCheck();
                        return;
                    }
                    com.oudmon.ble.base.bluetooth.spp.jieli.SppHandleBackup.this.mCallback.onDeleteSuccess(bytesToInt);
                    return;
                }
                if ((bArr[0] & 255) == 188 && bArr[1] == 51) {
                    com.iwown.awlog.AwLog.i(com.iwown.awlog.Author.HeZhiYuan, "===============回调 onComplete");
                    com.oudmon.ble.base.bluetooth.spp.jieli.SppHandleBackup.this.mFileSend = new byte[0];
                    com.oudmon.ble.base.bluetooth.spp.jieli.SppHandleBackup.this.mCallback.onComplete();
                    return;
                }
                if ((bArr[0] & 255) != 188 || bArr[1] != Byte.MIN_VALUE) {
                    if (com.oudmon.ble.base.bluetooth.spp.jieli.SppHandleBackup.this.mReceiving) {
                        java.lang.System.arraycopy(bArr, 0, com.oudmon.ble.base.bluetooth.spp.jieli.SppHandleBackup.this.mReceivedData, com.oudmon.ble.base.bluetooth.spp.jieli.SppHandleBackup.this.mReceivedCount, bArr.length);
                        com.oudmon.ble.base.bluetooth.spp.jieli.SppHandleBackup.access$812(com.oudmon.ble.base.bluetooth.spp.jieli.SppHandleBackup.this, bArr.length);
                        com.oudmon.ble.base.bluetooth.spp.jieli.SppHandleBackup sppHandleBackup = com.oudmon.ble.base.bluetooth.spp.jieli.SppHandleBackup.this;
                        sppHandleBackup.mReceiving = sppHandleBackup.mReceivedCount < com.oudmon.ble.base.bluetooth.spp.jieli.SppHandleBackup.this.mTotalCount;
                        if (com.oudmon.ble.base.bluetooth.spp.jieli.SppHandleBackup.this.mReceiving) {
                            return;
                        }
                        int bytesToInt2 = com.oudmon.ble.base.communication.utils.ByteUtil.bytesToInt(java.util.Arrays.copyOfRange(com.oudmon.ble.base.bluetooth.spp.jieli.SppHandleBackup.this.mReceivedData, 1, 2));
                        if (com.oudmon.ble.base.communication.utils.ByteUtil.bytesToInt(java.util.Arrays.copyOfRange(com.oudmon.ble.base.bluetooth.spp.jieli.SppHandleBackup.this.mReceivedData, 2, 3)) == 0) {
                            com.oudmon.ble.base.bluetooth.spp.jieli.SppHandleBackup.this.fileNames = new java.util.ArrayList();
                        }
                        com.iwown.awlog.AwLog.i(com.iwown.awlog.Author.HeZhiYuan, java.lang.Integer.valueOf(bytesToInt2));
                        if (bytesToInt2 > 0) {
                            int bytesToInt3 = com.oudmon.ble.base.communication.utils.ByteUtil.bytesToInt(java.util.Arrays.copyOfRange(com.oudmon.ble.base.bluetooth.spp.jieli.SppHandleBackup.this.mReceivedData, 4, 5));
                            com.oudmon.ble.base.bluetooth.spp.jieli.SppHandleBackup sppHandleBackup2 = com.oudmon.ble.base.bluetooth.spp.jieli.SppHandleBackup.this;
                            sppHandleBackup2.parseEbookData(sppHandleBackup2.mReceivedData, 5, bytesToInt3, bytesToInt2, 0);
                            return;
                        }
                        com.oudmon.ble.base.bluetooth.spp.jieli.SppHandleBackup.this.mCallback.onFileNames(com.oudmon.ble.base.bluetooth.spp.jieli.SppHandleBackup.this.fileNames);
                        return;
                    }
                    if ((bArr[0] & 255) == 188 && bArr[1] == -127) {
                        com.oudmon.ble.base.bluetooth.spp.jieli.SppHandleBackup.this.mCallback.onDeleteSuccess(com.oudmon.ble.base.communication.utils.ByteUtil.bytesToInt(java.util.Arrays.copyOfRange(bArr, 6, 7)));
                        return;
                    }
                    return;
                }
                com.oudmon.ble.base.bluetooth.spp.jieli.SppHandleBackup.this.mTotalCount = com.qcwireless.qc_utils.bytes.DataTransferUtils.bytesToShort(bArr, 2);
                com.oudmon.ble.base.bluetooth.spp.jieli.SppHandleBackup.this.mReceivedCount = bArr.length - 6;
                com.oudmon.ble.base.bluetooth.spp.jieli.SppHandleBackup sppHandleBackup3 = com.oudmon.ble.base.bluetooth.spp.jieli.SppHandleBackup.this;
                sppHandleBackup3.mReceivedData = new byte[sppHandleBackup3.mTotalCount];
                java.lang.System.arraycopy(bArr, 6, com.oudmon.ble.base.bluetooth.spp.jieli.SppHandleBackup.this.mReceivedData, 0, com.oudmon.ble.base.bluetooth.spp.jieli.SppHandleBackup.this.mReceivedCount);
                com.oudmon.ble.base.bluetooth.spp.jieli.SppHandleBackup sppHandleBackup4 = com.oudmon.ble.base.bluetooth.spp.jieli.SppHandleBackup.this;
                sppHandleBackup4.mReceiving = sppHandleBackup4.mReceivedCount < com.oudmon.ble.base.bluetooth.spp.jieli.SppHandleBackup.this.mTotalCount;
                if (com.oudmon.ble.base.bluetooth.spp.jieli.SppHandleBackup.this.mReceiving) {
                    return;
                }
                int bytesToInt4 = com.oudmon.ble.base.communication.utils.ByteUtil.bytesToInt(java.util.Arrays.copyOfRange(com.oudmon.ble.base.bluetooth.spp.jieli.SppHandleBackup.this.mReceivedData, 1, 2));
                if (com.oudmon.ble.base.communication.utils.ByteUtil.bytesToInt(java.util.Arrays.copyOfRange(com.oudmon.ble.base.bluetooth.spp.jieli.SppHandleBackup.this.mReceivedData, 2, 3)) == 0) {
                    com.oudmon.ble.base.bluetooth.spp.jieli.SppHandleBackup.this.fileNames = new java.util.ArrayList();
                }
                com.iwown.awlog.AwLog.i(com.iwown.awlog.Author.HeZhiYuan, java.lang.Integer.valueOf(bytesToInt4));
                if (bytesToInt4 > 0) {
                    int bytesToInt5 = com.oudmon.ble.base.communication.utils.ByteUtil.bytesToInt(java.util.Arrays.copyOfRange(com.oudmon.ble.base.bluetooth.spp.jieli.SppHandleBackup.this.mReceivedData, 4, 5));
                    com.oudmon.ble.base.bluetooth.spp.jieli.SppHandleBackup sppHandleBackup5 = com.oudmon.ble.base.bluetooth.spp.jieli.SppHandleBackup.this;
                    sppHandleBackup5.parseEbookData(sppHandleBackup5.mReceivedData, 5, bytesToInt5, bytesToInt4, 0);
                    return;
                }
                com.oudmon.ble.base.bluetooth.spp.jieli.SppHandleBackup.this.mCallback.onFileNames(com.oudmon.ble.base.bluetooth.spp.jieli.SppHandleBackup.this.fileNames);
            }
        ...
        public void onSerialIoError(java.lang.Exception exc) {
            if (com.oudmon.ble.base.bluetooth.spp.jieli.SppHandleBackup.this.outSerialListener != null) {
                com.oudmon.ble.base.bluetooth.spp.jieli.SppHandleBackup.this.outSerialListener.onSerialIoError(exc);
            }
        }
    };
    private com.oudmon.ble.base.communication.file.IEbookCallback mCallback = new com.oudmon.ble.base.communication.file.IEbookCallback() { // from class: com.oudmon.ble.base.bluetooth.spp.jieli.SppHandleBackup.2
        ...
        public void onFileNames(java.util.ArrayList<java.lang.String> arrayList) {
            java.util.Iterator it = com.oudmon.ble.base.bluetooth.spp.jieli.SppHandleBackup.this.mCallbackArray.iterator();
            while (it.hasNext()) {
    ...
    private com.oudmon.ble.base.bluetooth.OnGattEventCallback callback = new com.oudmon.ble.base.bluetooth.OnGattEventCallback() { // from class: com.oudmon.ble.base.bluetooth.spp.jieli.SppHandleBackup.3
            ...
            if (bArr != null) {
                ...
                if ((bArr[0] & 255) != 188 || bArr[1] != Byte.MIN_VALUE) {
                    if (com.oudmon.ble.base.bluetooth.spp.jieli.SppHandleBackup.this.mReceiving) {
                        ...
                        com.oudmon.ble.base.bluetooth.spp.jieli.SppHandleBackup sppHandleBackup = com.oudmon.ble.base.bluetooth.spp.jieli.SppHandleBackup.this;
                        sppHandleBackup.mReceiving = sppHandleBackup.mReceivedCount < com.oudmon.ble.base.bluetooth.spp.jieli.SppHandleBackup.this.mTotalCount;
                        com.iwown.awlog.AwLog.i(com.iwown.awlog.Author.HeZhiYuan, "文件：->3 mTotalCount: " + com.oudmon.ble.base.bluetooth.spp.jieli.SppHandleBackup.this.mTotalCount + ", mReceivedCount: " + com.oudmon.ble.base.bluetooth.spp.jieli.SppHandleBackup.this.mReceivedCount + ", mReceiving: " + com.oudmon.ble.base.bluetooth.spp.jieli.SppHandleBackup.this.mReceiving);
                        if (com.oudmon.ble.base.bluetooth.spp.jieli.SppHandleBackup.this.mReceiving) {
                            return;
                        }
                        com.iwown.awlog.AwLog.i(com.iwown.awlog.Author.HeZhiYuan, "文件：->4 ->" + com.qcwireless.qc_utils.bytes.DataTransferUtils.getHexString(com.oudmon.ble.base.bluetooth.spp.jieli.SppHandleBackup.this.mReceivedData));
                        int bytesToInt2 = com.oudmon.ble.base.communication.utils.ByteUtil.bytesToInt(java.util.Arrays.copyOfRange(com.oudmon.ble.base.bluetooth.spp.jieli.SppHandleBackup.this.mReceivedData, 1, 2));
                        if (com.oudmon.ble.base.communication.utils.ByteUtil.bytesToInt(java.util.Arrays.copyOfRange(com.oudmon.ble.base.bluetooth.spp.jieli.SppHandleBackup.this.mReceivedData, 2, 3)) == 0) {
                            com.oudmon.ble.base.bluetooth.spp.jieli.SppHandleBackup.this.fileNames = new java.util.ArrayList();
                        }
                ...
                com.oudmon.ble.base.bluetooth.spp.jieli.SppHandleBackup sppHandleBackup4 = com.oudmon.ble.base.bluetooth.spp.jieli.SppHandleBackup.this;
                sppHandleBackup4.mReceiving = sppHandleBackup4.mReceivedCount < com.oudmon.ble.base.bluetooth.spp.jieli.SppHandleBackup.this.mTotalCount;
                com.iwown.awlog.AwLog.i(com.iwown.awlog.Author.HeZhiYuan, "文件：-> 1mTotalCount: " + com.oudmon.ble.base.bluetooth.spp.jieli.SppHandleBackup.this.mTotalCount + ", mReceivedCount: " + com.oudmon.ble.base.bluetooth.spp.jieli.SppHandleBackup.this.mReceivedCount + ", mReceiving: " + com.oudmon.ble.base.bluetooth.spp.jieli.SppHandleBackup.this.mReceiving);
                if (com.oudmon.ble.base.bluetooth.spp.jieli.SppHandleBackup.this.mReceiving) {
                    return;
                }
                com.iwown.awlog.AwLog.i(com.iwown.awlog.Author.HeZhiYuan, "文件：->2->" + com.qcwireless.qc_utils.bytes.DataTransferUtils.getHexString(com.oudmon.ble.base.bluetooth.spp.jieli.SppHandleBackup.this.mReceivedData));
                int bytesToInt4 = com.oudmon.ble.base.communication.utils.ByteUtil.bytesToInt(java.util.Arrays.copyOfRange(com.oudmon.ble.base.bluetooth.spp.jieli.SppHandleBackup.this.mReceivedData, 1, 2));
                if (com.oudmon.ble.base.communication.utils.ByteUtil.bytesToInt(java.util.Arrays.copyOfRange(com.oudmon.ble.base.bluetooth.spp.jieli.SppHandleBackup.this.mReceivedData, 2, 3)) == 0) {
                    com.oudmon.ble.base.bluetooth.spp.jieli.SppHandleBackup.this.fileNames = new java.util.ArrayList();
                }
    ...
    static /* synthetic */ int access$812(com.oudmon.ble.base.bluetooth.spp.jieli.SppHandleBackup sppHandleBackup, int i) {
    ...
    public static com.oudmon.ble.base.bluetooth.spp.jieli.SppHandleBackup getInstance() {
        if (mInstance == null) {
            synchronized (com.oudmon.ble.base.bluetooth.spp.jieli.SppHandleBackup.class) {
                if (mInstance == null) {
                    mInstance = new com.oudmon.ble.base.bluetooth.spp.jieli.SppHandleBackup();
                }
            }
        }
        return mInstance;
    ...
    public void connect(android.bluetooth.BluetoothDevice bluetoothDevice) {
        com.oudmon.ble.base.bluetooth.spp.SerialSocket.getInstance().setDevice(bluetoothDevice);
        com.oudmon.ble.base.bluetooth.spp.SerialSocket.getInstance().connect(this.serialListener);
    }

    public void disconnect() {
        com.oudmon.ble.base.bluetooth.spp.SerialSocket.getInstance().disconnect();
    }

    public boolean isConnected() {
        return com.oudmon.ble.base.bluetooth.spp.SerialSocket.getInstance().isConnected();
    }
    ...
    public void start(int i) {
        com.oudmon.ble.base.bluetooth.spp.SerialSocket.getInstance().write(addHeader(com.realsil.sdk.bbpro.equalizer.EqConstants.CodeIndex.BUILD_IN_EQ_4, new byte[]{1, (byte) i}));
    }
    ...
    public void deleteMusic(int i, java.lang.String str) {
        try {
            ...
            com.oudmon.ble.base.bluetooth.spp.SerialSocket.getInstance().write(addHeader(129, com.oudmon.ble.base.communication.utils.ByteUtil.concat(new byte[]{1, (byte) i, (byte) bytes.length}, bytes)));
        } catch (java.lang.Exception e) {
            e.printStackTrace();
        }
    }
    ...
    /* JADX WARN: Removed duplicated region for block: B:35:0x01b6 A[Catch: IOException -> 0x01d7, TRY_ENTER, TRY_LEAVE, TryCatch #0 {IOException -> 0x01d7, blocks: (B:35:0x01b6, B:98:0x01d3), top: B:10:0x002b }] */
    ...
    */
    public boolean executeFilePrepare(java.lang.String r14) {
        /*
    ...
    */
        ...
        try {
            if (this.mPocketIndex * 1024 < this.totalSize) {
                if (this.mFileSend.length > 0) {
                    com.iwown.awlog.AwLog.i(com.iwown.awlog.Author.HeZhiYuan, "next pkg");
                    int min = java.lang.Math.min(com.realsil.sdk.bbpro.equalizer.EqConstants.CodeIndex.REALTIME_EQ_2, this.totalSize - (this.mPocketIndex * 1024));
                ...
                int i2 = this.sizeA;
                if (i < i2) {
                    int min2 = java.lang.Math.min(com.realsil.sdk.bbpro.equalizer.EqConstants.CodeIndex.REALTIME_EQ_2, i2 - (s * 1024));
    ...
    private void sendPocketToBle(byte[] bArr) {
        ...
        for (int i = 0; this.mPackageLength * i < bArr.length; i++) {
            com.oudmon.ble.base.bluetooth.spp.SerialSocket serialSocket = com.oudmon.ble.base.bluetooth.spp.SerialSocket.getInstance();
            int i2 = this.mPackageLength;
            serialSocket.write(java.util.Arrays.copyOfRange(bArr, i * i2, (i * i2) + java.lang.Math.min(i2, bArr.length - (i * i2))));
        }
    }
    ...
    public void cmdCheck() {
        com.oudmon.ble.base.bluetooth.spp.SerialSocket.getInstance().write(addHeader(51, null));
    }
