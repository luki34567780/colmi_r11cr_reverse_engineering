...
public class AlbumHandle {
    ...
    private static com.oudmon.ble.base.communication.file.AlbumHandle mInstance;
    ...
    private com.oudmon.ble.base.communication.file.IEbookCallback mCallback = new com.oudmon.ble.base.communication.file.IEbookCallback() { // from class: com.oudmon.ble.base.communication.file.AlbumHandle.2
        ...
        public void onFileNames(java.util.ArrayList<java.lang.String> arrayList) {
            java.util.Iterator it = com.oudmon.ble.base.communication.file.AlbumHandle.this.mCallbackArray.iterator();
            while (it.hasNext()) {
    ...
    private int sizeA = 1;
    private int sizeB = 1;
    private com.oudmon.ble.base.bluetooth.OnGattEventCallback callback = new com.oudmon.ble.base.bluetooth.OnGattEventCallback() { // from class: com.oudmon.ble.base.communication.file.AlbumHandle.3
        ...
        public void onReceivedData(java.lang.String str, byte[] bArr) {
            if (bArr != null) {
                if ((bArr[0] & 255) == 188 && bArr[1] == 49) {
                    ...
                    com.oudmon.ble.base.communication.file.AlbumHandle.this.cmdSendPacket();
                    return;
                }
                if ((bArr[0] & 255) == 188 && bArr[1] == 50) {
                    if (com.oudmon.ble.base.communication.file.AlbumHandle.this.readNextBigPocket()) {
                        float parseFloat = java.lang.Float.parseFloat(new java.text.DecimalFormat("#.00", new java.text.DecimalFormatSymbols(java.util.Locale.US)).format((((com.oudmon.ble.base.communication.file.AlbumHandle.this.mPocketIndex * 1024) * 1.0f) * 100.0f) / com.oudmon.ble.base.communication.file.AlbumHandle.this.totalSize));
                        com.iwown.awlog.AwLog.i(com.iwown.awlog.Author.HeZhiYuan, "向手环发送数据进度: " + parseFloat + ", 包序: " + ((int) com.oudmon.ble.base.communication.file.AlbumHandle.this.mPocketIndex) + "总包:" + com.oudmon.ble.base.communication.file.AlbumHandle.this.totalSize);
                        com.oudmon.ble.base.communication.file.AlbumHandle.this.mCallback.onProgress(java.lang.Math.min(parseFloat, 100.0f));
                        return;
                    }
                    com.iwown.awlog.AwLog.i(com.iwown.awlog.Author.HeZhiYuan, "向手环发送数据完毕, 包序: " + ((int) com.oudmon.ble.base.communication.file.AlbumHandle.this.mPocketIndex));
                    com.oudmon.ble.base.communication.file.AlbumHandle.this.cmdCheck();
                    return;
                }
                if ((bArr[0] & 255) == 188 && bArr[1] == 51) {
                    com.iwown.awlog.AwLog.i(com.iwown.awlog.Author.HeZhiYuan, "===============回调 onComplete");
                    com.oudmon.ble.base.communication.file.AlbumHandle.this.mCallback.onComplete();
                    com.oudmon.ble.base.communication.file.AlbumHandle.this.mFileSend = new byte[0];
                    return;
                }
                if ((bArr[0] & 255) == 188 && bArr[1] == Byte.MIN_VALUE) {
                    ...
                    if (com.oudmon.ble.base.communication.utils.ByteUtil.bytesToInt(java.util.Arrays.copyOfRange(bArr, 8, 9)) == 0) {
                        com.oudmon.ble.base.communication.file.AlbumHandle.this.fileNames = new java.util.ArrayList();
                    }
                    com.iwown.awlog.AwLog.i(com.iwown.awlog.Author.HeZhiYuan, java.lang.Integer.valueOf(bytesToInt));
                    if (bytesToInt <= 0) {
                        com.oudmon.ble.base.communication.file.AlbumHandle.this.mCallback.onFileNames(com.oudmon.ble.base.communication.file.AlbumHandle.this.fileNames);
                        return;
                    } else {
                        com.oudmon.ble.base.communication.file.AlbumHandle.this.parseEbookData(bArr, 11, com.oudmon.ble.base.communication.utils.ByteUtil.bytesToInt(java.util.Arrays.copyOfRange(bArr, 10, 11)), bytesToInt, 0);
                        return;
                    }
                }
                if ((bArr[0] & 255) == 188 && bArr[1] == -127) {
                    com.oudmon.ble.base.communication.file.AlbumHandle.this.mCallback.onDeleteSuccess(com.oudmon.ble.base.communication.utils.ByteUtil.bytesToInt(java.util.Arrays.copyOfRange(bArr, 6, 7)));
                }
            }
        }
    };
    ...
    public static com.oudmon.ble.base.communication.file.AlbumHandle getInstance() {
        if (mInstance == null) {
            synchronized (com.oudmon.ble.base.communication.file.AlbumHandle.class) {
                if (mInstance == null) {
                    mInstance = new com.oudmon.ble.base.communication.file.AlbumHandle();
                }
            }
        }
        return mInstance;
