...
public class BusStep implements android.os.Parcelable {
    public static final android.os.Parcelable.Creator<com.amap.api.services.route.BusStep> CREATOR = new android.os.Parcelable.Creator<com.amap.api.services.route.BusStep>() { // from class: com.amap.api.services.route.BusStep.1
