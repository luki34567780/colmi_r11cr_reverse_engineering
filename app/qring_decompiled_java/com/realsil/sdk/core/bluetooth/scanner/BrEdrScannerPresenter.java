...
public final class BrEdrScannerPresenter extends com.realsil.sdk.core.d.b {
    public BrEdrScannerPresenter(android.content.Context context) {
        super(context);
    }
    ...
    public BrEdrScannerPresenter(android.content.Context context, com.realsil.sdk.core.bluetooth.scanner.ScannerParams scannerParams, com.realsil.sdk.core.bluetooth.scanner.ScannerCallback scannerCallback) {
    ...
    public BrEdrScannerPresenter(android.content.Context context, android.os.Handler handler, com.realsil.sdk.core.bluetooth.scanner.ScannerParams scannerParams, com.realsil.sdk.core.bluetooth.scanner.ScannerCallback scannerCallback) {
