...
public final class GetAptPowerOnDelayTimeReq extends com.realsil.sdk.bbpro.profile.AppReq {

    public static class Builder {
        public com.realsil.sdk.bbpro.apt.GetAptPowerOnDelayTimeReq build() {
            return new com.realsil.sdk.bbpro.apt.GetAptPowerOnDelayTimeReq();
        }
    }
    ...
    public java.lang.String toString() {
        return java.lang.String.format("GetAptPowerOnDelayTimeReq(0x%04X) {", java.lang.Short.valueOf(getCommandId())) + "\n}";
    }
