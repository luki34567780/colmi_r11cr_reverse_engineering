...
public final class GetAptNrOnOffReq extends com.realsil.sdk.bbpro.profile.AppReq {

    public static class Builder {
        public com.realsil.sdk.bbpro.apt.GetAptNrOnOffReq build() {
            return new com.realsil.sdk.bbpro.apt.GetAptNrOnOffReq();
        }
    }
    ...
    public java.lang.String toString() {
        return java.lang.String.format("GetAptNrOnOffReq(0x%04X) {", java.lang.Short.valueOf(getCommandId())) + "\n}";
    }
