...
public final class SetLlAptScenarioChooseTryReq extends com.realsil.sdk.bbpro.profile.AppReq {
    ...
    public static class Builder {
        ...
        public com.realsil.sdk.bbpro.llapt.SetLlAptScenarioChooseTryReq build() {
            return new com.realsil.sdk.bbpro.llapt.SetLlAptScenarioChooseTryReq(this.a, this.b, this.c, this.d);
        }

        public com.realsil.sdk.bbpro.llapt.SetLlAptScenarioChooseTryReq.Builder lch(byte b, int i) {
            this.a = b;
            this.b = i;
            return this;
        }

        public com.realsil.sdk.bbpro.llapt.SetLlAptScenarioChooseTryReq.Builder rch(byte b, int i) {
            this.c = b;
            this.d = i;
            return this;
        }
    ...
    public java.lang.String toString() {
        return java.lang.String.format("SetLlAptScenarioChooseTryReq(0x%04X) {", java.lang.Short.valueOf(getCommandId())) + java.lang.String.format(java.util.Locale.US, "\n\tL=0x%02x-%d,R=0x%02x-%d)", java.lang.Byte.valueOf(this.a), java.lang.Integer.valueOf(this.b), java.lang.Byte.valueOf(this.c), java.lang.Integer.valueOf(this.d)) + "\n}";
    }
