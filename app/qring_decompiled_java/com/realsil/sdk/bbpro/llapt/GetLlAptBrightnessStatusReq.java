...
public final class GetLlAptBrightnessStatusReq extends com.realsil.sdk.bbpro.profile.AppReq {

    public static class Builder {
        public com.realsil.sdk.bbpro.llapt.GetLlAptBrightnessStatusReq build() {
            return new com.realsil.sdk.bbpro.llapt.GetLlAptBrightnessStatusReq();
        }
    }
    ...
    public java.lang.String toString() {
        return java.lang.String.format("GetLlAptBrightnessStatusReq(0x%04X) {", java.lang.Short.valueOf(getCommandId())) + "\n}";
    }
