...
public class GradientColorParser implements com.airbnb.lottie.parser.ValueParser<com.airbnb.lottie.model.content.GradientColor> {
    ...
    private void addOpacityStopsToGradientIfNeeded(com.airbnb.lottie.model.content.GradientColor gradientColor, java.util.List<java.lang.Float> list) {
        ...
        for (int i3 = 0; i3 < gradientColor.getSize(); i3++) {
            ...
            gradientColor.getColors()[i3] = android.graphics.Color.argb(getOpacityAtPosition(gradientColor.getPositions()[i3], dArr, dArr2), android.graphics.Color.red(i4), android.graphics.Color.green(i4), android.graphics.Color.blue(i4));
        }
    }
