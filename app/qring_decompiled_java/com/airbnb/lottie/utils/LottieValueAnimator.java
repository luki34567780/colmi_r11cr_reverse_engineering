...
public class LottieValueAnimator extends com.airbnb.lottie.utils.BaseLottieAnimator implements android.view.Choreographer.FrameCallback {
    private com.airbnb.lottie.LottieComposition composition;
    ...
    public void doFrame(long j) {
        ...
        this.frame = f2;
        boolean z = !com.airbnb.lottie.utils.MiscUtils.contains(f2, getMinFrame(), getMaxFrame());
        this.frame = com.airbnb.lottie.utils.MiscUtils.clamp(this.frame, getMinFrame(), getMaxFrame());
    ...
    private float getFrameDurationNs() {
        ...
        return (1.0E9f / lottieComposition.getFrameRate()) / java.lang.Math.abs(this.speed);
    }
    ...
    public void setComposition(com.airbnb.lottie.LottieComposition lottieComposition) {
        ...
        if (z) {
            setMinAndMaxFrames((int) java.lang.Math.max(this.minFrame, lottieComposition.getStartFrame()), (int) java.lang.Math.min(this.maxFrame, lottieComposition.getEndFrame()));
        } else {
    ...
    public void setFrame(float f) {
        ...
        this.frame = com.airbnb.lottie.utils.MiscUtils.clamp(f, getMinFrame(), getMaxFrame());
    ...
    public void setMinAndMaxFrames(float f, float f2) {
        ...
        com.airbnb.lottie.LottieComposition lottieComposition2 = this.composition;
        float endFrame = lottieComposition2 == null ? Float.MAX_VALUE : lottieComposition2.getEndFrame();
        this.minFrame = com.airbnb.lottie.utils.MiscUtils.clamp(f, startFrame, endFrame);
        this.maxFrame = com.airbnb.lottie.utils.MiscUtils.clamp(f2, startFrame, endFrame);
        setFrame((int) com.airbnb.lottie.utils.MiscUtils.clamp(this.frame, f, f2));
    }
    ...
    private void verifyFrame() {
        ...
        if (f < this.minFrame || f > this.maxFrame) {
            throw new java.lang.IllegalStateException(java.lang.String.format("Frame must be [%f,%f]. It is %f", java.lang.Float.valueOf(this.minFrame), java.lang.Float.valueOf(this.maxFrame), java.lang.Float.valueOf(this.frame)));
        }
    }
}
