...
public class StandardGifDecoder implements com.bumptech.glide.gifdecoder.GifDecoder {
    ...
    public StandardGifDecoder(com.bumptech.glide.gifdecoder.GifDecoder.BitmapProvider bitmapProvider, com.bumptech.glide.gifdecoder.GifHeader gifHeader, java.nio.ByteBuffer byteBuffer) {
        this(bitmapProvider, gifHeader, byteBuffer, 1);
    }

    public StandardGifDecoder(com.bumptech.glide.gifdecoder.GifDecoder.BitmapProvider bitmapProvider, com.bumptech.glide.gifdecoder.GifHeader gifHeader, java.nio.ByteBuffer byteBuffer, int i) {
        this(bitmapProvider);
        setData(gifHeader, byteBuffer, i);
    }

    public StandardGifDecoder(com.bumptech.glide.gifdecoder.GifDecoder.BitmapProvider bitmapProvider) {
    ...
    public synchronized android.graphics.Bitmap getNextFrame() {
        if (this.header.frameCount <= 0 || this.framePointer < 0) {
            ...
            if (android.util.Log.isLoggable(str, 3)) {
                android.util.Log.d(str, "Unable to decode frame, frameCount=" + this.header.frameCount + ", framePointer=" + this.framePointer);
            }
            this.status = 1;
        }
        int i = this.status;
        if (i != 1 && i != 2) {
            ...
            if (iArr == null) {
                ...
                if (android.util.Log.isLoggable(str2, 3)) {
                    android.util.Log.d(str2, "No valid color table found for frame #" + this.framePointer);
                }
                this.status = 1;
                return null;
            }
            if (gifFrame.transparency) {
                int[] iArr2 = this.act;
                java.lang.System.arraycopy(iArr2, 0, this.pct, 0, iArr2.length);
                int[] iArr3 = this.pct;
                this.act = iArr3;
        ...
        if (android.util.Log.isLoggable(str3, 3)) {
            android.util.Log.d(str3, "Unable to decode frame, status=" + this.status);
        }
        return null;
    }
    ...
    public int read(java.io.InputStream inputStream, int i) {
        ...
        if (inputStream != null) {
            try {
                ...
                android.util.Log.w(TAG, "Error closing stream", e2);
            }
        }
        return this.status;
    }
    ...
    @Override // com.bumptech.glide.gifdecoder.GifDecoder
    public synchronized void setData(com.bumptech.glide.gifdecoder.GifHeader gifHeader, byte[] bArr) {
        setData(gifHeader, java.nio.ByteBuffer.wrap(bArr));
    }

    @Override // com.bumptech.glide.gifdecoder.GifDecoder
    public synchronized void setData(com.bumptech.glide.gifdecoder.GifHeader gifHeader, java.nio.ByteBuffer byteBuffer) {
        setData(gifHeader, byteBuffer, 1);
    }

    @Override // com.bumptech.glide.gifdecoder.GifDecoder
    public synchronized void setData(com.bumptech.glide.gifdecoder.GifHeader gifHeader, java.nio.ByteBuffer byteBuffer, int i) {
        if (i <= 0) {
    ...
    private void decodeBitmapData(com.bumptech.glide.gifdecoder.GifFrame gifFrame) {
        ...
        java.util.Arrays.fill(bArr2, i16, i, (byte) 0);
    }
