...
public final class MemorySizeCalculator {
    ...
    MemorySizeCalculator(com.bumptech.glide.load.engine.cache.MemorySizeCalculator.Builder builder) {
        ...
        if (i3 <= i2) {
            ...
            this.memoryCacheSize = java.lang.Math.round(builder.memoryCacheScreens * f);
            this.bitmapPoolSize = java.lang.Math.round(f * builder.bitmapPoolScreens);
        }
    ...
    static boolean isLowMemoryDevice(android.app.ActivityManager activityManager) {
    ...
    public static final class Builder {
        ...
        com.bumptech.glide.load.engine.cache.MemorySizeCalculator.Builder setActivityManager(android.app.ActivityManager activityManager) {
            this.activityManager = activityManager;
            return this;
        }

        com.bumptech.glide.load.engine.cache.MemorySizeCalculator.Builder setScreenDimensions(com.bumptech.glide.load.engine.cache.MemorySizeCalculator.ScreenDimensions screenDimensions) {
    ...
    private static final class DisplayMetricsScreenDimensions implements com.bumptech.glide.load.engine.cache.MemorySizeCalculator.ScreenDimensions {
        private final android.util.DisplayMetrics displayMetrics;

        DisplayMetricsScreenDimensions(android.util.DisplayMetrics displayMetrics) {
