...
public final class DefaultImageHeaderParser implements com.bumptech.glide.load.ImageHeaderParser {
    ...
    public com.bumptech.glide.load.ImageHeaderParser.ImageType getType(java.io.InputStream inputStream) throws java.io.IOException {
    ...
    public com.bumptech.glide.load.ImageHeaderParser.ImageType getType(java.nio.ByteBuffer byteBuffer) throws java.io.IOException {
    ...
    private static final class ByteBufferReader implements com.bumptech.glide.load.resource.bitmap.DefaultImageHeaderParser.Reader {
    ...
    private static final class StreamReader implements com.bumptech.glide.load.resource.bitmap.DefaultImageHeaderParser.Reader {
