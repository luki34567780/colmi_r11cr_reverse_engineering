...
public class FitCenter extends com.bumptech.glide.load.resource.bitmap.BitmapTransformation {
    ...
    protected android.graphics.Bitmap transform(com.bumptech.glide.load.engine.bitmap_recycle.BitmapPool bitmapPool, android.graphics.Bitmap bitmap, int i, int i2) {
        return com.bumptech.glide.load.resource.bitmap.TransformationUtils.fitCenter(bitmapPool, bitmap, i, i2);
    }

    public boolean equals(java.lang.Object obj) {
        return obj instanceof com.bumptech.glide.load.resource.bitmap.FitCenter;
    }
