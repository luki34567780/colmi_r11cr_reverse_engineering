...
public final class Utf8 {
    ...
    public static final boolean isUtf8Continuation(byte b) {
        return (b & com.realsil.sdk.bbpro.params.Mmi.AU_MMI_SD_PLAYBACK_SWITCH) == 128;
    }
    ...
    public static final long size(java.lang.String str, int i, int i2) {
        ...
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(str, "<this>");
        if (!(i >= 0)) {
            throw new java.lang.IllegalArgumentException(kotlin.jvm.internal.Intrinsics.stringPlus("beginIndex < 0: ", java.lang.Integer.valueOf(i)).toString());
        }
        if (!(i2 >= i)) {
    ...
    public static final void processUtf8Bytes(java.lang.String str, int i, int i2, kotlin.jvm.functions.Function1<? super java.lang.Byte, kotlin.Unit> yield) {
        ...
        while (i < i2) {
            ...
            if (kotlin.jvm.internal.Intrinsics.compare((int) charAt, 128) < 0) {
                yield.invoke(java.lang.Byte.valueOf((byte) charAt));
                i++;
                ...
                if (kotlin.jvm.internal.Intrinsics.compare((int) charAt, 2048) < 0) {
                    yield.invoke(java.lang.Byte.valueOf((byte) ((charAt >> 6) | 192)));
                    yield.invoke(java.lang.Byte.valueOf((byte) ((charAt & '?') | 128)));
                } else {
                    boolean z = false;
                    if (!(55296 <= charAt && charAt <= 57343)) {
                        yield.invoke(java.lang.Byte.valueOf((byte) ((charAt >> '\f') | 224)));
                        yield.invoke(java.lang.Byte.valueOf((byte) (((charAt >> 6) & 63) | 128)));
                        yield.invoke(java.lang.Byte.valueOf((byte) ((charAt & '?') | 128)));
                    } else {
                        if (kotlin.jvm.internal.Intrinsics.compare((int) charAt, 56319) <= 0 && i2 > (i3 = i + 1)) {
                            ...
                            if (z) {
                                ...
                                yield.invoke(java.lang.Byte.valueOf((byte) ((charAt3 >> 18) | com.autonavi.amap.mapcore.tools.GlMapUtil.DEVICE_DISPLAY_DPI_MEDIAN)));
    ...
    /* JADX WARN: Code restructure failed: missing block: B:34:0x011b, code lost:
        ...
        if (((r16[r4] & com.realsil.sdk.bbpro.params.Mmi.AU_MMI_SD_PLAYBACK_SWITCH) == 128) == false) goto L27;
     */
    /* JADX WARN: Code restructure failed: missing block: B:75:0x0096, code lost:
    
        if (((r16[r4] & com.realsil.sdk.bbpro.params.Mmi.AU_MMI_SD_PLAYBACK_SWITCH) == 128) == false) goto L16;
     */
    /*
    ...
    */
    ...
    public static final int process3Utf8Bytes(byte[] bArr, int i, int i2, kotlin.jvm.functions.Function1<? super java.lang.Integer, kotlin.Unit> yield) {
        ...
        if (i2 <= i3) {
            ...
            int i4 = i + 1;
            if (i2 > i4) {
                if ((bArr[i4] & com.realsil.sdk.bbpro.params.Mmi.AU_MMI_SD_PLAYBACK_SWITCH) == 128) {
                    return 2;
                }
            }
            return 1;
        ...
        byte b3 = bArr[i3];
        if (!((b3 & com.realsil.sdk.bbpro.params.Mmi.AU_MMI_SD_PLAYBACK_SWITCH) == 128)) {
            yield.invoke(valueOf);
            return 2;
        }
    ...
    public static final int process4Utf8Bytes(byte[] bArr, int i, int i2, kotlin.jvm.functions.Function1<? super java.lang.Integer, kotlin.Unit> yield) {
        ...
        if (i2 <= i3) {
            ...
            if (i2 > i4) {
                if ((bArr[i4] & com.realsil.sdk.bbpro.params.Mmi.AU_MMI_SD_PLAYBACK_SWITCH) == 128) {
                    int i5 = i + 2;
                    if (i2 > i5) {
                        if ((bArr[i5] & com.realsil.sdk.bbpro.params.Mmi.AU_MMI_SD_PLAYBACK_SWITCH) == 128) {
                            return 3;
                        }
                    }
                    return 2;
        ...
        byte b4 = bArr[i3];
        if (!((b4 & com.realsil.sdk.bbpro.params.Mmi.AU_MMI_SD_PLAYBACK_SWITCH) == 128)) {
            yield.invoke(valueOf);
            return 3;
        }
